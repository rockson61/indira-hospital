    ...
    return (
        <SubServiceTemplate
            ...
            relatedServices={{
                ...
                related: [
                    ...
                    { title: "Total Knee Replacement", href: "/services/orthopaedics/total-knee-replacement-cost" },
        ...
        >
            <section>
                ...
                <div className="my-10 p-8 md:p-10 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10 rounded-[2.5rem] border border-blue-100 dark:border-blue-900 shadow-sm">
                    <h4 className="text-2xl font-black text-slate-900 dark:text-blue-300 mb-4 tracking-tight">Sports Medicine & Arthroscopy Unit</h4>
