    ...
    return (
        <SubServiceTemplate
            ...
            relatedServices={{
                ...
                related: [
                    { title: "Parkinson's Disease Care", href: "/services/neurology/parkinsons-disease-care" },
        ...
        >
            <section>
                ...
                <div className="my-10 p-8 md:p-10 bg-gradient-to-br from-violet-50 to-purple-50 dark:from-violet-900/10 dark:to-purple-900/10 rounded-[2.5rem] border border-violet-100 dark:border-violet-900 shadow-sm">
