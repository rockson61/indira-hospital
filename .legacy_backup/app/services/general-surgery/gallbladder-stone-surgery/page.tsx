      ...
      departmentSlug="general-surgery"
            ...
            relatedServices={{
                ...
                related: [
                    ...
                    { title: "Hernia Repair Guide", href: "/services/general-surgery/laparoscopic-hernia-repair" },
        ...
        >
            <section>
                ...
                <div className="my-10 p-8 md:p-12 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/10 dark:to-purple-900/10 rounded-[2.5rem] border border-indigo-100 dark:border-indigo-800 shadow-sm">
                    <h4 className="text-2xl font-black text-slate-900 dark:text-purple-300 mb-6 tracking-tight">Transparent Surgical Packages</h4>
