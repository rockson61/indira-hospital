    ...
    return (
        <SubServiceTemplate
            ...
            relatedServices={{
                ...
                related: [
                    ...
                    { title: "Kidney Stone Treatment", href: "/services/urology/kidney-stone-laser-surgery" },
        ...
        >
            <section>
                ...
                <div className="my-10 p-8 md:p-10 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/10 dark:to-cyan-900/10 rounded-[2.5rem] border border-blue-100 dark:border-blue-900 shadow-sm">
