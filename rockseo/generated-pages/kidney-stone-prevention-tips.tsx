...
// Topic: Kidney Stone Prevention Tips
// Cluster: urology
...
export const metadata: Metadata = {
  title: "Kidney Stone Prevention Tips | Indira Hospital Vellore",
  description: "Learn about Kidney Stone Prevention Tips at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function KidneyStonePreventionTipsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Kidney Stone Prevention Tips is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Kidney Stone Prevention Tips",
        steps: [
