...
export const metadata: Metadata = {
  title: "Trigger Finger Release | Indira Hospital Vellore",
  description: "Learn about Trigger Finger Release at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function TriggerFingerReleasePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Trigger Finger Release is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Trigger Finger Release",
        steps: [
