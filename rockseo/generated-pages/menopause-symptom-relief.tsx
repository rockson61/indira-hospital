...
// Topic: Menopause Symptom Relief
...
export const metadata: Metadata = {
  title: "Menopause Symptom Relief | Indira Hospital Vellore",
  description: "Learn about Menopause Symptom Relief at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function MenopauseSymptomReliefPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Menopause Symptom Relief is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Menopause Symptom Relief",
        steps: [
