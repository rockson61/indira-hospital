...
// Generated: 2026-02-14T15:50:57.224Z
...
export const metadata: Metadata = {
  title: "Teeth Contouring Reshaping | Indira Dental Clinic Vellore",
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Teeth Contouring Reshaping at Indira Dental Clinic
          </h1>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/services/cosmetic-dentistry" className="text-teal-600 hover:underline">
                ← Back to cosmetic dentistry main page
              </Link>
            </li>
