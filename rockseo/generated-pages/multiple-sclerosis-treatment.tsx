...
export const metadata: Metadata = {
  title: "Multiple Sclerosis Treatment | Indira Hospital Vellore",
  description: "Learn about Multiple Sclerosis Treatment at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function MultipleSclerosisTreatmentPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Multiple Sclerosis Treatment is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Multiple Sclerosis Treatment",
        steps: [
