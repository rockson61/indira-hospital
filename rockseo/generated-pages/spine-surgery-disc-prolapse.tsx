...
// Topic: Spine Surgery Disc Prolapse
...
export const metadata: Metadata = {
  title: "Spine Surgery Disc Prolapse | Indira Hospital Vellore",
  description: "Learn about Spine Surgery Disc Prolapse at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function SpineSurgeryDiscProlapsePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Spine Surgery Disc Prolapse is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Spine Surgery Disc Prolapse",
        steps: [
