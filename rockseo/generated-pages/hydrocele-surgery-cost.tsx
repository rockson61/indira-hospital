...
export const metadata: Metadata = {
  title: "Hydrocele Surgery Cost | Indira Hospital Vellore",
  description: "Learn about Hydrocele Surgery Cost at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function HydroceleSurgeryCostPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Hydrocele Surgery Cost is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Hydrocele Surgery Cost",
        steps: [
