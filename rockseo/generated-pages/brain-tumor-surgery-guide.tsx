...
// Topic: Brain Tumor Surgery Guide
// Cluster: neurology
...
export const metadata: Metadata = {
  title: "Brain Tumor Surgery Guide | Indira Hospital Vellore",
  description: "Learn about Brain Tumor Surgery Guide at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function BrainTumorSurgeryGuidePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Brain Tumor Surgery Guide is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Brain Tumor Surgery Guide",
        steps: [
