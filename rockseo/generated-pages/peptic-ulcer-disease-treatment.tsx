...
// Topic: Peptic Ulcer Disease Treatment
...
export const metadata: Metadata = {
  title: "Peptic Ulcer Disease Treatment | Indira Hospital Vellore",
  description: "Learn about Peptic Ulcer Disease Treatment at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function PepticUlcerDiseaseTreatmentPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Peptic Ulcer Disease Treatment is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Peptic Ulcer Disease Treatment",
        steps: [
