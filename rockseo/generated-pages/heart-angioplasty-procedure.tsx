...
// Topic: Heart Angioplasty Procedure
// Cluster: cardiology
...
export const metadata: Metadata = {
  title: "Heart Angioplasty Procedure | Indira Hospital Vellore",
  description: "Learn about Heart Angioplasty Procedure at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function HeartAngioplastyProcedurePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Heart Angioplasty Procedure is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Heart Angioplasty Procedure",
        steps: [
