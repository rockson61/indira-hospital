...
export const metadata: Metadata = {
  title: "Ceramic Braces Vs Metal | Indira Hospital Vellore",
  description: "Learn about Ceramic Braces Vs Metal at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function CeramicBracesVsMetalPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Ceramic Braces Vs Metal is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Ceramic Braces Vs Metal",
        steps: [
