...
// Topic: All-on-6 Implants Guide
// Cluster: dental-implants
// Hub: /services/dental-implants
// Generated: 2026-02-25T03:34:09.087Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "All-on-6 Implants Guide | Indira Hospital Vellore",
  description: "Learn about All-on-6 Implants Guide at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function AllOn6ImplantsGuidePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>All-on-6 Implants Guide is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to All-on-6 Implants Guide",
        steps: [
