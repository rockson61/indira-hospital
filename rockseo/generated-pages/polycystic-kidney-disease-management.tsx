...
// Topic: Polycystic Kidney Disease Management
// Cluster: nephrology
...
export const metadata: Metadata = {
  title: "Polycystic Kidney Disease Management | Indira Hospital Vellore",
  description: "Learn about Polycystic Kidney Disease Management at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function PolycysticKidneyDiseaseManagementPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Polycystic Kidney Disease Management is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Polycystic Kidney Disease Management",
        steps: [
