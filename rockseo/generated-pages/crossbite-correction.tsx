...
// Topic: Crossbite Correction
// Cluster: orthodontics
// Hub: /services/orthodontics
// Generated: 2026-02-25T03:34:09.109Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Crossbite Correction | Indira Hospital Vellore",
  description: "Learn about Crossbite Correction at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function CrossbiteCorrectionPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Crossbite Correction is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Crossbite Correction",
        steps: [
