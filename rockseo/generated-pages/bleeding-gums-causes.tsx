...
export const metadata: Metadata = {
  title: "Bleeding Gums Causes | Indira Hospital Vellore",
  description: "Learn about Bleeding Gums Causes at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function BleedingGumsCausesPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Bleeding Gums Causes is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Bleeding Gums Causes",
        steps: [
