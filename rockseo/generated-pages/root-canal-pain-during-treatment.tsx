...
// Topic: Root Canal Pain During Treatment
// Cluster: root-canal
...
export const metadata: Metadata = {
  title: "Root Canal Pain During Treatment | Indira Hospital Vellore",
  description: "Learn about Root Canal Pain During Treatment at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function RootCanalPainDuringTreatmentPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Root Canal Pain During Treatment is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Root Canal Pain During Treatment",
        steps: [
      ...
      reviews={{
        entityType: "service",
        entityName: "Root Canal Pain During Treatment",
        entitySlug: "root-canal/root-canal-pain-during-treatment"
      }}
    >
        {/* Main Content (Information Gain) */}
        <h2>What is Root Canal Pain During Treatment?</h2>
