...
export const metadata: Metadata = {
  title: "Gum Surgery Recovery | Indira Dental Clinic Vellore",
  description: "TODO: Add 150-160 character description with primary keyword in first 60 characters."
};

export default function GumSurgeryRecoveryPage() {
  return (
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Gum Surgery Recovery at Indira Dental Clinic
          </h1>
        ...
        <section className="py-8 prose prose-lg max-w-none">
          <h2>What is Gum Surgery Recovery?</h2>
