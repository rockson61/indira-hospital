...
export const metadata: Metadata = {
  title: "Male Infertility Causes | Indira Hospital Vellore",
  description: "Learn about Male Infertility Causes at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function MaleInfertilityCausesPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Male Infertility Causes is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Male Infertility Causes",
        steps: [
