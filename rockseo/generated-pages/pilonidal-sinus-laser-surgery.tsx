...
// Topic: Pilonidal Sinus Laser Surgery
// Cluster: general-surgery
// Hub: /services/general-surgery
// Generated: 2026-02-25T04:19:28.070Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Pilonidal Sinus Laser Surgery | Indira Hospital Vellore",
  description: "Learn about Pilonidal Sinus Laser Surgery at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function PilonidalSinusLaserSurgeryPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Pilonidal Sinus Laser Surgery is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Pilonidal Sinus Laser Surgery",
        steps: [
