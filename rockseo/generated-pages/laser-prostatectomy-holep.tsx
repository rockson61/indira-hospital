...
// Topic: Laser Prostatectomy HOLEP
// Cluster: urology
...
export const metadata: Metadata = {
  title: "Laser Prostatectomy HOLEP | Indira Hospital Vellore",
  description: "Learn about Laser Prostatectomy HOLEP at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function LaserProstatectomyHolepPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Laser Prostatectomy HOLEP is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Laser Prostatectomy HOLEP",
        steps: [
