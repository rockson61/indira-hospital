...
// Topic: Liver Cirrhosis Care Plan
...
export const metadata: Metadata = {
  title: "Liver Cirrhosis Care Plan | Indira Hospital Vellore",
  description: "Learn about Liver Cirrhosis Care Plan at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function LiverCirrhosisCarePlanPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Liver Cirrhosis Care Plan is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Liver Cirrhosis Care Plan",
        steps: [
