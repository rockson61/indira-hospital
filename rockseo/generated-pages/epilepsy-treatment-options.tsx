...
// Topic: Epilepsy Treatment Options
// Cluster: neurology
...
export const metadata: Metadata = {
  title: "Epilepsy Treatment Options | Indira Hospital Vellore",
  description: "Learn about Epilepsy Treatment Options at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function EpilepsyTreatmentOptionsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Epilepsy Treatment Options is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Epilepsy Treatment Options",
        steps: [
