...
export const metadata: Metadata = {
  title: "Root Canal Aftercare | Indira Hospital Vellore",
  description: "Learn about Root Canal Aftercare at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function RootCanalAftercarePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Root Canal Aftercare is a highly specialized treatment provided by our expert medical team.</strong> This advanced procedure offers exceptional success rates with transparent pricing.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Your structured clinical pathway for Root Canal Aftercare",
        steps: [
