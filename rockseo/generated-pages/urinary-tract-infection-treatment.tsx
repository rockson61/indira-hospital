...
export const metadata: Metadata = {
  title: "Urinary Tract Infection Treatment | Indira Hospital Vellore",
  description: "Learn about Urinary Tract Infection Treatment at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function UrinaryTractInfectionTreatmentPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Urinary Tract Infection Treatment is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Urinary Tract Infection Treatment",
        steps: [
