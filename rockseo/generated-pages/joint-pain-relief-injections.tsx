...
// Topic: Joint Pain Relief Injections
...
export const metadata: Metadata = {
  title: "Joint Pain Relief Injections | Indira Hospital Vellore",
  description: "Learn about Joint Pain Relief Injections at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function JointPainReliefInjectionsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Joint Pain Relief Injections is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Joint Pain Relief Injections",
        steps: [
