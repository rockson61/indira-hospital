...
// Generated: 2026-02-14T15:50:19.375Z
...
export const metadata: Metadata = {
  title: "Gingivitis Treatment Guide | Indira Dental Clinic Vellore",
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Gingivitis Treatment Guide at Indira Dental Clinic
          </h1>
        ...
        <section className="py-8 bg-teal-50 dark:bg-teal-900/20 rounded-xl p-6">
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/services/gum-treatment" className="text-teal-600 hover:underline">
                ← Back to gum treatment main page
              </Link>
            </li>
