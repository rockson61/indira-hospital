...
// Generated: 2026-02-25T03:34:09.127Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Kidney Stone Laser Surgery | Indira Hospital Vellore",
  description: "Learn about Kidney Stone Laser Surgery at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function KidneyStoneLaserSurgeryPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Kidney Stone Laser Surgery is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Kidney Stone Laser Surgery",
        steps: [
