...
// Generated: 2026-02-25T04:19:28.079Z
...
export default function ImmunotherapyTreatmentOptionsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Immunotherapy Treatment Options is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Immunotherapy Treatment Options",
        steps: [
