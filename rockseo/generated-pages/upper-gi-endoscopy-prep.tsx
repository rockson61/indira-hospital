...
export const metadata: Metadata = {
  title: "Upper GI Endoscopy Prep | Indira Hospital Vellore",
  description: "Learn about Upper GI Endoscopy Prep at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function UpperGiEndoscopyPrepPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Upper GI Endoscopy Prep is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Upper GI Endoscopy Prep",
        steps: [
