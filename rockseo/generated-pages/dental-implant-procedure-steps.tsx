...
// Topic: Dental Implant Procedure Steps
// Cluster: dental-implants
// Hub: /services/dental-implants
// Generated: 2026-02-14T15:12:30.827Z
...
export const metadata: Metadata = {
  title: "Dental Implant Procedure Steps | Indira Dental Clinic Vellore",
  description: "TODO: Add 150-160 character description with primary keyword in first 60 characters."
};

export default function DentalImplantProcedureStepsPage() {
  return (
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Dental Implant Procedure Steps at Indira Dental Clinic
          </h1>
        ...
        <section className="py-8 prose prose-lg max-w-none">
          <h2>What is Dental Implant Procedure Steps?</h2>
        ...
        <section className="py-8 bg-teal-50 dark:bg-teal-900/20 rounded-xl p-6">
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/services/dental-implants" className="text-teal-600 hover:underline">
