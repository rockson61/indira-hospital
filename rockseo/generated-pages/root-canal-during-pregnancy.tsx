...
// Topic: Root Canal During Pregnancy
// Cluster: root-canal
...
export const metadata: Metadata = {
  title: "Root Canal During Pregnancy | Indira Hospital Vellore",
  description: "Learn about Root Canal During Pregnancy at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function RootCanalDuringPregnancyPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Root Canal During Pregnancy is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Root Canal During Pregnancy",
        steps: [
