...
// Topic: Shoulder Arthroscopy Guide
...
export const metadata: Metadata = {
  title: "Shoulder Arthroscopy Guide | Indira Hospital Vellore",
  description: "Learn about Shoulder Arthroscopy Guide at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function ShoulderArthroscopyGuidePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Shoulder Arthroscopy Guide is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Shoulder Arthroscopy Guide",
        steps: [
