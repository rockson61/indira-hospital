...
// Topic: Gum Recession Treatment
// Cluster: gum-treatment
// Hub: /services/gum-treatment
// Generated: 2026-02-25T03:34:09.111Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Gum Recession Treatment | Indira Hospital Vellore",
  description: "Learn about Gum Recession Treatment at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function GumRecessionTreatmentPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Gum Recession Treatment is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Gum Recession Treatment",
        steps: [
