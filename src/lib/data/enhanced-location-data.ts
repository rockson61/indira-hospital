...
export const enhancedVelloreLocations: EnhancedLocationData[] = [
  ...
  // ─── Major Tamil Nadu Catchment Cities ──────────────────────────────────────
  {
    ...
    description: 'State capital and India\'s fourth largest city. Patients from Chennai trust Indira Hospital for specialised surgical procedures at affordable costs.',
