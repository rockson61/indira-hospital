...
export const ThyroidLongForm = () => {
 ...
 <div className="bg-teal-950 p-10 rounded-[4rem] border border-slate-200 dark:border-slate-800 text-white relative overflow-hidden flex flex-col justify-center">
