 ...
 *Price includes 4K Laparoscopy tower usage, Harmonic Scalpel, Titanium clips, and 24Hr ward stay.
 ...
 <button className="px-14 py-6 bg-white dark:bg-slate-900 hover:bg-white dark:bg-slate-900 text-white font-black rounded-3xl transition-all border border-slate-200 dark:border-slate-800 uppercase tracking-widest italic">WhatsApp Diagnostic Hub</button>
 </div>
 </section>
 </div>
 )
