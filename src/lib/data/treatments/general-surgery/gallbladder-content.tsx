        ...
        <div className="gallbladder-longform-content space-y-16 py-8">
            ...
            <section className="bg-slate-50 dark:bg-slate-900/50 p-12 rounded-[3.5rem] border border-slate-100 dark:border-slate-800 shadow-xl relative overflow-hidden">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div className="bg-indigo-950 p-10 rounded-[4rem] border border-white/10 text-white relative overflow-hidden flex flex-col justify-center">
            ...
            <section className="bg-white dark:bg-slate-900 rounded-[4rem] p-10 md:p-16 border border-slate-100 dark:border-slate-800 shadow-xl">
                ...
                <div className="grid md:grid-cols-3 gap-8 text-center px-4">
                    <div className="space-y-4">
                        ...
                        <p className="text-[10px] text-slate-500 italic">Determining stone size and checking for gallbladder wall thickening (sign of infection).</p>
                    </div>
                    <div className="space-y-4">
                        <div className="w-20 h-20 bg-indigo-50 dark:bg-indigo-950/30 rounded-3xl flex items-center justify-center text-indigo-600 mx-auto">
                        ...
                        <p className="text-[10px] text-slate-500 italic">Blood markers to rule out ductal blockage or early stage jaundice.</p>
                    </div>
                    <div className="space-y-4">
                        <div className="w-20 h-20 bg-indigo-50 dark:bg-indigo-950/30 rounded-3xl flex items-center justify-center text-indigo-600 mx-auto">
                        ...
                        <p className="text-[10px] text-slate-500 italic">Advanced imaging for complex anatomy or suspected bile duct stones.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-indigo-950 rounded-[4rem] p-20 text-center text-white relative overflow-hidden group/cta">
                ...
                <div className="flex flex-wrap justify-center gap-8 relative z-10">
                    ...
                    <button className="px-14 py-6 bg-white/10 hover:bg-white/20 text-white font-black rounded-3xl transition-all border border-white/10 uppercase tracking-widest italic">WhatsApp Diagnostic Hub</button>
                </div>
            </section>
        </div>
    )
