        ...
        <div className="appendix-longform-content space-y-16 py-8">
            ...
            <section className="bg-slate-50 dark:bg-slate-900/50 p-12 rounded-[3.5rem] border border-slate-100 dark:border-slate-800 shadow-xl relative overflow-hidden">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div className="bg-rose-950 p-10 rounded-[4rem] border border-white/10 text-white relative overflow-hidden flex flex-col justify-center">
                ...
                <div className="max-w-4xl relative z-10 mx-auto text-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 text-left">
                        ...
                        <div className="bg-white/5 p-12 rounded-[4rem] border border-white/10 flex flex-col justify-center group/card">
                             ...
                             <p className="text-[10px] text-slate-500 mt-2 uppercase font-black tracking-widest text-right italic">Success Rate for Emergency Lap-Appendectomy</p>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="p-8 bg-white/5 border border-white/10 rounded-[3rem]">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {['TN CMCHIS', 'Star Health', 'HDFC Ergo', 'NIVA Bupa', 'United India'].map((ins, i) => (
                                        <div key={i} className="px-4 py-1.5 bg-white/5 rounded-full border border-white/10 text-[10px] font-bold text-rose-100">{ins}</div>
                                    ))}
                                </div>
                            </div>
                        </div>
            ...
            <section className="bg-rose-950 rounded-[4rem] p-20 text-center text-white relative overflow-hidden group/cta">
                ...
                <div className="flex flex-wrap justify-center gap-8 relative z-10">
                    ...
                    <button className="px-14 py-6 bg-white/10 hover:bg-white/20 text-white font-black rounded-3xl transition-all border border-white/10 uppercase tracking-widest italic">WhatsApp Diagnostics</button>
                </div>
            </section>
        </div>
    )
