 ...
 *Price includes HD-Laparoscopic tower fees, anesthesia, medications, and 24-hour ward stay.
 ...
 <button className="px-14 py-6 bg-white dark:bg-slate-900 hover:bg-white dark:bg-slate-900 text-white font-black rounded-3xl transition-all border border-slate-200 dark:border-slate-800 uppercase tracking-widest italic">WhatsApp Diagnostics</button>
 </div>
 </section>
 </div>
 )
