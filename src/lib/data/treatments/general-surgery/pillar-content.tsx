...
export const GeneralSurgeryPillarLongForm = () => {
 ...
 <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-8 font-heading underline decoration-[#005f73]/20 underline-offset-8">
 ...
 <section className="bg-slate-50 dark:bg-slate-900 p-12 rounded-[3.5rem] border border-slate-100 dark:border-slate-800 shadow-xl overflow-hidden relative">
 ...
 <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-6 font-heading uppercase tracking-tighter">
 ...
 <div className="p-10 bg-slate-950 rounded-[3rem] text-white border border-slate-200 dark:border-slate-800 relative group overflow-hidden">
 <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:scale-125 transition-transform duration-700">
 <Microscope className="w-24 h-24 text-fuchsia-500" />
 </div>
 <h4 className="text-xl font-black mb-4 font-heading tracking-tight text-fuchsia-400">4K UHD Laparoscopy</h4>
 <p className="text-xs text-slate-400 leading-relaxed opacity-80">
 ...
 <h4 className="text-xl font-black mb-4 font-heading tracking-tight text-fuchsia-400">Harmonic Scalpel (Ultrasonic)</h4>
 <p className="text-xs text-slate-400 leading-relaxed opacity-80">
 ...
 <h4 className="text-xl font-black mb-4 font-heading tracking-tight text-fuchsia-400">German Laser Platform</h4>
 <p className="text-xs text-slate-400 leading-relaxed opacity-80">
 ...
 <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-10 font-heading underline decoration-[#005f73]/20 underline-offset-8 uppercase tracking-widest text-center">
 ...
 <p className="text-sm text-fuchsia-900/70 dark:text-fuchsia-400/70 leading-relaxed">
 ...
 <h2 className="text-4xl font-black mb-8 text-red-500 font-heading uppercase tracking-tighter">24/7 Surgical Emergency Readiness</h2>
 <div className="grid md:grid-cols-2 gap-12">
 <div className="space-y-6">
 ...
 <h4 className="text-xl font-black mb-2 font-heading">Emergency Hotline:</h4>
 ...
 <p className="text-[10px] text-slate-500 mt-6 uppercase font-black tracking-widest text-center">NABH Accredited Emergency Infrastructure</p>
 </div>
 </div>
 </div>
 </section>
 ...
 <h2 className="text-4xl font-black text-slate-900 dark:text-white font-heading italic m-0 tracking-tighter uppercase">The Surgical Architects</h2>
 ...
 <div className="text-3xl font-black text-[#005f73] mb-1">30+</div>
 <div className="text-[10px] font-black uppercase text-slate-500 tracking-widest">Years Mastery</div>
 </div>
 <div className="p-6 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 text-center">
 <div className="text-3xl font-black text-[#005f73] mb-1">30k+</div>
 <div className="text-[10px] font-black uppercase text-slate-500 tracking-widest">Success Outcomes</div>
 </div>
 </div>
 </div>
 ...
 <h4 className="text-2xl font-black text-[#005f73] mb-6 font-heading italic uppercase underline decoration-white/5 underline-offset-8">A Trusted Legacy</h4>
 ...
 <div>
 <div className="text-[10px] font-black uppercase text-[#005f73] tracking-widest leading-tight">Dr. P. Shankar</div>
 ...
 <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-12 font-heading uppercase tracking-widest text-center underline underline-offset-8 decoration-[#005f73]/20">
 Surgical FAQ
 </h2>
 ...
 <h2 className="text-5xl font-black mb-6 font-heading uppercase tracking-tighter">Your Health is Our Legacy</h2>
 <p className="text-white/60 mb-12 max-w-2xl mx-auto italic text-xl leading-relaxed font-light">
 ...
 <button className="px-14 py-6 bg-white text-[#005f73] font-black rounded-3xl transition-all shadow-2xl uppercase tracking-widest hover:scale-110 active:scale-95">Book Operation Consult</button>
 <button className="px-14 py-6 bg-white dark:bg-slate-900 hover:bg-white dark:bg-slate-900 text-white font-black rounded-3xl transition-all border border-slate-200 dark:border-slate-800 uppercase tracking-widest">Emergency Helpline</button>
 </div>
 </section>
 </div>
 )
