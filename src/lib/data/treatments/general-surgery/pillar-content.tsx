...
export const GeneralSurgeryPillarLongForm = () => {
 ...
 <button className="px-14 py-6 bg-white dark:bg-slate-900 hover:bg-white dark:bg-slate-900 text-white font-black rounded-3xl transition-all border border-slate-200 dark:border-slate-800 uppercase tracking-widest italic">Emergency Helpline</button>
 </div>
 </section>
 </div>
 )
