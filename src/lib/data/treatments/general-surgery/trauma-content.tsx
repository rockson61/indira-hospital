...
export const TraumaLongForm = () => {
 ...
 <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-8 font-heading underline decoration-red-600/20 underline-offset-8">
 ...
 <h4 className="font-bold text-red-900 dark:text-red-300 mt-6 font-heading text-xl uppercase">The Primary Survey (ABCDEs):</h4>
 ...
 <div className="bg-red-950 p-10 rounded-[4rem] border border-slate-200 dark:border-slate-800 text-white relative overflow-hidden flex flex-col justify-center">
 ...
 <h2 className="text-4xl font-black mb-10 text-red-400 font-heading uppercase tracking-tighter shrink-0">Surgical Damage Control</h2>
 <div className="grid md:grid-cols-2 gap-12 text-left">
 <div className="space-y-6">
 <h4 className="text-2xl font-bold font-heading italic text-red-100 uppercase">Lethal Triad Intervention</h4>
 ...
 <h4 className="text-red-400 font-bold mb-4 font-heading text-xl uppercase underline decoration-white/10 underline-offset-8 text-center shrink-0">FAST Scan Integration</h4>
 ...
 <p className="text-[10px] text-slate-500 mt-2 uppercase font-black tracking-widest text-right leading-tight">Diagnostic Speed Metric</p>
 </div>
 </div>
 </div>
 </section>
 ...
 <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-10 font-heading uppercase tracking-widest text-center">Intensive Care & Rehabilitation</h2>
 ...
 <h2 className="text-4xl font-black text-red-400 font-heading uppercase tracking-tighter m-0">Medicolegal Transparency</h2>
 ...
 <p className="text-xs text-slate-400 mb-4">Cashless approval teams work 24/7 for critical cases:</p>
 <div className="flex flex-wrap gap-2">
 {['Chief Minister Scheme', 'Ayushman Bharat', 'Star Health', 'HDFC Ergo', 'Traffic Victim Fund'].map((ins, i) => (
 <div key={i} className="px-4 py-1.5 bg-white dark:bg-slate-900 rounded-full border border-slate-200 dark:border-slate-800 text-[10px] font-bold text-red-100">{ins}</div>
 ))}
 </div>
 </div>
 </div>
 ...
 <h4 className="text-2xl font-black mb-2 font-heading">"Cure First, Cash Later"</h4>
 <p className="text-3xl font-black tracking-tighter mb-4 text-balance">Life-Saving Priority</p>
 ...
 <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-12 font-heading uppercase tracking-widest text-center underline underline-offset-8 decoration-red-600/20">Trauma & Emergency FAQ</h2>
 ...
 <h2 className="text-5xl font-black mb-6 font-heading italic uppercase tracking-tighter shrink-0">Every Second Counts</h2>
 <p className="text-red-100/60 mb-12 max-w-2xl mx-auto italic text-xl leading-relaxed font-light">
 ...
 <button className="px-14 py-6 bg-red-600 hover:bg-red-700 text-white font-black rounded-3xl transition-all shadow-2xl shadow-red-600/30 uppercase tracking-widest group-hover/cta:scale-110 active:scale-95 animate-pulse">Call 24/7 Red Hotline</button>
 <button className="px-14 py-6 bg-white dark:bg-slate-900 hover:bg-white dark:bg-slate-900 text-white font-black rounded-3xl transition-all border border-slate-200 dark:border-slate-800 uppercase tracking-widest flex items-center gap-3">
