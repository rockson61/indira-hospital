...
export default function HealthLibraryPage() {
 ...
 <button className="w-full py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-white dark:bg-slate-900 transition-all">Browse Videos</button>
 </div>
 </div>
