            ...
            fullDescription={
                <div className="space-y-16">
                    ...
                    <section id="philosophy" className="relative overflow-hidden p-8 md:p-12 rounded-[2.5rem] bg-sky-50/50 dark:bg-sky-950/20 border border-sky-100 dark:border-sky-900/50 text-left">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                            ...
                            <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-sky-100 dark:border-sky-800 shadow-xl flex flex-col justify-center">
                                <Activity className="w-16 h-16 text-sky-500 mb-6 font-heading uppercase tracking-widest italic" />
                                ...
                                <div className="inline-flex items-center gap-2 text-sky-600 font-bold text-xs uppercase tracking-widest italic">
                    ...
                    <section className="bg-slate-900 rounded-[3rem] p-10 md:p-16 text-white text-center relative overflow-hidden">
                        ...
                        <h3 className="text-3xl font-bold mb-8 italic font-heading text-sky-300 uppercase tracking-widest leading-none">Diagnostic & Surgical Modality Range</h3>
                        <div className="grid md:grid-cols-4 gap-6 text-left relative z-10">
                            {[
                                ...
                                <div key={i} className="p-6 rounded-[2rem] bg-white/5 border border-white/10 group hover:border-sky-500/50 transition-all">
