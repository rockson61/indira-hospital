...
export default function DrRocksonSamuelProfile() {
 ...
 <Smile className="w-16 h-16 text-indigo-500 mb-6 font-heading uppercase tracking-widest italic" />
 ...
 <h3 className="text-3xl font-bold mb-8 italic font-heading text-indigo-300 uppercase tracking-widest leading-none">The Digital Dental Ecosystem</h3>
