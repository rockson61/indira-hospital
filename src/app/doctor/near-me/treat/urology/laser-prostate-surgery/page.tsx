...
export const metadata: Metadata = constructMetadata({
 title: "Elite Laser Prostate Surgery (HoLEP & TURP in Vellore | I...",
 description: "Advanced Elite Laser Prostate Surgery (HoLEP & TURP) surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and...",
 path: "/doctor/near-me/treat/urology/laser-prostate-surgery"
});
...
export default function ProstateSurgeryPage() {
 ...
 <h3 className="font-heading text-3xl font-bold text-slate-900 dark:text-white mb-8 border-l-4 border-blue-500 pl-4 font-heading uppercase tracking-tighter">
 ...
 <h3 className="font-heading text-3xl font-bold mb-8 font-heading text-blue-300 uppercase tracking-widest leading-none">Clinical Men's Health Matrix</h3>
 ...
 <div key={i} className="p-6 rounded-[2rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 group hover:border-blue-500/50 transition-all">
 ...
 <h3 className="font-heading text-3xl font-bold text-slate-900 dark:text-white mb-4 font-heading tracking-tighter uppercase uppercase">What are the Benefits of Prostate Care Surgery?</h3>
 <p className="text-slate-600 dark:text-subtle-on-light">Restoring dignity and urinary flow with precision laser science.</p>
 </div>
