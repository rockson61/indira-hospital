...
export const metadata: Metadata = constructMetadata({
 title: "Dermatology, Laser & Trichology Hub in Vel in Vellore | I...",
 description: "Advanced Dermatology, Laser & Trichology Hub in Vellore, Tamil Nadu surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accre...",
 path: "/doctor/near-me/treat/dermatology"
});
...
export default function DermatologyDepartmentPage() {
 ...
 <h2 className="text-4xl font-black text-slate-900 dark:text-white font-heading border-l-8 border-rose-500 pl-6 mb-8 uppercase tracking-tight">
 ...
 <h4 className="text-2xl font-bold text-rose-300 mb-4 uppercase tracking-tighter text-left">Clinical Trichology Hub</h4>
 <p className="text-rose-100/60 text-sm leading-relaxed mb-6 font-medium text-left">
 ...
 <h2 className="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Dermatological Excellence Domains</h2>
 ...
 <h3 className="text-4xl font-black mb-16 flex items-center gap-3 font-heading uppercase tracking-tighter text-rose-400 text-left">
 ...
 <h4 className="font-black text-white mb-6 flex items-start gap-4 group-hover:text-rose-400 transition-colors text-lg">
