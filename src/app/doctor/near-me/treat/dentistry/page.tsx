...
export const metadata: Metadata = constructMetadata({
 title: "Dentistry & Smile Design Hub in Vellore, T in Vellore | I...",
 description: "Advanced Dentistry & Smile Design Hub in Vellore, Tamil Nadu surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited c...",
 path: "/doctor/near-me/treat/dentistry"
});
...
export default function DentistryDepartmentPage() {
 ...
 <h2 className="text-4xl font-black text-slate-900 dark:text-white font-heading border-l-8 border-cyan-600 pl-6 mb-8 uppercase tracking-tight text-left">
 The Smile Revolution: Advanced Dental Sciences
 </h2>
 <div className="text-xl leading-relaxed text-slate-700 dark:text-slate-300">
 <p>
 The <strong>Department of Dentistry & Oral-Maxillofacial Bio-Science</strong> at Indira Super Speciality Hospital is where clinical precision meets aesthetic artistry. We believe a smile is more than just teeth—it is your identity. Our mission is to restore this identity through <strong>Painless Interventions</strong>, <strong>Biocompatible Implants</strong>, and <strong>Digital Smile Mapping.</strong>
 </p>
 <p className="mt-4">
 Led by <strong>Dr. Rockson Samuel</strong>, our facility is equipped with modern ergonomic chairs, low-radiation digital radiography, and a 100% sterile environment. From managing complex wisdom tooth impactions to delivering high-definition ceramic veneers, we provide <strong>Tertiary Dental Solutions</strong> that prioritize your comfort and confidence.
 </p>
 </div>

 <div className="grid md:grid-cols-2 gap-8 mt-12 not-prose text-left">
 <div className="p-8 bg-cyan-50 dark:bg-cyan-900/20 rounded-[2.5rem] border border-cyan-100 dark:border-cyan-800 shadow-sm relative overflow-hidden group text-left">
 ...
 <div className="p-8 bg-slate-900 text-white rounded-[2.5rem] border border-slate-800 shadow-xl relative overflow-hidden group text-left">
 <div className="absolute inset-0 bg-blue-600/5 rotate-12 group-hover:rotate-0 transition-transform"></div>
 <h4 className="text-2xl font-bold text-cyan-300 mb-4 uppercase tracking-tighter text-left">Single-Visit Root Canal</h4>
 <p className="text-cyan-100/60 text-sm leading-relaxed mb-6 font-medium">
 ...
 <h2 className="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Smile Specialization Pillars</h2>
 ...
 <p className="mt-4">
 At Indira Hospital, our <strong>Endo-Protocol</strong> ensures:
 </p>
 ...
 <h3 className="text-4xl font-black mb-16 flex items-center gap-3 font-heading uppercase tracking-tighter text-cyan-400 text-left">
 ...
 a: "With our advanced rotary system, 90% of RCT cases are completed in a <strong>Single Sitting</strong> of 45-60 minutes. Complex infections or redo-RCTs may require a second visit to ensure complete sterilization."
 },
 {
 ...
 {
 q: "Can bleeding gums be treated permanently?",
 a: "Certainly. Bleeding is a sign of Gingivitis (gum inflammation). A thorough <strong>Ultrasonic Scaling</strong> followed by specialized gum therapy can restore health. If left untreated, it progresses to bone loss (Periodontitis)."
 },
 {
 ...
 <h4 className="font-black text-white mb-6 flex items-start gap-4 group-hover:text-cyan-400 transition-colors text-lg">
