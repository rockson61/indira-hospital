...
export default function TreatmentDirectoryPage() {
 ...
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-fuchsia-100 dark:bg-fuchsia-950 text-fuchsia-700 dark:text-fuchsia-300 text-sm font-bold uppercase tracking-widest mb-6 border border-fuchsia-200">
 ...
 <p className="text-xl text-slate-600 dark:text-subtle-on-light font-medium">Explore our complete range of specialized surgical and medical procedures.</p>
 </div>
 ...
 className="group flex items-start gap-2 text-slate-600 dark:text-subtle-on-light hover:text-fuchsia-600 transition-colors py-1"
 >
 ...
 className="inline-flex items-center gap-2 text-sm font-bold text-fuchsia-700 uppercase tracking-widest hover:gap-3 transition-all pt-2"
 >
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium">Our specialists are available 24/7 for expert guidance and second opinions.</p>
 </div>
