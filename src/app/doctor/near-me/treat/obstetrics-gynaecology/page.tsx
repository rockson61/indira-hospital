...
export default function GynaecologyPillarPage() {
 ...
 <h2 className="text-4xl font-black text-rose-900 dark:text-rose-400 font-heading border-l-8 border-rose-600 pl-6 mb-8 uppercase tracking-tight text-left">
 ...
 <p className="font-bold text-slate-900 dark:text-slate-100 border-l-4 border-rose-500 pl-6">
 ...
 <h4 className="font-black text-rose-100 mb-6 flex items-start gap-4 group-hover:text-rose-400 transition-colors text-lg text-left">
