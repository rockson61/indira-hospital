...
export const metadata: Metadata = {
    title: "Micro-Incision Cataract Surgery (MICS) in Vellore | Indira Super Speciality Hospital",
    description: "Micro-Incision Cataract Surgery (MICS) at Indira Super Speciality Hospital, Vellore. NABH-accredited ophthalmology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/ophthalmology/cataract-surgery-mics",
    },
    openGraph: {
        title: "Micro-Incision Cataract Surgery (MICS) in Vellore | Indira Super Speciality Hospital",
        description: "Micro-Incision Cataract Surgery (MICS) at Indira Super Speciality Hospital, Vellore. NABH-accredited ophthalmology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/ophthalmology/cataract-surgery-mics",
        type: 'website',
    },
}
    ...
    return (
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Micro-Incision Cataract Surgery (MICS)</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Micro-Incision Cataract Surgery (MICS) in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Micro-Incision Cataract Surgery (MICS) Surgery?</h2>
