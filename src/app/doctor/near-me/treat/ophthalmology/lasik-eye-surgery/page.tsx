...
export const metadata: Metadata = {
    title: "LASIK Eye Surgery in Vellore | Indira Super Speciality Hospital",
    description: "LASIK Eye Surgery at Indira Super Speciality Hospital, Vellore. NABH-accredited ophthalmology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/ophthalmology/lasik-eye-surgery",
    },
    openGraph: {
        title: "LASIK Eye Surgery in Vellore | Indira Super Speciality Hospital",
        description: "LASIK Eye Surgery at Indira Super Speciality Hospital, Vellore. NABH-accredited ophthalmology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/ophthalmology/lasik-eye-surgery",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="LASIK Eye Surgery in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>LASIK Eye Surgery</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'LASIK Eye Surgery',
                entitySlug: 'lasik-eye-surgery'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: LASIK Eye Surgery in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of LASIK Eye Surgery Surgery?</h2>
