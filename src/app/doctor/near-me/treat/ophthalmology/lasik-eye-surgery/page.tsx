...
export const metadata: Metadata = constructMetadata({
    title: "LASIK Eye Surgery in Vellore | Indira Hospital",
    description: "Advanced LASIK Eye Surgery in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and same-day disch...",
    path: "/doctor/near-me/treat/ophthalmology/lasik-eye-surgery"
});
