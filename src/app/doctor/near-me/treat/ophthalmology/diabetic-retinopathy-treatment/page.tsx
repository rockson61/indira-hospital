...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Diabetic Retinopathy Treatment in Vellore, Tamil Nadu"
            ...
            description={
                <>
                    <p>
                        Searching for the <strong>best diabetic retinopathy treatment in Vellore</strong>? Indira Super Speciality Hospital is a center of excellence for advanced ophthalmology care, providing precision-driven surgical solutions with a focus on patient safety and rapid healing.
                    </p>
                    <p className="mt-4">
            ...
            quickFacts={[
                ...
                { label: 'Tech Level', value: 'Advanced', icon: 'Microscope' },
        ...
        >
            <div className="space-y-12">
                <section>
                    <h2 className="font-heading text-3xl font-bold text-slate-900 mb-6">Why Choose Indira for Diabetic Retinopathy Treatment?</h2>
                ...
                <section className="bg-slate-900 rounded-[3rem] p-12 text-white">
                    <h2 className="font-heading text-3xl font-bold mb-6">Advanced Ophthalmology Infrastructure</h2>
