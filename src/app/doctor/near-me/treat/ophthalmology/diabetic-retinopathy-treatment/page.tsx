...
export const metadata: Metadata = {
    title: "Diabetic Retinopathy Treatment in Vellore | Indira Super Speciality Hospital",
    description: "Diabetic Retinopathy Treatment at Indira Super Speciality Hospital, Vellore. NABH-accredited ophthalmology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/ophthalmology/diabetic-retinopathy-treatment",
    },
    openGraph: {
        title: "Diabetic Retinopathy Treatment in Vellore | Indira Super Speciality Hospital",
        description: "Diabetic Retinopathy Treatment at Indira Super Speciality Hospital, Vellore. NABH-accredited ophthalmology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/ophthalmology/diabetic-retinopathy-treatment",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Diabetic Retinopathy Treatment in Vellore"
            eyebrow="Top Ophthalmology Solutions"
            departmentName="Ophthalmology"
            departmentSlug="ophthalmology"
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Diabetic Retinopathy Treatment</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Diabetic Retinopathy Treatment',
                entitySlug: 'diabetic-retinopathy-treatment'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Diabetic Retinopathy Treatment in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Diabetic Retinopathy Treatment Surgery?</h2>
                    ...
                    <section className="bg-slate-900 rounded-[3rem] p-12 text-white">
                        <h2 className="text-3xl font-black text-white mb-6">How Does Ophthalmology Treatment Work?</h2>
                        <p className="text-fuchsia-200/80 text-lg mb-8">
                            Our hospital is equipped with high-end medical technology to support complex ophthalmology procedures, reducing surgical time and enhancing safety.
                        </p>
