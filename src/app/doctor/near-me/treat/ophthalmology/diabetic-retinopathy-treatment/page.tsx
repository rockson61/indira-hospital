...
export const metadata: Metadata = constructMetadata({
    title: "Diabetic Retinopathy Treatment in Vellore | Indira Hospital",
    description: "Advanced Diabetic Retinopathy Treatment in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and s...",
    path: "/doctor/near-me/treat/ophthalmology/diabetic-retinopathy-treatment"
});
