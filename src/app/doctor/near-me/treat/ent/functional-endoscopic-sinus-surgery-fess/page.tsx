...
export const metadata: Metadata = constructMetadata({
 title: "Elite Functional Endoscopic Sinus Surgery in Vellore | I...",
 description: "Advanced Elite Functional Endoscopic Sinus Surgery (FESS) surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care...",
 path: "/doctor/near-me/treat/ent/functional-endoscopic-sinus-surgery-fess"
});
...
export default function FESSSurgicalPage() {
 ...
 <strong>Elite Functional Endoscopic Sinus Surgery (FESS)</strong> is a high-precision medical procedure at Indira Super Speciality Hospital, Vellore. Our surgical team utilizes internal clinical benchmarks to ensure <strong>painless outcomes</strong> and <strong>rapid patient recovery</strong> for all procedures.
 </p>
 </article>
 }
 quickFacts={[
 ...
 <AioKnowledgeBlock 
 title="Quick Facts: Elite Functional Endoscopic Sinus Surgery (FESS) in Vellore"
 items={[
 ...
 <h3 className="font-heading text-3xl font-bold mb-4">The Precision Recovery Roadmap</h3>
 ...
 <div key={i} className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex flex-col items-center">
 <p className="text-emerald-400 font-bold mb-2">{step.day}</p>
 <h5 className="font-bold text-sm mb-2">{step.title}</h5>
 <p className="text-sm text-subtle-on-light leading-relaxed">{step.text}</p>
 </div>
 ))}
 </div>
 </section>
