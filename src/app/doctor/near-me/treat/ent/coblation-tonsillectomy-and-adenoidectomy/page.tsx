...
export const metadata: Metadata = constructMetadata({
 title: "Elite Coblation Tonsillectomy & Adenoidect in Vellore | I...",
 description: "Advanced Elite Coblation Tonsillectomy & Adenoidectomy surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, a...",
 path: "/doctor/near-me/treat/ent/coblation-tonsillectomy-and-adenoidectomy"
});
...
export default function TonsillectomyPage() {
 ...
 <strong>Elite Coblation Tonsillectomy & Adenoidectomy</strong> is a high-precision medical procedure at Indira Super Speciality Hospital, Vellore. Our surgical team utilizes internal clinical benchmarks to ensure <strong>painless outcomes</strong> and <strong>rapid patient recovery</strong> for all procedures.
 </p>
 </article>
 }
 quickFacts={[
 ...
 <AioKnowledgeBlock 
 title="Quick Facts: Elite Coblation Tonsillectomy & Adenoidectomy in Vellore"
 items={[
