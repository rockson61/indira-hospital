...
export const metadata: Metadata = constructMetadata({
 title: "Elite Microlaryngeal Surgery & Voice Care in Vellore | I...",
 description: "Advanced Elite Microlaryngeal Surgery & Voice Care surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and s...",
 path: "/doctor/near-me/treat/ent/microlaryngeal-surgery-voice-care"
});
 ...
 **Elite Phonosurgery** at Indira is performed using a "Cold Steel"technique. We avoid lasers that generate heat, which can cause thermal damage to the deep Reinke's space. By using delicate microscopic shears, we preserve the healthy tissue, ensuring your voice returns with its natural tone and range.
 ...
 <p className="text-slate-600 dark:text-subtle-on-light text-sm leading-relaxed mb-6 border-l-2 border-fuchsia-100 pl-4">
 ...
 <p className="text-slate-600 dark:text-subtle-on-light mt-2">Stroboscopy: The diagnostic gold standard for fine-vibration flaws.</p>
 </div>
 ...
 <p className="text-sm text-slate-600 dark:text-subtle-on-light">"Post-op surgery is only half the cure. Our specialized speech pathologists help you retrain your vocal muscles to prevent the return of nodules and polyps."</p>
 </div>
 </div>
 ...
 <p className="text-xs font-black uppercase tracking-widest text-slate-500">Recurrent Clear Rate</p>
 </div>
 <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm text-center border-b-4 border-fuchsia-500">
 <p className="font-heading text-3xl font-bold text-fuchsia-600 mb-1">20X</p>
 <p className="text-xs font-black uppercase tracking-widest text-slate-500">Zeiss Zoom</p>
 </div>
 </div>
 </div>
 </section>
