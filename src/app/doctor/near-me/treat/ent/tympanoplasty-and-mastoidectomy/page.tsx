                ...
                <div className="space-y-16">
                    ...
                    <section>
                        <div className="text-center max-w-3xl mx-auto mb-12">
                            <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Common Ear Surgery Indications</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            {[
                                ...
                                <div key={i} className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 text-center hover:bg-emerald-50/20 transition-all border-b-4 border-emerald-500">
                                    <h4 className="font-bold mb-2 text-emerald-600 font-primary italic tracking-tighter uppercase">{item.title}</h4>
                    ...
                    <section className="bg-slate-900 rounded-[3rem] p-10 md:p-16 text-white overflow-hidden relative">
                        ...
                        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-left">
                            <div className="space-y-6">
                                <h3 className="text-3xl font-bold italic font-primary text-emerald-300">Mastoidectomy: Cleansing the Temporal Bone</h3>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-6 bg-white/5 border border-white/10 rounded-2xl text-center">
                                    <p className="text-xs text-emerald-300 font-bold uppercase tracking-widest mb-1 font-primary italic">Microscope</p>
                                    <p className="text-3xl font-bold text-white">Zeiss</p>
                                </div>
                                <div className="p-6 bg-white/5 border border-white/10 rounded-2xl text-center">
                                    <p className="text-xs text-emerald-300 font-bold uppercase tracking-widest mb-1 font-primary italic">Precision</p>
                                    <p className="text-3xl font-bold text-white">Sub-mm</p>
                                </div>
                            </div>
                        </div>
                    </section>
