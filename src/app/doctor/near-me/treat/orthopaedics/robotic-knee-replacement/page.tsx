...
export const metadata: Metadata = {
    title: "Robotic Knee Replacement in Vellore | Indira Super Speciality Hospital",
    description: "Robotic Knee Replacement at Indira Super Speciality Hospital, Vellore. NABH-accredited orthopaedics care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/orthopaedics/robotic-knee-replacement",
    },
    openGraph: {
        title: "Robotic Knee Replacement in Vellore | Indira Super Speciality Hospital",
        description: "Robotic Knee Replacement at Indira Super Speciality Hospital, Vellore. NABH-accredited orthopaedics care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/orthopaedics/robotic-knee-replacement",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Robotic Knee Replacement in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Robotic Knee Replacement</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Robotic Knee Replacement',
                entitySlug: 'robotic-knee-replacement'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Robotic Knee Replacement in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Robotic Knee Replacement Surgery?</h2>
