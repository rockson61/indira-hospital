...
export const metadata: Metadata = constructMetadata({
    title: "ACL Reconstruction Surgery in Vellore | Indira Hospital",
    description: "Advanced ACL Reconstruction Surgery in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and same-...",
    path: "/doctor/near-me/treat/orthopaedics/acl-reconstruction-surgery"
});
