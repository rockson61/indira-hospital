...
export const metadata: Metadata = {
    title: "ACL Reconstruction Surgery in Vellore | Indira Super Speciality Hospital",
    description: "ACL Reconstruction Surgery at Indira Super Speciality Hospital, Vellore. NABH-accredited orthopaedics care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/orthopaedics/acl-reconstruction-surgery",
    },
    openGraph: {
        title: "ACL Reconstruction Surgery in Vellore | Indira Super Speciality Hospital",
        description: "ACL Reconstruction Surgery at Indira Super Speciality Hospital, Vellore. NABH-accredited orthopaedics care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/orthopaedics/acl-reconstruction-surgery",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="ACL Reconstruction Surgery in Vellore"
            eyebrow="Top Orthopaedics Solutions"
            departmentName="Orthopaedics"
            departmentSlug="orthopaedics"
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>ACL Reconstruction Surgery</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'ACL Reconstruction Surgery',
                entitySlug: 'acl-reconstruction-surgery'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: ACL Reconstruction Surgery in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of ACL Reconstruction Surgery Surgery?</h2>
                    ...
                    <section className="bg-slate-900 rounded-[3rem] p-12 text-white">
                        <h2 className="text-3xl font-black text-white mb-6">How Does Orthopaedics Treatment Work?</h2>
                        <p className="text-fuchsia-200/80 text-lg mb-8">
                            Our hospital is equipped with high-end medical technology to support complex orthopaedics procedures, reducing surgical time and enhancing safety.
                        </p>
