    ...
    return (
        <SubServiceTemplate
            ...
            description={
                <>
                    <p>
                        Searching for the <strong>best acl reconstruction surgery in Vellore</strong>? Indira Super Speciality Hospital is a center of excellence for advanced orthopaedics care, providing precision-driven surgical solutions with a focus on patient safety and rapid healing.
                    </p>
                    <p className="mt-4">
        ...
        >
            <div className="space-y-12">
                <section>
                    <h2 className="text-3xl font-bold text-slate-900 mb-6">Why Choose Indira for ACL Reconstruction Surgery?</h2>
