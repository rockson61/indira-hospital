    ...
    return (
        <SubServiceTemplate
            ...
            description={
                <>
                    <p>
                        Searching for the <strong>best advanced fracture care in Vellore</strong>? Indira Super Speciality Hospital is a center of excellence for advanced orthopaedics care, providing precision-driven surgical solutions with a focus on patient safety and rapid healing.
                    </p>
                    <p className="mt-4">
        ...
        >
            <div className="space-y-12">
                <section>
                    <h2 className="text-3xl font-bold text-slate-900 mb-6">Why Choose Indira for Advanced Fracture Care?</h2>
                ...
                <section className="bg-slate-900 rounded-[3rem] p-12 text-white">
                    <h2 className="text-3xl font-bold mb-6">Advanced Orthopaedics Infrastructure</h2>
