...
export const metadata: Metadata = {
    title: "Advanced Fracture Care in Vellore | Indira Super Speciality Hospital",
    description: "Advanced Fracture Care at Indira Super Speciality Hospital, Vellore. NABH-accredited orthopaedics care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/orthopaedics/advanced-fracture-care",
    },
    openGraph: {
        title: "Advanced Fracture Care in Vellore | Indira Super Speciality Hospital",
        description: "Advanced Fracture Care at Indira Super Speciality Hospital, Vellore. NABH-accredited orthopaedics care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/orthopaedics/advanced-fracture-care",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Advanced Fracture Care in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Advanced Fracture Care</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Advanced Fracture Care',
                entitySlug: 'advanced-fracture-care'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Advanced Fracture Care in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Advanced Fracture Care Surgery?</h2>
