...
export const metadata: Metadata = constructMetadata({
    title: "Total Hip Replacement in Vellore | Indira Hospital",
    description: "Advanced Total Hip Replacement in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and same-day d...",
    path: "/doctor/near-me/treat/orthopaedics/total-hip-replacement"
});
