...
export const metadata: Metadata = {
    title: "Total Hip Replacement in Vellore | Indira Super Speciality Hospital",
    description: "Total Hip Replacement at Indira Super Speciality Hospital, Vellore. NABH-accredited orthopaedics care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/orthopaedics/total-hip-replacement",
    },
    openGraph: {
        title: "Total Hip Replacement in Vellore | Indira Super Speciality Hospital",
        description: "Total Hip Replacement at Indira Super Speciality Hospital, Vellore. NABH-accredited orthopaedics care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/orthopaedics/total-hip-replacement",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Total Hip Replacement in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Total Hip Replacement</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Total Hip Replacement in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Total Hip Replacement Surgery?</h2>
