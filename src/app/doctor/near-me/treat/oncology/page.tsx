...
export default function OncologyDepartmentPage() {
 ...
 <h4 className="text-2xl font-bold text-rose-300 mb-4 uppercase tracking-tighter">Radical Surgical Oncology</h4>
 ...
 <h2 className="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">The 3 Pillars of Curative Intent</h2>
 ...
 <h4 className="font-black text-rose-100 mb-6 flex items-start gap-4 group-hover:text-rose-400 transition-colors text-lg">
