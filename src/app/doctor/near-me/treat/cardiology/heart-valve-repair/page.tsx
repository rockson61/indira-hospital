...
export const metadata: Metadata = {
    title: "Heart Valve Repair in Vellore | Indira Super Speciality Hospital",
    description: "Heart Valve Repair at Indira Super Speciality Hospital, Vellore. NABH-accredited cardiology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/cardiology/heart-valve-repair",
    },
    openGraph: {
        title: "Heart Valve Repair in Vellore | Indira Super Speciality Hospital",
        description: "Heart Valve Repair at Indira Super Speciality Hospital, Vellore. NABH-accredited cardiology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/cardiology/heart-valve-repair",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Heart Valve Repair in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Heart Valve Repair</strong> at Indira Super Speciality Hospital, Vellore, is a precision-driven clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Heart Valve Repair',
                entitySlug: 'heart-valve-repair'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Heart Valve Repair in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Heart Valve Repair Surgery?</h2>
