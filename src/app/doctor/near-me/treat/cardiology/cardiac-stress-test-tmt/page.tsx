    ...
    return (
        ...
        >
            <section>
                ...
                <div className="my-10 p-8 md:p-10 bg-gradient-to-br from-green-50 to-fuchsia-50 dark:from-green-900/10 dark:to-fuchsia-900/10 rounded-[2.5rem] border border-green-100 dark:border-green-900 shadow-sm dark:shadow-slate-900/30">
                    <h4 className="text-2xl font-black text-slate-900 dark:text-white dark:text-green-300 mb-4 tracking-tight">Safety & Comfort at Indira Hospital</h4>
