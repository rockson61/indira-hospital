...
export const metadata: Metadata = {
    title: "Permanent Pacemaker Implantation in Vellore | Indira Super Speciality Hospital",
    description: "Permanent Pacemaker Implantation at Indira Super Speciality Hospital, Vellore. NABH-accredited cardiology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/cardiology/pacemaker-implantation",
    },
    openGraph: {
        title: "Permanent Pacemaker Implantation in Vellore | Indira Super Speciality Hospital",
        description: "Permanent Pacemaker Implantation at Indira Super Speciality Hospital, Vellore. NABH-accredited cardiology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/cardiology/pacemaker-implantation",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Permanent Pacemaker Implantation in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Permanent Pacemaker Implantation</strong> at Indira Super Speciality Hospital, Vellore, is a precision-driven clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Permanent Pacemaker Implantation',
                entitySlug: 'pacemaker-implantation'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Permanent Pacemaker Implantation in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Permanent Pacemaker Implantation Surgery?</h2>
