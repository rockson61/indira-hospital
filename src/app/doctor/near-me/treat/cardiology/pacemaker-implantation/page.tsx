...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Permanent Pacemaker Implantation in Vellore, Tamil Nadu"
            ...
            description={
                <>
                    <p>
                        Searching for the <strong>best permanent pacemaker implantation in Vellore</strong>? Indira Super Speciality Hospital is a center of excellence for advanced cardiology care, providing precision-driven surgical solutions with a focus on patient safety and rapid healing.
                    </p>
                    <p className="mt-4">
        ...
        >
            <div className="space-y-12">
                <section>
                    <h2 className="font-heading text-3xl font-bold text-slate-900 mb-6">Why Choose Indira for Permanent Pacemaker Implantation?</h2>
                ...
                <section className="bg-slate-900 rounded-[3rem] p-12 text-white">
                    <h2 className="font-heading text-3xl font-bold mb-6">Advanced Cardiology Infrastructure</h2>
