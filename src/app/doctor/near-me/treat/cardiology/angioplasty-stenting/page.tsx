...
export const metadata: Metadata = constructMetadata({
    title: "Angioplasty & Stenting in Vellore | Indira Hospital",
    description: "Advanced Angioplasty & Stenting in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and same-day ...",
    path: "/doctor/near-me/treat/cardiology/angioplasty-stenting"
});

export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Angioplasty & Stenting in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Angioplasty & Stenting</strong> at Indira Super Speciality Hospital, Vellore, is a precision-driven clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Angioplasty & Stenting',
                entitySlug: 'angioplasty-stenting'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Angioplasty & Stenting in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Angioplasty & Stenting Surgery?</h2>
