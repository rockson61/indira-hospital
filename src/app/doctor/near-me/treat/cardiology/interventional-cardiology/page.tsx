...
export const metadata: Metadata = constructMetadata({
    title: "Interventional Cardiology in Vellore | Indira Hospital",
    description: "Advanced Interventional Cardiology in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and same-d...",
    path: "/doctor/near-me/treat/cardiology/interventional-cardiology"
});
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Interventional Cardiology</strong> at Indira Super Speciality Hospital, Vellore, is a precision-driven clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
