    ...
    return (
        ...
        >
            <section>
                ...
                <div className="my-10 p-8 md:p-10 bg-gradient-to-br from-teal-50 to-teal-50 dark:from-violet-900/10 dark:to-teal-900/10 rounded-[2.5rem] border border-violet-100 dark:border-violet-900 shadow-sm">
