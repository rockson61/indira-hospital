    ...
    return (
        ...
        >
            <section>
                ...
                <div className="my-10 p-8 md:p-10 bg-gradient-to-br from-fuchsia-50 to-fuchsia-50 dark:from-violet-900/10 dark:to-fuchsia-900/10 rounded-[2.5rem] border border-violet-100 dark:border-violet-900 shadow-sm dark:shadow-slate-900/30">
                    <h4 className="text-2xl font-black text-slate-900 dark:text-white dark:text-violet-300 mb-4 tracking-tight">Holistic Support for Families</h4>
