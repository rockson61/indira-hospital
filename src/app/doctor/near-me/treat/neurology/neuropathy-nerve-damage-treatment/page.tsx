    ...
    return (
        <SubServiceTemplate
            ...
            relatedServices={{
                ...
                related: [
                    { title: "EEG Test Guide", href: "/doctor/near-me/treat/neurology/eeg-test-procedure" },
                    { title: "Migraine Management", href: "/doctor/near-me/treat/neurology/migraine-relief-management" },
