...
export default function NeurologyDepartmentPage() {
 ...
 <h4 className="text-2xl font-bold text-indigo-300 mb-4 uppercase tracking-tighter text-left">Epilepsy Excellence Hub</h4>
 ...
 <h2 className="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Neuroscience Excellence Domains</h2>
