...
export const metadata: Metadata = constructMetadata({
 title: "Elite Rectal Prolapse Surgery (LVMR) in Ve in Vellore | I...",
 description: "Advanced Elite Rectal Prolapse Surgery (LVMR) surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and same-d...",
 path: "/doctor/near-me/treat/proctology/rectal-prolapse-surgery"
});
...
export default function RectalProlapsePage() {
 ...
 <strong>Elite Rectal Prolapse Surgery (LVMR)</strong> is a high-precision medical procedure at Indira Super Speciality Hospital, Vellore. Our surgical team utilizes internal clinical benchmarks to ensure <strong>painless outcomes</strong> and <strong>rapid patient recovery</strong> for all procedures.
 </p>
 </article>
 }
 quickFacts={[
 ...
 <AioKnowledgeBlock 
 title="Quick Facts: Elite Rectal Prolapse Surgery (LVMR) in Vellore"
 items={[
 ...
 <p className="text-sm text-slate-500">We isolate and preserve the autonomic nerves responsible for bowel, bladder, and sexual function—a critical step often missed in conventional surgery.</p>
 </div>
 </div>
 <div className="flex items-start gap-4">
 <div className="w-10 h-10 rounded-xl bg-white dark:bg-slate-900 flex items-center justify-center shadow-md shrink-0">
 ...
 <p className="text-sm text-slate-500">Only the front part of the rectum is mobilized, ensuring the posterior attachments remain intact for maximum stability.</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <p className="text-slate-600 dark:text-subtle-on-light text-sm leading-relaxed mb-6">
 ...
 <p className="text-slate-600 dark:text-subtle-on-light">If you experience a mass protruding through the anus, it is critical to determine the stage of descent.</p>
 </div>
 ...
 <p className="text-subtle-on-light max-w-2xl mx-auto mb-12">
 ...
 <p className="text-emerald-400 font-bold mb-2 uppercase tracking-widest text-xs">{step.day}</p>
 <h5 className="font-bold text-sm mb-2">{step.title}</h5>
 <p className="text-sm text-subtle-on-light leading-relaxed font-medium">{step.text}</p>
 </div>
 ))}
 </div>
 </section>
 ...
 <span className="p-4 bg-emerald-50 dark:bg-emerald-900/30 rounded-2xl text-xs font-black uppercase text-emerald-600 flex items-center gap-2 tracking-widest">
