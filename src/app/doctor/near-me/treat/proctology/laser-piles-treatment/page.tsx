...
export const metadata: Metadata = constructMetadata({
    title: "Laser Piles Treatment in Vellore | Indira Hospital",
    description: "Advanced Laser Piles Treatment in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and same-day d...",
    path: "/doctor/near-me/treat/proctology/laser-piles-treatment"
});
