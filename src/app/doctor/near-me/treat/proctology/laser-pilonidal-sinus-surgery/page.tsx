...
export const metadata: Metadata = constructMetadata({
    title: "Laser Pilonidal Sinus Surgery (SiLaC) in Vellore | Indira...",
    description: "Advanced Laser Pilonidal Sinus Surgery (SiLaC) in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care...",
    path: "/doctor/near-me/treat/proctology/laser-pilonidal-sinus-surgery"
});
