...
export const metadata: Metadata = {
    title: "Laser Pilonidal Sinus Surgery (SiLaC) in Vellore | Indira Super Speciality Hospital",
    description: "Laser Pilonidal Sinus Surgery (SiLaC) at Indira Super Speciality Hospital, Vellore. NABH-accredited proctology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/proctology/laser-pilonidal-sinus-surgery",
    },
    openGraph: {
        title: "Laser Pilonidal Sinus Surgery (SiLaC) in Vellore | Indira Super Speciality Hospital",
        description: "Laser Pilonidal Sinus Surgery (SiLaC) at Indira Super Speciality Hospital, Vellore. NABH-accredited proctology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/proctology/laser-pilonidal-sinus-surgery",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Laser Pilonidal Sinus Surgery (SiLaC) in Vellore"
            eyebrow="Top Proctology Solutions"
            departmentName="Proctology"
            departmentSlug="proctology"
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Laser Pilonidal Sinus Surgery (SiLaC)</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Laser Pilonidal Sinus Surgery (SiLaC)',
                entitySlug: 'laser-pilonidal-sinus-surgery'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Laser Pilonidal Sinus Surgery (SiLaC) in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Laser Pilonidal Sinus Surgery (SiLaC) Surgery?</h2>
                    ...
                    <section className="bg-slate-900 rounded-[3rem] p-12 text-white">
                        <h2 className="text-3xl font-black text-white mb-6">How Does Proctology Treatment Work?</h2>
                        <p className="text-fuchsia-200/80 text-lg mb-8">
                            Our hospital is equipped with high-end medical technology to support complex proctology procedures, reducing surgical time and enhancing safety.
                        </p>
