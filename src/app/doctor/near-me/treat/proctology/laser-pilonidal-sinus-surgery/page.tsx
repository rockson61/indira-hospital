...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Laser Pilonidal Sinus Surgery (SiLaC) in Vellore, Tamil Nadu"
        ...
        >
            <div className="space-y-12">
                <section>
                    <h2 className="font-heading text-3xl font-bold text-slate-900 mb-6">Why Choose Indira for Laser Pilonidal Sinus Surgery (SiLaC)?</h2>
