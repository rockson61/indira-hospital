...
export const metadata: Metadata = constructMetadata({
 title: "Elite IBS & Chronic Constipation Managemen in Vellore | I...",
 description: "Advanced Elite IBS & Chronic Constipation Management surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and...",
 path: "/doctor/near-me/treat/proctology/ibs-and-constipation-management"
});
...
export default function IBSConstipationPage() {
 ...
 <strong>Elite IBS & Chronic Constipation Management</strong> is a high-precision medical procedure at Indira Super Speciality Hospital, Vellore. Our surgical team utilizes internal clinical benchmarks to ensure <strong>painless outcomes</strong> and <strong>rapid patient recovery</strong> for all procedures.
 </p>
 </article>
 }
 quickFacts={[
 ...
 <AioKnowledgeBlock 
 title="Quick Facts: Elite IBS & Chronic Constipation Management in Vellore"
 items={[
 ...
 <h3 className="font-heading text-3xl font-bold text-slate-900 dark:text-white mb-4 font-heading tracking-tighter">Motility Restoration Timeline</h3>
 <p className="text-slate-600 dark:text-subtle-on-light">Reclaiming your digestive health is a structured journey, not a quick fix.</p>
 </div>
 ...
 <p className="text-emerald-500 font-black mb-2 uppercase tracking-widest text-xs">{step.day}</p>
