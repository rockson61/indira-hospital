...
export const metadata: Metadata = {
    title: "Laser Fistula Surgery (FiLaC) in Vellore | Indira Super Speciality Hospital",
    description: "Laser Fistula Surgery (FiLaC) at Indira Super Speciality Hospital, Vellore. NABH-accredited proctology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/proctology/laser-fistula-surgery-filac",
    },
    openGraph: {
        title: "Laser Fistula Surgery (FiLaC) in Vellore | Indira Super Speciality Hospital",
        description: "Laser Fistula Surgery (FiLaC) at Indira Super Speciality Hospital, Vellore. NABH-accredited proctology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/proctology/laser-fistula-surgery-filac",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Laser Fistula Surgery (FiLaC) in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Laser Fistula Surgery (FiLaC)</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                ...
                entitySlug: 'laser-fistula-surgery-filac'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Laser Fistula Surgery (FiLaC) Surgery?</h2>
