    ...
    return (
        <SubServiceTemplate
            ...
            description={
                <>
                    <p>
                        Searching for the <strong>best laser fissure treatment in Vellore</strong>? Indira Super Speciality Hospital is a center of excellence for advanced proctology care, providing precision-driven surgical solutions with a focus on patient safety and rapid healing.
                    </p>
                    <p className="mt-4">
            ...
            quickFacts={[
                ...
                { label: 'Tech Level', value: 'Advanced', icon: 'Sparkles' },
        ...
        >
            <div className="space-y-12">
                <section>
                    <h2 className="text-3xl font-bold text-slate-900 mb-6">Why Choose Indira for Laser Fissure Treatment?</h2>
