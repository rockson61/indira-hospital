...
export const metadata: Metadata = {
    title: "Laser Fissure Treatment in Vellore | Indira Super Speciality Hospital",
    description: "Laser Fissure Treatment at Indira Super Speciality Hospital, Vellore. NABH-accredited proctology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/proctology/laser-fissure-treatment",
    },
    openGraph: {
        title: "Laser Fissure Treatment in Vellore | Indira Super Speciality Hospital",
        description: "Laser Fissure Treatment at Indira Super Speciality Hospital, Vellore. NABH-accredited proctology care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/proctology/laser-fissure-treatment",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Laser Fissure Treatment in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Laser Fissure Treatment</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Laser Fissure Treatment',
                entitySlug: 'laser-fissure-treatment'
            }}
            showAvailabilityCTA={true}
            showVideoBank={true}
            duration="20 Mins"
            hospitalStay="Daycare (4 hrs)"
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Laser Fissure Treatment in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Laser Fissure Treatment Surgery?</h2>
