...
export const metadata: Metadata = {
    title: "Lipoma Removal in Vellore | Indira Super Speciality Hospital",
    description: "Lipoma Removal at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/general-surgery/lipoma-excision-surgery",
    },
    openGraph: {
        title: "Lipoma Removal in Vellore | Indira Super Speciality Hospital",
        description: "Lipoma Removal at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/general-surgery/lipoma-excision-surgery",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Lipoma Removal in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Lipoma Removal</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Lipoma Removal',
                entitySlug: 'lipoma-excision-surgery'
            }}
            showAvailabilityCTA={true}
            showVideoBank={true}
            duration="15-20 Mins"
            hospitalStay="Daycare (2 hrs)"
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Lipoma Removal in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Lipoma Removal Surgery?</h2>
