...
export const metadata: Metadata = {
    title: "Laser Varicose Veins in Vellore | Indira Super Speciality Hospital",
    description: "Laser Varicose Veins at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/general-surgery/varicose-veins-laser-treatment",
    },
    openGraph: {
        title: "Laser Varicose Veins in Vellore | Indira Super Speciality Hospital",
        description: "Laser Varicose Veins at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/general-surgery/varicose-veins-laser-treatment",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Laser Varicose Veins in Vellore"
            eyebrow="Top General Surgery Solutions"
            departmentName="General Surgery"
            departmentSlug="general-surgery"
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Laser Varicose Veins</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Laser Varicose Veins',
                entitySlug: 'varicose-veins-laser-treatment'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Laser Varicose Veins in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Laser Varicose Veins Surgery?</h2>
                    ...
                    <section className="bg-slate-900 rounded-[3rem] p-12 text-white">
                        <h2 className="text-3xl font-black text-white mb-6">How Does General Surgery Treatment Work?</h2>
                        <p className="text-fuchsia-200/80 text-lg mb-8">
                            Our hospital is equipped with high-end medical technology to support complex general surgery procedures, reducing surgical time and enhancing safety.
                        </p>
