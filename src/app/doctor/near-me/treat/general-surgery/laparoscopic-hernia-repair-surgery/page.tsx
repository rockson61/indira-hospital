    ...
    return (
        <SubServiceTemplate
            ...
            description={
                <>
                    <p>
                        Searching for the <strong>best laparoscopic hernia repair in Vellore</strong>? Indira Super Speciality Hospital is a center of excellence for advanced general surgery care, providing precision-driven surgical solutions with a focus on patient safety and rapid healing.
                    </p>
                    <p className="mt-4">
