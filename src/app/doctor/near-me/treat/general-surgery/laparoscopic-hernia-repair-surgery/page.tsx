            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Laparoscopic Hernia Repair</strong> at Indira Super Speciality Hospital, Vellore, is a precision-driven clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
