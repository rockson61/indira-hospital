...
export const metadata: Metadata = {
    title: "Laparoscopic Hernia Repair in Vellore | Indira Super Speciality Hospital",
    description: "Laparoscopic Hernia Repair at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/general-surgery/laparoscopic-hernia-repair-surgery",
    },
    openGraph: {
        title: "Laparoscopic Hernia Repair in Vellore | Indira Super Speciality Hospital",
        description: "Laparoscopic Hernia Repair at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/general-surgery/laparoscopic-hernia-repair-surgery",
        type: 'website',
    },
}
    ...
    return (
        <SubServiceTemplate
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Laparoscopic Hernia Repair</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                ...
                entitySlug: 'laparoscopic-hernia-repair-surgery'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Laparoscopic Hernia Repair in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Laparoscopic Hernia Repair Surgery?</h2>
