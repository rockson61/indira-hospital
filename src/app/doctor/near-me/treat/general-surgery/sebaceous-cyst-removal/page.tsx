...
export const metadata: Metadata = constructMetadata({
    title: "Cyst Excision | Indira Hospital in Vellore | Indira Hospital",
    description: "Advanced Cyst Excision in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and same-day discharge.",
    path: "/doctor/near-me/treat/general-surgery/sebaceous-cyst-removal"
});
