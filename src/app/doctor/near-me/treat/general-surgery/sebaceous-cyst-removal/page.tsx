...
export const metadata: Metadata = {
    title: "Cyst Excision in Vellore | Indira Super Speciality Hospital",
    description: "Cyst Excision at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/general-surgery/sebaceous-cyst-removal",
    },
    openGraph: {
        title: "Cyst Excision in Vellore | Indira Super Speciality Hospital",
        description: "Cyst Excision at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/general-surgery/sebaceous-cyst-removal",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Cyst Excision in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Cyst Excision</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Cyst Excision',
                entitySlug: 'sebaceous-cyst-removal'
            }}
            showAvailabilityCTA={true}
            showVideoBank={true}
            duration="15 Mins"
            hospitalStay="Daycare (1 hr)"
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Cyst Excision in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Cyst Excision Surgery?</h2>
