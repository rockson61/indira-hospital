...
export const metadata: Metadata = constructMetadata({
    title: "Diabetic Foot Care in Vellore | Indira Hospital",
    description: "Advanced Diabetic Foot Care in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and same-day disc...",
    path: "/doctor/near-me/treat/general-surgery/diabetic-foot-ulcer-care"
});
