...
export const metadata: Metadata = {
    title: "Laparoscopic Cholecystectomy in Vellore | Indira Super Speciality Hospital",
    description: "Laparoscopic Cholecystectomy at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/general-surgery/laparoscopic-cholecystectomy-gallbladder-removal",
    },
    openGraph: {
        title: "Laparoscopic Cholecystectomy in Vellore | Indira Super Speciality Hospital",
        description: "Laparoscopic Cholecystectomy at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/general-surgery/laparoscopic-cholecystectomy-gallbladder-removal",
        type: 'website',
    },
}
    ...
    return (
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Laparoscopic Cholecystectomy</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Laparoscopic Cholecystectomy in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Laparoscopic Cholecystectomy Surgery?</h2>
