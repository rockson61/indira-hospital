    ...
    return (
        ...
        >
            <section>
                ...
                <div className="my-10 p-8 md:p-10 bg-gradient-to-br from-pink-50 to-fuchsia-50 dark:from-pink-900/10 dark:to-fuchsia-900/10 rounded-[2.5rem] border border-pink-100 dark:border-pink-900 shadow-sm dark:shadow-slate-900/30">
                    <h4 className="text-2xl font-black text-slate-900 dark:text-white dark:text-pink-300 mb-4 tracking-tight">Advanced Proctology Unit</h4>
