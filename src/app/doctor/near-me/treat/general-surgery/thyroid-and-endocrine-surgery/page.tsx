...
export const metadata: Metadata = {
    title: "Thyroid Surgery in Vellore | Indira Super Speciality Hospital",
    description: "Thyroid Surgery at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
    alternates: {
        canonical: "/doctor/near-me/treat/general-surgery/thyroid-and-endocrine-surgery",
    },
    openGraph: {
        title: "Thyroid Surgery in Vellore | Indira Super Speciality Hospital",
        description: "Thyroid Surgery at Indira Super Speciality Hospital, Vellore. NABH-accredited general surgery care with advanced technology, experienced specialists, and fast recovery. Book a consultation today.",
        url: "/doctor/near-me/treat/general-surgery/thyroid-and-endocrine-surgery",
        type: 'website',
    },
}
...
export default function SEOPage() {
    return (
        <SubServiceTemplate
            title="Thyroid Surgery in Vellore"
            ...
            description={
                <article>
                    <p className="text-lg leading-relaxed">
                        <strong>Thyroid Surgery</strong> at Indira Super Speciality Hospital, Vellore, is a top-rated clinical procedure. Our surgical experts utilize advanced medical protocols to ensure <strong>painless outcomes</strong> and <strong>accelerated patient recovery</strong> for all procedures.
                    </p>
                </article>
            }
            quickFacts={[
            ...
            reviews={{
                entityType: 'service',
                entityName: 'Thyroid Surgery',
                entitySlug: 'thyroid-and-endocrine-surgery'
            }}
        ...
        >
            <div className="space-y-16">
                ...
                <AioKnowledgeBlock 
                    title="Quick Facts: Thyroid Surgery in Vellore"
                    items={[
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">What are the Benefits of Thyroid Surgery Surgery?</h2>
