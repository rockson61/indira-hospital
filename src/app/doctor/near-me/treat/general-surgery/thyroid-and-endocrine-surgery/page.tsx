...
export const metadata: Metadata = constructMetadata({
    title: "Thyroid Surgery in Vellore | Indira Hospital",
    description: "Advanced Thyroid Surgery in Vellore surgery at Indira Super Speciality Hospital, Vellore. Expert specialists, NABH accredited care, and same-day discharge.",
    path: "/doctor/near-me/treat/general-surgery/thyroid-and-endocrine-surgery"
});
