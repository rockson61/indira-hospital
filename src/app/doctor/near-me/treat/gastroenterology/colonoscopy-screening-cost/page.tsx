...
export default function ColonoscopyPage() {
 ...
 <p className="text-slate-600 dark:text-subtle-on-light">Regular colonoscopy screening can reduce the risk of colon cancer by up to 90%.</p>
 </div>
 ...
 <p className="text-subtle-on-light max-w-2xl mx-auto mb-12 leading-relaxed">
 ...
 <h4 className="font-bold mb-2 text-sm uppercase tracking-widest">{box.title}</h4>
 <p className="text-xs text-subtle-on-light font-medium">{box.text}</p>
 </div>
 ))}
 </div>
 </section>
