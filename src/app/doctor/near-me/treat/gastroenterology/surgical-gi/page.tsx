...
export default function SurgicalGastroPage() {
 ...
 <p className="text-slate-600 dark:text-subtle-on-light text-sm leading-relaxed mb-6 font-medium">
 ...
 <p className="text-slate-600 dark:text-subtle-on-light">From oncology to complex hernias, we manage the most challenging abdominal pathology.</p>
 </div>
 ...
 <p className="text-sm text-slate-600 dark:text-subtle-on-light leading-relaxed font-heading">{item.desc}</p>
 </div>
 ))}
 </div>
 </section>
 ...
 <p className="text-sm text-subtle-on-light leading-relaxed antialiased">{step.text}</p>
 </div>
 ))}
 </div>
 </section>
