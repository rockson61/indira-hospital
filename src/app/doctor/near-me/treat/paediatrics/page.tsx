...
export default function PaediatricsDepartmentPage() {
 return (
 <DepartmentTemplate
 title="Paediatrics & Neonatology Hub in Vellore, Tamil Nadu"
 slug="paediatrics"
 ...
 <h4 className="text-2xl font-bold text-rose-300 mb-4 uppercase tracking-tighter text-left">Pediatric Surgical Excellence</h4>
 ...
 <h2 className="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Total Child Wellness Pillars</h2>
 ...
 <div className="p-10 rounded-[3rem] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm transition-all hover:border-rose-600">
 <h5 className="text-xl font-bold text-slate-900 dark:text-white mb-4 uppercase">Growth & Obesity Clinic</h5>
 <p className="text-sm text-slate-500 leading-relaxed font-medium">
