...
import { Droplets, Shield, Zap, Award, Clock, Users, Microscope, Heart, Activity, CheckCircle2 } from "lucide-react"
...
export default function NephrologyDepartmentPage() {
    ...
    return (
        <DepartmentTemplate
            title="Elite Renal Sciences & Nephrology Hub"
            slug="nephrology"
            ...
            fullDescription={`
                <div className="nephrology-pillar-content space-y-20 text-left">
                    ...
                    <section className="intro prose prose-lg max-w-none prose-slate dark:prose-invert">
                        <h2 className="text-4xl font-black text-slate-900 dark:text-white font-primary italic border-l-8 border-indigo-600 pl-6 mb-8 uppercase tracking-tight">
                        ...
                        <div className="text-xl leading-relaxed text-slate-700 dark:text-slate-300">
                            <p>
                                Your kidneys are the master chemists of your body. The **Department of Nephrology & Renal Sciences** at Indira Super Speciality Hospital is a regional benchmark for kidney function preservation and advanced blood purification. We operate on a clinical principle of **"Preservation First"**—utilizing evidence-based medicine to slow the progression of chronic kidney disease (CKD).
                            </p>
                            <p className="mt-4">
                                Our facility features a high-capacity **24/7 Dialysis Unit** equipped with high-flux filters that clear more toxins than standard systems. For critically ill patients in our ICU, we provide **CRRT (Continuous Renal Replacement Therapy)**, ensuring stable kidney support even in hemodynamically unstable cases.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mt-12 not-prose">
                            <div className="p-8 bg-indigo-50 dark:bg-indigo-900/20 rounded-[2.5rem] border border-indigo-100 dark:border-indigo-800 shadow-sm relative overflow-hidden group">
                                ...
                                <div className="flex flex-wrap gap-2 text-[10px] font-black uppercase tracking-tighter">
                                    <span className="px-3 py-1 bg-white dark:bg-slate-800 rounded-full border border-indigo-100 dark:border-indigo-700">Ultrapure Water (RO)</span>
                                    <span className="px-3 py-1 bg-white dark:bg-slate-800 rounded-full border border-indigo-100 dark:border-indigo-700">Zero-Hepatitis Risk</span>
                                </div>
                            </div>
                            <div className="p-8 bg-slate-900 text-white rounded-[2.5rem] border border-slate-800 shadow-xl relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold text-indigo-300 mb-4 italic uppercase tracking-tighter">CKD Preservation Clinic</h4>
                                <p className="text-indigo-100/60 text-sm leading-relaxed mb-6 italic font-medium">
                                    Avoiding the need for dialysis. We utilize the latest in **SGLT2 inhibitors** and precision hypertension control to protect your remaining nephrons.
                                </p>
                    ...
                    <section className="prose prose-lg max-w-none prose-slate dark:prose-invert bg-indigo-50 dark:bg-slate-950 p-12 md:p-20 rounded-[4rem] border border-indigo-100 dark:border-slate-800 font-serif italic shadow-inner relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/5 blur-[100px] -mr-32 -mt-32"></div>
                        <h3 className="text-indigo-900 dark:text-indigo-400 font-black uppercase text-3xl tracking-tighter not-italic font-primary italic text-left">Clinical Insight: The Dialysis Purity Paradox</h3>
                        <p>
                            Not all dialysis is created equal. The standard version clears small molecules like Urea and Creatinine. However, **High-Flux Hemodialysis** is required to clear "Middle Molecules" (like Beta-2 Microglobulin) that cause chronic itching, bone pain, and heart damage in long-term patients.
                        </p>
                        <p className="mt-4">
                            At Indira Hospital, our **Purity Standards** ensuring:
                        </p>
                            ...
                            {[
                                {
                                    ...
                                    a: "CKD is defined as permanent structural damage. While it cannot be 'reversed' to normal, it can be **stabilized.** With strict blood pressure control, proper diet, and avoiding nephrotoxic drugs (like certain painkillers), we can delay the need for dialysis by decades."
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    a: "Not if managed early. **Diabetic Nephropathy** is preventable. Regular screening for 'Microalbuminuria' (trace protein in urine) allows us to detect kidney strain years before any failure occurs."
                                },
                                {
                                    q: "Why do dialysis patients feel itchy or have bone pain?",
                                    a: "This is often due to high Phosphorus levels or the buildup of larger uremic toxins. Switching to **High-Flux Dialysis** and strict dietary phosphorus management (avoiding certain colas and processed foods) can significantly alleviate these symptoms."
                                },
                                {
            ...
            procedures={[
                ...
                { name: "Transplant Workup Suire", link: "/doctor/near-me/treat/nephrology" }
            ]}
