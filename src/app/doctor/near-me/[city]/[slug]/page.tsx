...
async function ServiceView({ service, location, city, slug }: any) {
 ...
 <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-indigo-300 text-[10px] font-black uppercase tracking-[0.4em] mb-10 shadow-2xl">
