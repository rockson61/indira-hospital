...
async function DoctorView({ doctor, location, city, slug }: any) {
 ...
 <nav className="flex flex-wrap items-center text-sm breadcrumb-on-dark mb-10 gap-1">
 ...
 <div className="w-32 h-32 sm:w-44 sm:h-44 rounded-[2.5rem] overflow-hidden border-4 border-slate-200 dark:border-slate-800 shadow-2xl bg-white dark:bg-slate-900 group hover:scale-105 transition-transform duration-500 relative">
 ...
 <p className="text-subtle-on-light text-lg mb-8 font-medium">Indira Super Speciality Hospital, Vellore</p>
 ...
 <div key={label} className="flex items-center gap-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl px-5 py-3 shadow-2xl">
 ...
 <div>
 <span className="block text-sm font-semibold uppercase tracking-wider text-subtle-on-light mb-2 mt-4">Available Transport Options</span>
 <div className="flex flex-wrap gap-2">
 {location.transportOptions?.bus && <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-md text-sm font-medium">Bus Route</span>}
 {location.transportOptions?.train && <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-md text-sm font-medium">Direct Train</span>}
 {location.transportOptions?.taxi && <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-md text-sm font-medium">Taxi Service</span>}
 </div>
 </div>
 </div>
 </div>
...
async function ServiceView({ service, location, city, slug }: any) {
 ...
 <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-indigo-300 text-xs font-black uppercase tracking-widest mb-10 shadow-2xl">
 ...
 {item.description && <p className="text-sm text-subtle-on-light">{item.description}</p>}
 </div>
 </div>
 );
 })}
 ...
 <p className="text-sm text-subtle-on-dark mb-6">
 ...
 <p className="text-sm font-bold text-indigo-900 dark:text-indigo-300 uppercase mb-2">Estimated Cost</p>
 <p className="text-lg font-black text-indigo-600 dark:text-indigo-400">Starting from ₹15,000*</p>
 <p className="text-xs text-subtle-on-light mt-1">*Final cost depends on clinical evaluation & room category.</p>
 </div>
 <div className="space-y-2">
 <p className="text-sm font-bold text-subtle-on-light uppercase">Coverage Supported</p>
