...
export default async function LocationDoctorPage({
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-800 min-h-screen">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                <div className="col-span-2">
                    <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-[2rem] p-8 shadow-sm mb-8">
                        ...
                        <div className="flex items-center gap-4 pt-6 border-t border-slate-50">
                            <div className="px-4 py-2 bg-slate-50 dark:bg-slate-800 rounded-xl">
                                <span className="font-black text-slate-900 dark:text-white">{currDoctor.experience}+ Years</span>
                                <span className="text-xs text-slate-500 dark:text-slate-400 ml-2 uppercase tracking-widest font-bold">Experience</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-1">
                    <div className="bg-slate-900 border border-slate-800 rounded-[2rem] p-8 shadow-2xl sticky top-24 text-white">
                        ...
                        <a
                            ...
                            className="block w-full text-center px-6 py-4 bg-fuchsia-500 text-slate-900 dark:text-white font-black rounded-2xl hover:bg-fuchsia-400 transition-all hover:scale-[1.02] shadow-lg shadow-fuchsia-500/20"
                        >
