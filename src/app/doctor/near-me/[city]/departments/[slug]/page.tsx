            ...
            <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-900">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="max-w-3xl">
                        ...
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-teal-300 text-sm font-bold tracking-widest uppercase mb-8 shadow-[0_0_30px_-5px_var(--tw-shadow-color)] shadow-teal-500/30">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 -mt-16 lg:-mt-24 relative z-20">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div className="bg-white rounded-[2rem] p-8 sm:p-12 shadow-xl shadow-slate-200/40 border border-slate-100">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                {currDept.features.map((feature, i) => {
                                    ...
                                    return (
                                        <div key={i} className="group relative p-6 bg-slate-50 rounded-2xl border border-slate-100/60 hover:border-teal-200 hover:bg-teal-50/50 transition-all duration-300 hover:shadow-lg hover:shadow-teal-100/50 hover:-translate-y-1">
                                            <div className="flex items-start gap-4">
                                                <div className="p-2.5 bg-white rounded-xl shadow-sm group-hover:bg-teal-500 group-hover:text-white transition-colors duration-300 text-slate-400">
                    ...
                    <div className="lg:col-span-4 sticky top-32">
                        <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900 rounded-[2rem] p-10 overflow-hidden shadow-2xl shadow-teal-900/20 group">
                            {/* Animated Background Elements */}
                            <div className="absolute top-0 right-0 w-48 h-48 bg-teal-500/20 rounded-full blur-[60px] group-hover:bg-teal-400/30 transition-colors duration-700" />
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-teal-100/70 font-light mb-10 leading-relaxed">
                                    Experience world-class {currDept.name.toLowerCase()} care without leaving {formattedCity}. Skip the queue and book directly.
                                </p>

                                <a
                                    href="/book-appointment"
                                    className="relative flex items-center justify-between w-full px-8 py-5 bg-teal-500 hover:bg-teal-400 text-[#002b36] font-black rounded-2xl transition-all duration-300 hover:scale-[1.02] shadow-[0_0_40px_-10px_var(--tw-shadow-color)] shadow-teal-400/50 overflow-hidden group/btn"
                                >
                                ...
                                <div className="mt-8 pt-8 border-t border-white/10 flex items-center justify-between text-xs text-teal-100/40 uppercase tracking-widest font-bold">
