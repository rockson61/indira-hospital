...
export default function DoctorsDirectoryClient() {
 ...
 <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-fuchsia-300 text-sm font-bold tracking-widest uppercase mb-10 shadow-[0_0_30px_-5px_var(--tw-shadow-color)] shadow-fuchsia-500/30">
 ...
 <div className="max-w-4xl mx-auto bg-white dark:bg-slate-900 p-3 sm:p-5 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.6)] flex flex-col lg:flex-row gap-4">
 ...
 <select
 className="block w-full pl-18 pr-12 py-5 sm:py-6 bg-white dark:bg-slate-900 text-white rounded-3xl focus:ring-4 focus:ring-fuchsia-500/20 focus:bg-slate-900 transition-all outline-none appearance-none font-bold border border-transparent focus:border-slate-200 dark:border-slate-800 text-xl cursor-pointer"
 value={selectedDept}
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium text-xl mb-12 max-w-md mx-auto">{DOCTORS_DIRECTORY.DEFAULT_NO_DOCTORS_SUGGESTION}</p>
 <button
 ...
 >
 <div className="relative h-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/50 rounded-[3.5rem] p-10 lg:p-14 hover:bg-white dark:bg-slate-900 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] hover:-translate-y-2 transition-all duration-700 flex flex-col overflow-hidden">
 ...
 />
 <div className="pt-2">
 <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-fuchsia-50 dark:bg-fuchsia-950 border border-fuchsia-100 text-xs font-black uppercase tracking-[0.2em] text-fuchsia-600 mb-4 shadow-sm group-hover:bg-fuchsia-500 group-hover:text-white transition-colors">
 ...
 <div className="flex items-center gap-2 text-sm text-subtle-on-light font-black uppercase tracking-widest">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light text-lg lg:text-xl line-clamp-3 leading-relaxed mb-12 flex-grow font-light relative z-10">
 {doctor.bio}
 </p>
 ...
 <div className="flex items-center gap-2 text-xs font-black text-subtle-on-light uppercase tracking-widest mb-1">
 ...
 className="text-sm font-black text-subtle-on-light hover:text-fuchsia-600 uppercase tracking-[0.2em] transition-all flex items-center gap-2"
 >
