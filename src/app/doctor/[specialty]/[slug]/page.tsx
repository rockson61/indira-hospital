...
export default async function DoctorProfileRoute({
 ...
 name={currDoctor.name}
 initials={initials}
 className="w-32 h-32 md:w-44 md:h-44 rounded-[2.5rem] border-4 border-slate-200 dark:border-slate-800 shadow-2xl bg-white dark:bg-slate-900"
 />
 <div>
 <div className="mb-10">
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full text-xs font-semibold text-white/70 hover:bg-white dark:bg-slate-900 transition-colors"
 >
 {dept.title} Dept.
 </Link>
 )}
 ...
 {dept && (
 <Link href={`/departments/${dept.slug}`} className="inline-flex items-center gap-1.5 px-3 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full text-xs font-semibold text-white/70 hover:bg-white dark:bg-slate-900 transition-colors">
 {dept.title} Dept.
 </Link>
 )}
 </div>
 ...
 {comparisonType && (
 <div className="mt-8 inline-flex items-center gap-4 p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-xl">
