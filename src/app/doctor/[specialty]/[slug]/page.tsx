...
export default async function DoctorProfileRoute({
 ...
 return (
  ...
  {/* Breadcrumb */}
  <nav className="flex items-center text-xs tracking-wider uppercase text-indigo-300/60 mb-8 font-semibold">
  ...
  <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-fuchsia-300 text-xs font-black tracking-widest uppercase shadow-lg">
  ...
  <span
  key={tag}
  className="inline-flex items-center gap-1.5 px-3 py-1 bg-fuchsia-500/10 border border-fuchsia-500/20 rounded-full text-xs font-semibold text-fuchsia-200"
  >
  ...
  className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs font-semibold text-slate-300 hover:bg-white/10 transition-colors"
  >
  {dept.title} Dept.
  </Link>
  )}
  ...
  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Years Experience</p>
  </div>
  <div className="bg-white/5 border border-white/10 rounded-2xl p-4 text-center backdrop-blur-md hover:bg-white/10 hover:border-white/20 transition-all duration-300">
  <Star className="w-5 h-5 text-amber-400 mx-auto mb-2" />
  <p className="text-2xl font-black text-white">4.9</p>
  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Patient Rating</p>
  </div>
  <div className="bg-white/5 border border-white/10 rounded-2xl p-4 text-center backdrop-blur-md hover:bg-white/10 hover:border-white/20 transition-all duration-300">
  ...
  <p className="text-xs text-slate-500 dark:text-slate-400">Direct clinic scheduling for standard and surgical checkups.</p>
  </div>
  ...
  >
  <div className="w-6 h-6 rounded-lg bg-white dark:bg-slate-900 flex items-center justify-center flex-shrink-0 shadow-sm text-fuchsia-600 dark:text-fuchsia-400 font-bold text-xs">
  {i + 1}
  </div>
  ...
  <span className="text-fuchsia-700 dark:text-fuchsia-300 font-bold text-xs">
