...
export function GuidesClient() {
 ...
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-sm font-black tracking-widest uppercase">
 ...
 <p className="text-lg md:text-xl text-slate-500 dark:text-subtle-on-light font-medium leading-relaxed max-w-3xl mx-auto">
 ...
 <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-subtle-on-light"/>
 <Input 
 ...
 <p className="text-sm text-slate-500 dark:text-subtle-on-light font-medium">
 {guide.subtitle}
 </p>
 </div>
 <div className="flex gap-2 mt-10">
 <Button size="sm"variant="outline"className="rounded-full border-slate-200 dark:border-slate-700 text-sm font-bold hover:bg-slate-100 dark:hover:bg-slate-800">
 <Download className="w-3.5 h-3.5 mr-2"/> Download PDF
 </Button>
 <Button size="sm"variant="ghost"className="rounded-full text-sm font-bold text-subtle-on-light">
 <Printer className="w-3.5 h-3.5 mr-2"/> Print
 </Button>
 </div>
 </div>

 <div className="lg:w-2/3 p-10 bg-slate-50/50 dark:bg-slate-900">
 <div className="flex items-center gap-2 mb-8">
 <Clock className="w-4 h-4 text-subtle-on-light"/>
 <span className="text-xs font-black text-subtle-on-light uppercase tracking-[0.2em]">The Clinical Protocol</span>
 </div>
 
 <div className="grid sm:grid-cols-2 gap-8">
 {guide.steps.map((step, si) => (
 <div key={si} className="flex gap-4 group">
 <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-sm font-black text-slate-900 dark:text-white group-hover:bg-purple-600 group-hover:text-white transition-colors duration-500">
 {si + 1}
 </div>
 <div className="space-y-1">
 <h4 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider">{step}</h4>
 <p className="text-sm text-slate-500 dark:text-subtle-on-light font-medium leading-relaxed">Verified by Indira Elite Medical Board for optimal outcomes.</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <Button 
 variant="link"
 className="text-purple-600 dark:text-purple-400 font-black uppercase text-sm tracking-[0.2em] p-0 group"
 ...
 <Button 
 variant="outline"
 className="h-14 px-8 rounded-xl border-slate-200 dark:border-slate-800 hover:bg-white dark:bg-slate-900 font-bold"
 ...
 <p className="text-sm text-subtle-on-light font-medium">Every guide is reviewed annually by our clinical chiefs.</p>
 </div>
 </div>
 </div>
 </div>
