...
export default function ProviderResourcesPage() {
 ...
 <div key={i} className="bg-slate-50 dark:bg-slate-900 p-8 rounded-[3rem] border border-slate-100 dark:border-slate-800 hover:border-fuchsia-200 transition-all group">
 ...
 <p className="text-slate-600 dark:text-subtle-on-light font-medium leading-relaxed text-sm">{resource.description}</p>
 </div>
 ))}
 </div>
 </section>
 ...
 <div key={i} className="p-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl text-center">
