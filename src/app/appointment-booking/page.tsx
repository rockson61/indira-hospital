...
export default function AppointmentBookingPage() {
 ...
 <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-indigo-400 text-[10px] font-black tracking-widest uppercase mb-8">
