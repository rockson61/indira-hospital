...
export default async function HealthPackagesPage() {
 ...
 {pkg.is_featured && (
 <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-gradient-to-r from-amber-400 to-orange-500 text-white text-sm font-black rounded-full mb-6 uppercase tracking-widest shadow-lg shadow-orange-500/30 w-fit">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light text-sm mb-6 line-clamp-2 font-medium leading-relaxed">
 ...
 <p className="text-sm font-black text-subtle-on-light uppercase tracking-widest flex items-center gap-2">
 ...
 <span key={i} className="flex items-center gap-1.5 text-sm font-bold text-slate-600 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 px-3 py-1.5 rounded-xl group-hover:border-fuchsia-100 group-hover:bg-fuchsia-50 dark:bg-fuchsia-950 shadow-sm transition-colors">
 <Check className="w-3.5 h-3.5 text-fuchsia-500"/>
 {test.trim()}
 </span>
 ))}
 {pkg.tests_included && pkg.tests_included.split(',').length > 5 && (
 <span className="text-sm font-bold text-subtle-on-light py-1.5 px-2 bg-slate-50 dark:bg-slate-800 rounded-xl border border-dashed border-slate-200 dark:border-slate-700">+{pkg.tests_included.split(',').length - 5} more</span>
 )}
 </div>
 </div>
 </div>
 ...
 {packages.length === 0 && (
 <div className="text-center py-24 bg-white dark:bg-slate-900 rounded-[3rem] border-2 border-dashed border-slate-200 dark:border-slate-700 mt-12">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light max-w-md mx-auto mb-8">
 ...
 <InternalLinkGrid type="diagnostics"title="Individual Lab Tests"subtitle="Pathology & Imaging"limit={12} className="bg-slate-50 dark:bg-slate-900 border-t"/>
 ...
 <InternalLinkGrid type="locations"title="Serving Patients Across Tamil Nadu"subtitle="Location Directory"limit={16} className="bg-slate-50 dark:bg-slate-900 border-t"/>

 {/* WHY DIAGNOSTIC BENTO */}
 <SectionContainer className="pb-24">
 <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-fuchsia-950 rounded-[4rem] border border-slate-200 dark:border-slate-800 overflow-hidden shadow-2xl relative group/cta">
 ...
 <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-fuchsia-300 text-sm font-bold tracking-widest uppercase mb-6 w-fit">
 Clinical Excellence
 </div>
 ...
 <div className="w-14 h-14 rounded-2xl bg-white dark:bg-slate-900 flex items-center justify-center flex-shrink-0 border border-slate-200 dark:border-slate-800 group-hover:bg-fuchsia-500 transition-colors duration-300">
 ...
 <p className="text-subtle-on-light leading-relaxed font-light">Precision diagnostics driven by specialized doctors utilizing our 3T MRI and advanced imaging suites.</p>
 </div>
 </div>
 <div className="flex gap-6 items-start group">
 <div className="w-14 h-14 rounded-2xl bg-white dark:bg-slate-900 flex items-center justify-center flex-shrink-0 border border-slate-200 dark:border-slate-800 group-hover:bg-fuchsia-500 transition-colors duration-300">
 ...
 <p className="text-subtle-on-light leading-relaxed font-light">We don't merely provide reports; our clinical team provides a structured path to ongoing wellness and recovery.</p>
 </div>
 </div>
 </div>
 </div>
 <div className="hidden lg:block relative min-h-[400px] border-l border-slate-200 dark:border-slate-800 rounded-r-[4rem] overflow-hidden bg-[url('/images/hospital/Consultation.webp')] bg-cover bg-center">
 <div className="absolute inset-0 bg-slate-900 dark:bg-slate-900 -[2px]"></div>
 </div>
 </div>
 </div>
 </SectionContainer>
