...
export default function FAQClient() {
 ...
 <ChevronDown className="w-5 h-5 text-subtle-on-light group-open:rotate-180 transition-transform duration-500 ease-in-out"/>
 </div>
 </summary>
 <div className="px-8 pb-8 pt-2 pl-24 text-slate-600 text-lg leading-relaxed border-t border-slate-50/50">
 {faq.answer}
 <div className="mt-6 flex items-center gap-2">
 <span className="text-xs font-black uppercase tracking-widest bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-full text-subtle-on-light">
 {faq.category}
 </span>
 </div>
 </div>
 ...
 <p className="text-slate-500 dark:text-subtle-on-light">We couldn't find any questions matching &quot;{searchTerm}&quot;.</p>
 </div>
 )}
 ...
 <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-fuchsia-300 text-sm font-bold tracking-widest uppercase mb-6">
