...
export default function LodgingPage() {
 ...
 {/* Hospital rooms note */}
 <div className="relative group overflow-hidden bg-slate-900 rounded-[3rem] p-10 md:p-14 border border-slate-200 dark:border-slate-800 shadow-2xl">
 ...
 <div className="w-20 h-20 rounded-3xl bg-white dark:bg-slate-900 flex items-center justify-center text-fuchsia-400 flex-shrink-0 border border-slate-200 dark:border-slate-800">
 <Bed className="w-10 h-10"/>
 </div>
 <div className="flex-1 text-center lg:text-left">
 <h2 className="elite-section-title text-white mb-4">Stay Inside the Hospital Campus</h2>
 <p className="text-subtle-on-light text-lg font-light leading-relaxed mb-6">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium">Curated accommodation options within a 1.5km radius of the hospital.</p>
 </div>
 </div>
 ...
 <div className="w-14 h-14 rounded-2xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-600 dark:text-subtle-on-light border border-slate-100 dark:border-slate-700">
 <Home className="w-7 h-7"/>
 </div>
 {h.halal && (
 <span className="px-4 py-1 bg-green-50 dark:bg-green-950 text-green-700 dark:text-green-300 text-sm rounded-full font-black uppercase tracking-widest border border-green-100 dark:border-green-800/50">Halal Friendly</span>
 )}
 </div>
 ...
 <span className="text-sm font-bold text-slate-500 dark:text-subtle-on-light">{h.distance} from hospital</span>
 </div>
 ...
 {h.features.map((f) => (
 <span key={f} className="text-xs px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-subtle-on-light rounded-lg font-black uppercase tracking-widest">{f}</span>
 ))}
 </div>
 ...
 <p className="text-slate-500 dark:text-subtle-on-light mt-4 text-lg font-medium">Full concierge support to make your medical stay as comfortable as possible.</p>
 </div>
 ...
 <p className="text-sm text-slate-500 dark:text-subtle-on-light leading-relaxed font-medium">{item.d}</p>
 </div>
 ))}
 </div>
 </section>
 ...
 <InternalLinkGrid type="health-packages"title="Wellness Packages"subtitle="Health Screening"limit={8} className="bg-slate-50 dark:bg-slate-900 border-y"/>
 ...
 <div className="w-20 h-20 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center mx-auto mb-10">
 ...
 <p className="text-xl text-subtle-on-light font-light mb-12">Our international host desk will suggest the most suitable lodging based on your clinical needs and preferences.</p>
 <a href={WA} target="_blank"rel="noopener noreferrer"
