...
export default function TransportationPage() {
 ...
 <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-emerald-300 text-xs font-bold tracking-widest uppercase mb-6 shadow-lg shadow-emerald-500/20">
