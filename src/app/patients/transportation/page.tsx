...
export default function TransportationPage() {
 ...
 <p className="text-slate-500 dark:text-subtle-on-light mt-2 text-lg font-medium">Clear instructions based on your point of origin.</p>
 </div>
 <div className="w-16 h-16 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-subtle-on-light">
 ...
 <span className="inline-block text-xs font-black px-3 py-1 bg-emerald-50 dark:bg-emerald-950/20 text-emerald-700 dark:text-emerald-400 rounded-full border border-emerald-100 dark:border-emerald-800 uppercase tracking-[0.2em]">{mode.badge}</span>
 </div>
 </div>
 ...
 <span className="flex-shrink-0 w-6 h-6 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 flex items-center justify-center font-black text-xs mt-0.5">{i + 1}</span>
 ...
 <p className="text-sm text-slate-500 dark:text-subtle-on-light leading-relaxed">{mode.tip}</p>
 </div>
 </div>
 </div>
 );
 ...
 <div>
 <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-500/10 text-red-500 text-sm font-black uppercase tracking-widest mb-6 border border-red-500/20">
 ...
 <p className="text-subtle-on-light text-lg font-light leading-relaxed mb-8 max-w-lg">Our advanced life support (ALS) ambulances are equipped with ventilators and monitoring equipment, ready to serve anywhere in Vellore and nearby districts.</p>
 ...
 <div key={i} className="flex items-start gap-5 p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 hover:bg-white dark:bg-slate-900 transition-colors">
 <div className="w-6 h-6 rounded-full bg-red-500 flex items-center justify-center text-white text-xs font-black flex-shrink-0 mt-0.5 shadow-lg shadow-red-500/20">
 {i + 1}
 </div>
 ...
 <div className="space-y-6 text-slate-600 dark:text-subtle-on-light text-lg font-medium leading-relaxed">
 <p>54, Katpadi Road, Suthanthira Ponvizha Nagar, Gandhi Nagar, Vellore — 632006, Tamil Nadu, India</p>
 
 <div className="grid gap-3 pt-4">
 <p className="text-xs font-black text-subtle-on-light uppercase tracking-[0.2em] mb-2">Distance From Landmarks</p>
 {[
 ...
 <span className="text-sm font-black text-slate-900 dark:text-white">{item.d}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <InternalLinkGrid type="services"title="All Treatments A–Z"subtitle="Services Directory"limit={12} className="bg-slate-50 dark:bg-slate-900 border-y"/>
