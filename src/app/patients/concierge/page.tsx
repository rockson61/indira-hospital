...
export default function ConciergePage() {
 ...
 >
 <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-purple-400 text-xs font-black tracking-[0.3em] uppercase mb-12 shadow-[0_0_40px_-5px_var(--tw-shadow-color)] shadow-purple-500/20">
