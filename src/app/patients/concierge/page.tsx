...
export default function ConciergePage() {
 ...
 >
 <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-purple-400 text-sm font-black tracking-[0.3em] uppercase mb-12 shadow-[0_0_40px_-5px_var(--tw-shadow-color)] shadow-purple-500/20">
 ...
 <p className="text-xl md:text-2xl text-subtle-on-light max-w-3xl mx-auto font-light leading-relaxed mb-16">
 ...
 {/* THE FOUR PILLARS */}
 <SectionContainer className="py-32 border-y border-slate-200 dark:border-slate-800">
 ...
 >
 <Card className="bg-slate-900 dark:bg-slate-900 border-slate-200 dark:border-slate-800 overflow-hidden h-full hover:border-purple-500/30 transition-all duration-500">
 ...
 <p className="text-subtle-on-light font-medium leading-relaxed">
 {feature.description}
 </p>
 </CardContent>
 </Card>
 ...
 <div className="inline-flex items-center gap-2 p-2 px-4 rounded-xl bg-purple-500/10 border border-purple-500/20 text-purple-400 text-sm font-bold uppercase tracking-widest">
 ...
 <div className="aspect-[4/5] rounded-[4rem] bg-gradient-to-br from-purple-500/20 to-slate-900 border border-slate-200 dark:border-slate-800 overflow-hidden relative group">
 ...
 <section className="bg-slate-950 py-24 border-y border-slate-200 dark:border-slate-800 overflow-hidden">
