    ...
    return (
        <main className="min-h-screen bg-white dark:bg-slate-950">
            ...
            <SectionContainer className="py-24 max-w-7xl mx-auto space-y-24">
                ...
                {/* COUNTRY HUB LINKS */}
                <div className="bg-slate-900 rounded-[3.5rem] p-12 text-white border border-white/5 shadow-2xl relative overflow-hidden text-center lg:text-left">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
                        ...
                        <div className="flex flex-wrap gap-3 justify-center lg:justify-end">
                            {INTERNATIONAL_COUNTRIES.slice(0, 16).map((c, i) => (
                                <Link key={i} href={`/patients/international/${c.slug}`} className="px-5 py-2.5 bg-white/5 border border-white/10 rounded-xl text-xs font-bold hover:bg-white/10 transition-all flex items-center gap-2 group">
