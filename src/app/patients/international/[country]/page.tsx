...
export default async function InternationalCountryPage({ params }: { params: Promise<{ country: string }> }) {
 ...
 <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-fuchsia-300 text-sm font-bold tracking-widest uppercase shadow-lg shadow-fuchsia-500/20">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light text-sm font-medium leading-relaxed">{item.value}</p>
 </div>
 ))}
 </div>
 </section>
 ...
 <p className="text-xs text-green-600 font-bold uppercase tracking-widest">{t.savings}</p>
 </div>
 </div>
 ...
 <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/20 border border-amber-400/30 text-amber-300 text-xs font-black tracking-widest uppercase mb-6">
 ...
 <p className="text-subtle-on-light text-sm mb-10 font-light leading-relaxed max-w-xl">
 ...
 <div key={i} className="flex items-center justify-between py-4 border-b border-slate-200 dark:border-slate-800 text-sm font-medium uppercase tracking-widest">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light text-sm mb-10 font-medium text-center lg:text-left">Save up to 85% compared to home country costs.</p>
 ...
 <th className="py-6 px-8 font-black text-subtle-on-light text-center uppercase tracking-widest">USA / UK / UAE</th>
 </tr>
 </thead>
 ...
 <td className="py-5 px-8 text-center text-subtle-on-light">{row.usa}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 <p className="text-subtle-on-light text-sm mb-8 font-medium leading-relaxed">
 Receive a detailed treatment plan and cost estimate within hours. No commitment.
 </p>
 <a href={waUrl} target="_blank"rel="noopener noreferrer"
 className="w-full flex items-center justify-center gap-3 px-6 py-5 bg-green-500 hover:bg-green-400 text-white font-black rounded-2xl transition-all shadow-xl shadow-green-900/40 uppercase tracking-widest text-xs mb-4">
 <MessageCircle className="w-5 h-5"/> WhatsApp Desk
 </a>
 <div className="text-center pt-2">
 <p className="text-xs font-black text-fuchsia-300 uppercase tracking-widest animate-pulse">Average response: 45 mins</p>
 </div>
 </div>
 ...
 <p className="text-[9px] text-subtle-on-light font-bold uppercase tracking-widest truncate">{doc.designation}</p>
 </div>
 </Link>
 ))}
 </div>
 <Link href="/doctors"className="flex items-center justify-center gap-2 mt-8 text-xs font-black text-fuchsia-600 uppercase tracking-widest hover:translate-x-1 transition-all">
 ...
 <span className="text-xs font-black text-subtle-on-light uppercase tracking-widest group-hover:text-fuchsia-600">{link.label}</span>
 ...
 <p className="text-xl text-subtle-on-light font-light mb-16 leading-relaxed">Join 15,000+ international patients who transformed their lives at Indira Hospital.</p>
 <a href={waUrl} target="_blank"rel="noopener noreferrer"
