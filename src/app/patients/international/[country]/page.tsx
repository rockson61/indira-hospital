                ...
                <SectionContainer className="relative z-10">
                    <div className="max-w-4xl mx-auto text-center lg:text-left lg:mx-0">
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-4 mb-6">
                            ...
                            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-fuchsia-300 text-xs font-bold tracking-widest uppercase shadow-lg shadow-fuchsia-500/20">
            ...
            <SectionContainer className="py-24 max-w-7xl mx-auto px-6 lg:px-8">
                <div className="grid lg:grid-cols-3 gap-16">
                    ...
                    <div className="lg:col-span-2 space-y-24">
                        ...
                        <section className="bg-slate-900 rounded-[3rem] p-8 md:p-12 text-white border border-white/5 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="grid gap-4">
                                    {CMC_VS_INDIRA.slice(0, 4).map((row, i) => (
                                        <div key={i} className="flex items-center justify-between py-4 border-b border-white/5 text-xs font-medium uppercase tracking-widest">
                        ...
                        <section>
                            ...
                            <div className="overflow-x-auto rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
                                <table className="w-full text-xs text-left">
                                    ...
                                    <tbody className="divide-y divide-slate-50 dark:divide-slate-800 bg-white dark:bg-slate-900/50 uppercase tracking-tight font-bold">
