...
export default function TourismSpotsPage() {
 ...
 <div>
 <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-amber-300 text-[10px] font-black tracking-widest uppercase mb-8">
 ...
 className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-white font-black rounded-2xl hover:bg-white dark:bg-slate-900 transition-all uppercase tracking-widest text-xs">
