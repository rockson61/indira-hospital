...
export default function TourismSpotsPage() {
 ...
 <div className="text-xs font-bold text-amber-200 uppercase tracking-widest">{stat.l}</div>
 </div>
 ))}
 </SectionContainer>
 </div>
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium leading-relaxed text-sm">{feature.desc}</p>
 </div>
 ))}
 </div>
 </section>
 ...
 <p className="text-slate-500 dark:text-subtle-on-light mt-4 text-lg font-medium">Explore the best recovery spots handpicked for our international guests.</p>
 </div>
 ...
 <span className="px-4 py-1.5 bg-slate-50 dark:bg-slate-800 text-subtle-on-light text-xs font-black uppercase tracking-widest rounded-full border border-slate-100 dark:border-slate-700">
 {state.type}
 </span>
 </div>
 <p className="text-slate-500 dark:text-subtle-on-light mb-10 font-medium leading-relaxed">{state.description}</p>
 </div>
 ...
 <p className="text-sm text-slate-500 dark:text-subtle-on-light font-medium">{spot.desc}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <div>
 <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-amber-300 text-xs font-black tracking-widest uppercase mb-8">
 ...
 <p className="text-lg text-subtle-on-light mb-10 leading-relaxed font-light">
 ...
 <div key={i} className="flex items-center gap-4 text-sm font-black uppercase tracking-widest text-amber-400">
 ...
 <a href={waUrl} target="_blank"rel="noopener noreferrer"
 className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-green-500 hover:bg-green-400 text-white font-black rounded-2xl transition-all shadow-xl shadow-green-900/40 uppercase tracking-widest text-sm">
 WhatsApp Concierge <MessageCircle className="w-5 h-5"/>
 </a>
 <a href={`tel:${siteConfig.contact.phone}`}
 className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-white font-black rounded-2xl hover:bg-white dark:bg-slate-900 transition-all uppercase tracking-widest text-sm">
 Call Now <Phone className="w-5 h-5 text-amber-400"/>
 </a>
 </div>
 </div>

 <div className="relative aspect-square rounded-[4rem] overflow-hidden border border-slate-200 dark:border-slate-800 shadow-2xl bg-slate-800">
