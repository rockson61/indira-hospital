...
export default function SecondOpinionPage() {
 ...
 <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-blue-300 text-xs font-bold tracking-widest uppercase mb-6 shadow-lg shadow-blue-500/20">
