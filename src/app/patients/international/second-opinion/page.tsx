...
export default function SecondOpinionPage() {
 ...
 <div key={i} className="flex items-center gap-2 text-sm font-black uppercase tracking-[0.2em] text-subtle-on-light">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light mt-4 text-lg font-medium">Four simple steps to clarity and confidence in your medical journey.</p>
 </div>
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium leading-relaxed text-sm">{step.desc}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <section className="bg-slate-900 rounded-[3.5rem] p-10 md:p-16 border border-slate-200 dark:border-slate-800 relative overflow-hidden text-center lg:text-left">
 ...
 <p className="text-subtle-on-light font-medium mb-10 leading-relaxed text-lg">Our international desk will assign your case to the right senior specialist immediately upon receipt.</p>
 ...
 <div key={i} className="flex items-center gap-3 text-sm font-black uppercase tracking-widest text-blue-400">
 ...
 <div>
 <p className="text-green-400 font-black uppercase tracking-widest text-xs mb-1">Fastest Option</p>
 <h4 className="text-white font-black text-2xl uppercase tracking-tighter">WhatsApp</h4>
 <p className="text-subtle-on-light text-sm font-medium mt-1">{siteConfig.contact.whatsapp}</p>
 </div>
 ...
 <div>
 <p className="text-blue-400 font-black uppercase tracking-widest text-xs mb-1">Large Files</p>
 <h4 className="text-white font-black text-2xl uppercase tracking-tighter">Email</h4>
 <p className="text-subtle-on-light text-sm font-medium mt-1 break-all">{EMAIL}</p>
 </div>
 ...
 <p className="text-lg text-slate-500 dark:text-subtle-on-light font-medium">We provide second opinions across all major surgical and medical specialties.</p>
 </div>
 ...
 <p className="text-slate-500 dark:text-subtle-on-light text-sm font-medium leading-relaxed">{spec.desc}</p>
 </div>
 ))}
 </div>
 </section>
 ...
 <p className="text-xl text-subtle-on-light font-light mb-16 max-w-2xl mx-auto leading-relaxed">No payment. No obligation. Just an honest specialist opinion from India's leading quaternary care hospital.</p>
