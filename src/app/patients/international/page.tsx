...
export default function InternationalPatientsPage() {
 ...
 <p className="text-sm text-slate-500 dark:text-subtle-on-light font-medium leading-relaxed">We enforce strict international safety protocols and surgical hygiene standards for every global patient.</p>
 </div>
 </div>
 </div>

 <div className="order-1 lg:order-2">
 <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-fuchsia-50 dark:bg-fuchsia-950 text-fuchsia-700 text-sm font-bold tracking-widest uppercase mb-6 border border-fuchsia-100">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium leading-relaxed">{item.d}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <p className="text-xl text-subtle-on-light font-light leading-relaxed">Continuous, step-by-step concierge support from your first global inquiry to your final localized recovery.</p>
 </div>
 ...
 <p className="text-subtle-on-light font-light leading-relaxed group-hover:text-slate-300 transition-colors">{step.desc}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <div>
 <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-fuchsia-300 text-sm font-bold uppercase tracking-widest mb-10">
 ...
 <p className="text-xl text-subtle-on-light font-medium leading-relaxed mb-12">
 ...
 <p className="text-sm text-slate-500 font-medium uppercase tracking-widest">{item.d}</p>
 </Link>
 ))}
 </div>
 </div>
 ...
 <div className="text-xs text-fuchsia-400 uppercase font-bold tracking-widest">{row.major}</div>
 </div>
 <div className="px-3 py-1 bg-fuchsia-500/20 text-fuchsia-300 text-xs font-black rounded-full uppercase tracking-tighter">
 {row.traffic}
 </div>
 </div>
 ))}
 ...
 <div className="text-white/70 text-sm font-bold uppercase tracking-widest">Global Medical Standards</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-950 border border-indigo-100 text-indigo-700 text-sm font-bold tracking-widest uppercase mb-4 shadow-sm">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light mt-4 max-w-2xl mx-auto font-medium text-lg lg:text-xl font-light">
 ...
 <p className="text-xs text-indigo-600 font-black uppercase tracking-[0.2em] mb-6">{country.region}</p>
 
 <div className="space-y-3 mb-8 flex-grow">
 {country.common_treatments.slice(0, 3).map((t, index) => (
 <div key={index} className="flex items-center gap-3 text-sm font-bold text-slate-600 dark:text-subtle-on-light">
 ...
 <div className="text-xs font-black uppercase tracking-widest text-subtle-on-light mb-2">Clinical Access</div>
 ...
 <div className="mt-8 flex items-center gap-2 text-indigo-700 dark:text-indigo-400 font-black text-sm uppercase tracking-widest group-hover:gap-4 transition-all">
 ...
 <span className="text-sm font-bold text-slate-600 dark:text-slate-300 group-hover:text-indigo-700 dark:group-hover:text-indigo-400 truncate tracking-tight">{country.name}</span>
 </Link>
 ))}
 </div>
 </div>
