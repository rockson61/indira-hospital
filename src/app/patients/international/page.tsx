...
const PROCESS_STEPS = [
    {
        ...
        icon: <MessageCircle className="w-6 h-6 text-teal-300 group-hover:text-white transition-colors" />
    },
    {
        title: "Visa Assistance",
        desc: "We provide official medical invitation letters for fast-track M-Visa processing and documentation.",
        icon: <FileText className="w-6 h-6 text-teal-300 group-hover:text-white transition-colors" />
    },
    {
        title: "Travel Support",
        desc: "Dedicated VIP pickup from Chennai (MAA) airport and seamless local transport in Vellore.",
        icon: <Plane className="w-6 h-6 text-teal-300 group-hover:text-white transition-colors" />
    },
    {
        title: "Care & Recovery",
        desc: "World-class surgery followed by personalized rehabilitation, private suite recovery, and medical follow-up.",
        icon: <HeartPulse className="w-6 h-6 text-teal-300 group-hover:text-white transition-colors" />
    }
];

export default function InternationalPatientsPage() {
    return (
        <main className="min-h-screen bg-slate-50 dark:bg-slate-950 selection:bg-teal-200 selection:text-teal-900 pb-24">
            {/* ELITE GLOBAL HERO */}
            <section className="bg-slate-900 pt-36 pb-40 lg:pt-48 lg:pb-48 text-white relative overflow-hidden rounded-b-[3rem] sm:rounded-b-[5rem]">
                ...
                <SectionContainer className="relative z-10 text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <h1 className="text-5xl sm:text-7xl font-black mb-6 tracking-tight leading-[1.1]">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-indigo-400">Without Borders.</span>
                        </h1>
            ...
            <SectionContainer className="relative z-20 -mt-20 max-w-6xl mx-auto px-4">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-2 sm:p-4 bg-white/40 backdrop-blur-3xl rounded-[2.5rem] border border-white shadow-[0_20px_40px_rgba(0,0,0,0.08)]">
                    {[
                        ...
                        <div key={i} className="group bg-white rounded-2xl p-6 text-center shadow-sm border border-slate-100 hover:shadow-lg hover:border-teal-200 transition-all duration-300">
                            <div className="text-3xl font-black text-slate-800 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-teal-600 group-hover:to-emerald-500 transition-colors mb-1">{stat.val}</div>
            ...
            <SectionContainer id="why-india" className="py-24 max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-1 lg:order-2">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-teal-50 text-teal-700 text-xs font-bold tracking-widest uppercase mb-6 border border-teal-100">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black mb-10 text-slate-900 tracking-tight leading-[1.1]">
                            Why Choose <br /> <span className="text-teal-600">Health Tourism in India?</span>
                        </h2>
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={i} className="group flex gap-5 items-start">
                                    <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-teal-500 group-hover:border-teal-400 group-hover:shadow-[0_0_20px_rgba(20,184,166,0.3)] transition-all duration-300">
                                        <CheckCircle2 className="w-6 h-6 text-teal-500 group-hover:text-white transition-colors" />
                                    </div>
                                    <div className="pt-1">
                                        <h3 className="font-bold text-xl text-slate-900 mb-2 group-hover:text-teal-700 transition-colors">{item.t}</h3>
            ...
            <section id="process" className="py-24 relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-teal-500/10 rounded-full blur-[120px] z-0" />
                ...
                <SectionContainer className="relative z-10 max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {PROCESS_STEPS.map((step, i) => (
                            <div key={i} className="group bg-slate-800/50 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/5 hover:bg-slate-800 hover:border-teal-500/30 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)] hover:-translate-y-2 transition-all duration-500 relative overflow-hidden">
                                <div className="absolute top-0 right-0 p-6 text-6xl font-black text-white/5 group-hover:text-teal-500/10 transition-colors duration-500">0{i + 1}</div>
                                ...
                                <div className="relative z-10">
                                    <div className="mb-8 flex w-16 h-16 items-center justify-center rounded-2xl bg-white/5 border border-white/10 group-hover:bg-teal-500 group-hover:border-teal-400 transition-all duration-500 shadow-lg">
                                        {step.icon}
                                    </div>
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    {INTERNATIONAL_COUNTRIES.map((c) => (
                        <Link
                            ...
                            className="group flex flex-col items-center justify-center min-w-[160px] p-6 rounded-3xl bg-white border border-slate-200 hover:border-teal-400 hover:shadow-[0_10px_30px_rgba(20,184,166,0.15)] hover:-translate-y-1 transition-all duration-300"
                        >
                            <span className="text-xl font-black text-slate-800 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-teal-600 group-hover:to-emerald-500 transition-colors">{c.name}</span>
                            <span className="text-xs font-bold text-slate-400 tracking-wider uppercase mt-2 group-hover:text-teal-600/60 transition-colors">{c.region}</span>
                        </Link>
                    ))}
                </div>
            </SectionContainer>
            ...
            <SectionContainer className="pb-24 max-w-7xl mx-auto px-4">
                <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-teal-950 rounded-[4rem] border border-white/10 overflow-hidden shadow-2xl relative group/cta flex flex-col items-center text-center p-12 sm:p-20">
                    ...
                    <div className="relative z-10 w-full max-w-4xl">
                        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 mb-8 shadow-[0_0_30px_rgba(20,184,166,0.2)]">
                            <Plane className="w-8 h-8 text-teal-300" />
                        </div>
                        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-8 tracking-tight leading-[1.1]">
                            Ready for a Free <br /> <span className="text-teal-400">Cost Estimate?</span>
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center w-full max-w-2xl mx-auto">
                            <a href="https://wa.me/917010650063?text=Hi, I am an international patient. Can I get a cost estimate?" target="_blank" rel="noopener noreferrer" className="group/btn relative flex items-center justify-center w-full sm:w-auto px-10 py-5 bg-teal-500 text-white font-black rounded-2xl hover:scale-[1.02] transition-all shadow-lg shadow-teal-500/25 overflow-hidden">
