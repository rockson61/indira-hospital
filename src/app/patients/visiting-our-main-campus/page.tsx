...
export default function VisitingMainCampusPage() {
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium">To ensure patient recovery and safety, please adhere to these timings.</p>
 </div>
 </div>
 ...
 <tr>
 <th className="py-6 px-8 text-left font-black text-slate-900 dark:text-white uppercase tracking-widest text-sm">Ward / Zone</th>
 <th className="py-6 px-8 text-center font-black text-slate-900 dark:text-white uppercase tracking-widest text-sm">Morning Slot</th>
 <th className="py-6 px-8 text-center font-black text-slate-900 dark:text-white uppercase tracking-widest text-sm">Evening Slot</th>
 <th className="py-6 px-8 text-left font-black text-slate-900 dark:text-white uppercase tracking-widest text-sm">Regulations</th>
 </tr>
 </thead>
 ...
 <td className="py-6 px-8 text-slate-500 dark:text-subtle-on-light text-sm font-medium leading-relaxed">{row.note}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium">Facilities designed for your comfort and convenience during your stay.</p>
 </div>
 </div>
 ...
 <p className="text-sm text-slate-500 dark:text-subtle-on-light leading-relaxed font-medium">{desc}</p>
 </div>
 ))}
 </div>
 </section>
 ...
 {/* RULES & GUIDELINES */}
 <section className="bg-slate-900 rounded-[3.5rem] p-10 md:p-16 border border-slate-200 dark:border-slate-800 relative overflow-hidden group">
 ...
 <div>
 <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 text-white text-sm font-black uppercase tracking-widest mb-6">
 ...
 <p className="text-subtle-on-light text-lg font-light leading-relaxed mb-8">To maintain a sterile, quiet, and professional healing environment, all visitors must strictly follow these protocols.</p>
 ...
 {RULES.map((rule, i) => (
 <div key={i} className="flex items-start gap-4 p-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 hover:bg-white dark:bg-slate-900 transition-colors">
 <div className="w-6 h-6 rounded-full bg-fuchsia-500 flex items-center justify-center text-white text-xs font-black flex-shrink-0 mt-0.5 shadow-lg shadow-fuchsia-500/20">
 {i + 1}
 </div>
 ...
 <p className="text-slate-500 dark:text-subtle-on-light text-lg font-medium leading-relaxed max-w-2xl">54, Katpadi Road, Suthanthira Ponvizha Nagar, Gandhi Nagar, Vellore — 632006, Tamil Nadu</p>
 ...
 <InternalLinkGrid type="health-packages"title="Preventive Wellness Packages"subtitle="Early Detection"limit={8} className="bg-slate-50 dark:bg-slate-900 border-y"/>
