...
export default function VisitingMainCampusPage() {
 ...
 <div>
 <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 text-white text-xs font-black uppercase tracking-widest mb-6">
