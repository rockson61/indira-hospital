...
export default function InsurancePage() {
    return (
        <main className="min-h-screen bg-slate-50 selection:bg-teal-200 selection:text-teal-900 pb-24">
            ...
            <section className="bg-slate-900 pt-36 pb-32 lg:pt-48 lg:pb-40 text-white relative overflow-hidden rounded-b-[3rem] sm:rounded-b-[5rem]">
                ...
                <SectionContainer className="relative z-10 text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <h1 className="text-5xl sm:text-7xl font-black mb-6 tracking-tight leading-[1.1]">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-indigo-400">TPA Partners.</span>
                        </h1>
            ...
            <SectionContainer className="relative z-20 -mt-20 max-w-7xl mx-auto px-4 mb-24">
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 hover:shadow-2xl hover:shadow-teal-900/5 transition-shadow duration-700 bg-white/40 p-2 sm:p-4 rounded-[3rem] backdrop-blur-3xl border border-white">
                    {benefits.map((b) => (
                        <div key={b.title} className="group relative bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(20,184,166,0.12)] hover:border-teal-200 transition-all duration-500 overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-br from-teal-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                            <div className="relative z-10">
                                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-teal-50 text-teal-600 group-hover:scale-110 group-hover:bg-teal-600 group-hover:text-white transition-all duration-500 shadow-lg shadow-teal-500/10">
            ...
            <SectionContainer className="py-16">
                ...
                <div className="flex flex-wrap justify-center gap-4 mt-12 max-w-5xl mx-auto">
                    {insurancePartners.map((name) => (
                        <div
                            key={name}
                            className="group flex items-center justify-center px-6 py-4 bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-[0_8px_30px_rgba(20,184,166,0.15)] hover:border-teal-300 hover:-translate-y-1 transition-all duration-300 cursor-default"
                        >
                            <div className="flex items-center gap-3">
                                <ShieldCheck className="w-5 h-5 text-slate-400 group-hover:text-teal-500 transition-colors" />
                ...
                <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-teal-950 rounded-[4rem] border border-white/10 overflow-hidden shadow-2xl relative group/cta flex flex-col items-center text-center p-12 sm:p-20">
                    ...
                    <div className="relative z-10 w-full max-w-3xl">
                        ...
                        <h2 className="text-4xl sm:text-5xl font-black text-white mb-6 tracking-tight leading-[1.1]">
                            Need Help with <br /> <span className="text-teal-400">Insurance Claims?</span>
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center w-full max-w-md mx-auto">
                            <Link href="/contact" className="group/btn relative flex items-center justify-center w-full sm:w-auto px-8 py-5 bg-teal-500 text-white font-black rounded-2xl hover:scale-[1.02] transition-all shadow-lg shadow-teal-500/25 overflow-hidden">
