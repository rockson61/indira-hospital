...
export default async function PatientResourcePage({ params }: { params: Promise<{ slug: string }> }) {
 ...
 <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-fuchsia-300 text-sm font-bold tracking-widest uppercase mb-6">
 ...
 <div>
 <div className="text-sm font-black text-fuchsia-600 dark:text-fuchsia-400 uppercase tracking-widest mb-2">
 ...
 <div className="prose prose-lg prose-slate dark:prose-invert max-w-none prose-headings:font-black prose-h2:text-3xl prose-h2:mb-6 prose-p:text-slate-600 dark:prose-p:text-subtle-on-light prose-p:leading-relaxed prose-li:text-slate-600 dark:prose-li:text-subtle-on-light prose-a:text-fuchsia-600 dark:prose-a:text-fuchsia-400 font-medium relative z-10">
 ...
 <p className="text-subtle-on-light text-sm mb-8 leading-relaxed">Our Help Desk is available 24/7 to assist with your journey, billing, and clinical inquiries.</p>
 <a href={waUrl} className="flex items-center justify-center gap-2 px-8 py-4 bg-white text-slate-900 font-black rounded-xl hover:bg-fuchsia-50 transition-all uppercase tracking-widest text-sm">
 ...
 <Link key={i} href={link.href} className="flex items-center justify-between text-slate-500 dark:text-subtle-on-light hover:text-fuchsia-600 dark:hover:text-fuchsia-400 font-bold transition-colors group">
 <span>{link.text}</span>
