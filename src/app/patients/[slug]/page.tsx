...
export default async function PatientResourcePage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <main className="min-h-screen bg-white dark:bg-slate-950">
            ...
            <section className="bg-slate-900 pt-48 pb-32 lg:pt-60 lg:pb-40 text-white relative overflow-hidden rounded-b-[3rem] sm:rounded-b-[5rem]">
                ...
                <SectionContainer className="relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-fuchsia-300 text-xs font-bold tracking-widest uppercase mb-6">
            ...
            <InternalLinkGrid type="health-packages" title="Wellness Screening" subtitle="Master Health Checkups" limit={8} className="bg-slate-50 dark:bg-slate-900/50 border-y" />
