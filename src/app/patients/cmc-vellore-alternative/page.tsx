...
export default function CMCVelloreAlternativePage() {
 ...
 <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-amber-300 text-sm font-bold tracking-widest uppercase mb-6 shadow-lg shadow-amber-500/20">
 ...
 <div className="text-xs font-black text-subtle-on-light uppercase tracking-[0.2em]">{stat.l}</div>
 </div>
 ))}
 </div>
 </div>
 ...
 <p className="text-slate-500 dark:text-subtle-on-light mt-2 text-lg font-medium">Why wait months when you can be treated this week?</p>
 </div>
 <div className="w-16 h-16 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-subtle-on-light border border-slate-200 dark:border-slate-700">
 ...
 <tr>
 <th className="py-6 px-8 font-black uppercase tracking-widest text-sm">Specialty</th>
 <th className="py-6 px-8 font-black uppercase tracking-widest text-sm text-center text-red-400">CMC Wait</th>
 <th className="py-6 px-8 font-black uppercase tracking-widest text-sm text-center text-emerald-400">Indira Wait</th>
 </tr>
 </thead>
 ...
 <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-sm font-black uppercase tracking-widest border border-red-100 dark:border-red-900/30">
 ...
 <div className="bg-slate-900 rounded-[3rem] p-10 text-white border border-slate-200 dark:border-slate-800 shadow-2xl relative overflow-hidden flex flex-col justify-center">
 <div className="absolute top-0 right-0 w-32 h-32 bg-fuchsia-500/20 rounded-full blur-[40px] pointer-events-none"/>
 <div className="relative z-10">
 <h3 className="elite-section-title mb-6 uppercase">Same City. <br /><span className="text-fuchsia-400">No Waiting.</span></h3>
 <p className="text-subtle-on-light font-medium mb-8 leading-relaxed">Indira Hospital is located in Gandhi Nagar, Vellore — just minutes away from CMC. You get the same medical hub benefits without the long queues.</p>
 ...
 <a href={waUrl} className="flex items-center justify-center gap-2 px-8 py-5 bg-white text-slate-900 font-black rounded-2xl hover:bg-fuchsia-50 transition-all uppercase tracking-widest text-sm">
 ...
 <p className="text-lg text-slate-500 dark:text-subtle-on-light font-medium">NABH-accredited care doesn't have to be a queue.</p>
 </div>
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium leading-relaxed text-sm">{desc}</p>
 </div>
 ))}
 </div>
 </section>
 ...
 <section className="bg-slate-900 rounded-[3.5rem] p-10 md:p-16 border border-slate-200 dark:border-slate-800 relative overflow-hidden">
 ...
 <div className="relative z-10">
 <h2 className="elite-section-title text-white mb-12 uppercase text-center lg:text-left">Full Comparison: <br /><small className="text-fuchsia-400 opacity-80 text-2xl lowercase">no compromises, just faster care.</small></h2>
 
 <div className="overflow-x-auto">
 <table className="w-full text-left">
 <thead>
 <tr className="border-b border-slate-200 dark:border-slate-800 uppercase tracking-[0.2em] text-xs font-black text-slate-500">
 ...
 <tr key={row.factor} className="group hover:bg-white dark:bg-slate-900 transition-colors">
 <td className="py-6 pr-8 font-black text-subtle-on-light group-hover:text-fuchsia-400 transition-colors uppercase tracking-tight text-sm">{row.factor}</td>
 ...
 <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-950 text-emerald-700 text-sm font-black tracking-widest uppercase mb-6 border border-emerald-100">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium text-sm leading-relaxed">{step.desc}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <h3 className="elite-section-title text-slate-900 dark:text-white mb-6 uppercase">Get a Second Opinion <br /><span className="text-indigo-600">Free of Cost.</span></h3>
 <p className="text-slate-500 dark:text-subtle-on-light font-medium mb-10 px-4 leading-relaxed">Send your existing reports and CMC diagnosis. Our senior specialists will review them and provide a complete treatment plan within 24 hours.</p>
 ...
 <h2 className="elite-section-title text-white mb-10 uppercase">Your Health <br /><span className="text-fuchsia-500">Can't Wait Months.</span></h2>
 <p className="text-xl text-subtle-on-light font-light mb-16 max-w-2xl mx-auto leading-relaxed">NABH Quality care at Indira Hospital starts this week. Join 50,000+ satisfied patients today.</p>
 ...
 className="inline-flex items-center gap-4 px-12 py-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-white font-black rounded-[2rem] hover:bg-white dark:bg-slate-900 text-xl transition-all">
 Book Online Now
 </Link>
 </div>
 </div>
 ...
 <InternalLinkGrid type="health-packages"title="Wellness Screening"subtitle="Preventive Health"limit={8} className="bg-slate-50 dark:bg-slate-900 border-y"/>
