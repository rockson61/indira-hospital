...
export default function ExpertOpinionClient() {
 ...
 >
 <Badge variant="outline"className="px-5 py-2 rounded-full border-blue-500/20 bg-blue-500/5 text-blue-600 dark:text-blue-400 text-sm font-black tracking-widest uppercase mb-8">
 ...
 <p className="text-xl md:text-2xl text-slate-500 dark:text-subtle-on-light max-w-3xl mx-auto font-light leading-relaxed">
 ...
 <p className="text-lg text-slate-500 dark:text-subtle-on-light font-medium leading-relaxed">
 ...
 <p className="text-sm text-slate-500 font-bold uppercase tracking-wider">{member.focus}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 {/* UPLOAD SIMULATOR */}
 <Card className="bg-slate-900 border-slate-200 dark:border-slate-800 rounded-[3rem] p-10 relative overflow-hidden group">
 ...
 <p className="text-subtle-on-light font-medium text-sm">Drag and drop MRI, CT scans, or discharge summaries (ZIP/PDF).</p>
 </div>
 ...
 <label 
 htmlFor="case-upload"
 className="flex flex-col items-center justify-center h-48 rounded-[2rem] border-2 border-dashed border-slate-200 dark:border-slate-800 hover:border-blue-500/50 hover:bg-blue-500/5 transition-all cursor-pointer group/label"
 >
 ...
 <p className="text-blue-400 font-black text-sm uppercase tracking-[0.2em] animate-pulse">Encrypting & Uploading...</p>
 </motion.div>
 ) : fileUploaded ? (
 <motion.div 
 key="done"
 ...
 <p className="font-black text-sm uppercase tracking-[0.2em]">Upload Complete</p>
 </motion.div>
 ) : (
 <motion.div 
 key="idle"
 ...
 <p className="text-slate-500 font-bold text-sm uppercase tracking-widest">Select Files</p>
 </motion.div>
 )}
 </AnimatePresence>
 </label>
 ...
 <p className="text-xs font-black text-subtle-on-light uppercase tracking-widest leading-none">HIPAA Compliant Transfer</p>
 </div>
 ...
 <p className="text-sm text-slate-500 font-black uppercase tracking-widest mt-1">{stat.label}</p>
 </div>
 </div>
 ))}
 </div>
