...
// Topic: Laparoscopic Hysterectomy Guide
...
export const metadata: Metadata = {
  title: "Laparoscopic Hysterectomy Guide | Indira Hospital Vellore",
  description: "Learn about Laparoscopic Hysterectomy Guide at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function LaparoscopicHysterectomyGuidePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Laparoscopic Hysterectomy Guide is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Laparoscopic Hysterectomy Guide",
        steps: [
