...
// Topic: Bladder Cancer Treatment Options
// Cluster: urology
// Hub: /services/urology
// Generated: 2026-02-25T04:19:28.073Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Bladder Cancer Treatment Options | Indira Hospital Vellore",
  description: "Learn about Bladder Cancer Treatment Options at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function BladderCancerTreatmentOptionsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Bladder Cancer Treatment Options is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Bladder Cancer Treatment Options",
        steps: [
