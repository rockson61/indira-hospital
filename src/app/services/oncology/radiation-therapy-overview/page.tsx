    ...
    return (
        ...
        >
            <section>
                ...
                <div className="my-10 p-8 md:p-10 bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/10 dark:to-violet-900/10 rounded-[2.5rem] border border-purple-100 dark:border-purple-900 shadow-sm">
                    <h4 className="text-2xl font-black text-slate-900 dark:text-purple-300 mb-4 tracking-tight">Cancer Care Coordination</h4>
