      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Surgical Oncology Overview at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Surgical Oncology Overview"
          description="Read verified experiences from patients who underwent Surgical Oncology Overview at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
