...
// Generated: 2026-02-16T11:40:07.711Z
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Breast Cancer Screening Guide at Indira Super Speciality Hospital
          </h1>
        ...
        <section className="py-8 bg-teal-50 dark:bg-teal-900/20 rounded-xl p-6">
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/services/oncology" className="text-teal-600 hover:underline">
                ← Back to oncology main page
              </Link>
            </li>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Breast Cancer Screening Guide"
          description="Read verified experiences from patients who underwent Breast Cancer Screening Guide at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
