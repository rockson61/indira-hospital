      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Palliative Care Services at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Palliative Care Services"
          description="Read verified experiences from patients who underwent Palliative Care Services at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
