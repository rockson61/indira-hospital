      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Chemotherapy Side Effects at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Chemotherapy Side Effects"
          description="Read verified experiences from patients who underwent Chemotherapy Side Effects at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
