...
// Topic: Cervical Cancer Vaccines
// Cluster: oncology
...
export const metadata: Metadata = {
  title: "Cervical Cancer Vaccines | Indira Hospital Vellore",
  description: "Learn about Cervical Cancer Vaccines at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function CervicalCancerVaccinesPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Cervical Cancer Vaccines is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Cervical Cancer Vaccines",
        steps: [
