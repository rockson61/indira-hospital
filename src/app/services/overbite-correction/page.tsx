...
export default function OverbiteCorrectionPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Overbite Correction is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Overbite Correction",
        steps: [
