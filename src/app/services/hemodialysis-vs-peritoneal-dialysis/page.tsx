...
// Topic: Hemodialysis Vs Peritoneal Dialysis
// Cluster: nephrology
// Hub: /services/nephrology
// Generated: 2026-02-25T04:19:28.082Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Hemodialysis Vs Peritoneal Dialysis | Indira Hospital Vellore",
  description: "Learn about Hemodialysis Vs Peritoneal Dialysis at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function HemodialysisVsPeritonealDialysisPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Hemodialysis Vs Peritoneal Dialysis is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Hemodialysis Vs Peritoneal Dialysis",
        steps: [
