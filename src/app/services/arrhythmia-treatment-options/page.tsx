...
// Topic: Arrhythmia Treatment Options
// Cluster: cardiology
// Hub: /services/cardiology
// Generated: 2026-02-25T04:19:28.076Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Arrhythmia Treatment Options | Indira Hospital Vellore",
  description: "Learn about Arrhythmia Treatment Options at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function ArrhythmiaTreatmentOptionsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Arrhythmia Treatment Options is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Arrhythmia Treatment Options",
        steps: [
