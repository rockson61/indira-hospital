...
// Topic: Single Sitting Root Canal
// Cluster: root-canal
// Hub: /services/root-canal-treatment
// Generated: 2026-02-25T05:28:19.368Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Single Sitting Root Canal | Indira Hospital Vellore",
  description: "Learn about Single Sitting Root Canal at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function SingleSittingRootCanalPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Single Sitting Root Canal is a highly specialized treatment provided by our expert medical team.</strong> This advanced procedure offers exceptional success rates with transparent pricing.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Your structured clinical pathway for Single Sitting Root Canal",
        steps: [
