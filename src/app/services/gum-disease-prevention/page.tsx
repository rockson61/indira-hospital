...
export default function GumDiseasePreventionPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Gum Disease Prevention is a highly specialized treatment provided by our expert medical team.</strong> This advanced procedure offers exceptional success rates with transparent pricing.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Your structured clinical pathway for Gum Disease Prevention",
        steps: [
