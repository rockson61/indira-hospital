...
export const metadata: Metadata = {
  title: "Root Canal Cost Breakdown | Indira Hospital Vellore",
  description: "Learn about Root Canal Cost Breakdown at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function RootCanalCostBreakdownPage() {
  return (
    <SubServiceTemplate
      ...
      reviews={{
        entityType: "service",
        entityName: "Root Canal Cost Breakdown",
