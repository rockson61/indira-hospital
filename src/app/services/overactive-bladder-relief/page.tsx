...
// Topic: Overactive Bladder Relief
// Cluster: urology
...
export const metadata: Metadata = {
  title: "Overactive Bladder Relief | Indira Hospital Vellore",
  description: "Learn about Overactive Bladder Relief at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function OveractiveBladderReliefPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Overactive Bladder Relief is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Overactive Bladder Relief",
        steps: [
