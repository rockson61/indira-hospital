...
// Topic: Braces Pain Management
// Cluster: orthodontics
// Hub: /services/orthodontics
// Generated: 2026-02-25T03:34:09.107Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Braces Pain Management | Indira Hospital Vellore",
  description: "Learn about Braces Pain Management at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function BracesPainManagementPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Braces Pain Management is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Braces Pain Management",
        steps: [
