...
// Topic: Targeted Therapy For Cancer
// Cluster: oncology
// Hub: /services/oncology
// Generated: 2026-02-25T04:19:28.078Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Targeted Therapy For Cancer | Indira Hospital Vellore",
  description: "Learn about Targeted Therapy For Cancer at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function TargetedTherapyForCancerPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Targeted Therapy For Cancer is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Targeted Therapy For Cancer",
        steps: [
