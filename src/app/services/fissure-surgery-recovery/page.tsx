...
// Topic: Fissure Surgery Recovery
...
export const metadata: Metadata = {
  title: "Fissure Surgery Recovery | Indira Hospital Vellore",
  description: "Learn about Fissure Surgery Recovery at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function FissureSurgeryRecoveryPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Fissure Surgery Recovery is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Fissure Surgery Recovery",
        steps: [
