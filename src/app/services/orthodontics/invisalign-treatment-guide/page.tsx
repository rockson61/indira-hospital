...
export const metadata: Metadata = {
  title: "Invisalign Treatment Guide | Indira Dental Clinic Vellore",
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Invisalign Treatment Guide at Indira Dental Clinic
          </h1>
        ...
        <section className="py-8 bg-teal-50 dark:bg-teal-900/20 rounded-xl p-6">
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/services/orthodontics" className="text-teal-600 hover:underline">
                ← Back to orthodontics main page
              </Link>
            </li>
