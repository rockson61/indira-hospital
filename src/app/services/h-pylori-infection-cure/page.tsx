...
export const metadata: Metadata = {
  title: "H-pylori Infection Cure | Indira Hospital Vellore",
  description: "Learn about H-pylori Infection Cure at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function HPyloriInfectionCurePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>H-pylori Infection Cure is a highly specialized treatment provided by our expert medical team.</strong> This advanced procedure offers exceptional success rates with transparent pricing.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Your structured clinical pathway for H-pylori Infection Cure",
        steps: [
    ...
    >
        ...
        <h2>Understanding H-pylori Infection Cure</h2>
        <p>H-pylori Infection Cure is a cutting-edge medical procedure designed to address severe bloating and persistent heartburn. At Indira Hospital, our distinguished specialists utilize precision diagnostics to ensure maximum safety and rapid recovery. By choosing our dedicated department, patients benefit from world-class healthcare tailored to their precise clinical needs.</p>
        
        <h2>Who Needs This Treatment?</h2>
        <p>If you are experiencing warning signs such as severe bloating, conservative therapies may not be sufficient. H-pylori Infection Cure is recommended when lifestyle modifications fail to provide relief, and diagnostic imaging confirms the necessity of a cutting-edge intervention. Early consultation can prevent complications and lead to rapid recovery.</p>
        
        <h2>The Procedure at Indira Hospital</h2>
        <p>The H-pylori Infection Cure pathway begins with comprehensive pre-operative diagnostics to map out the anatomy. In the operating suite, our team leverages precision diagnostics for exact execution. The minimally invasive nature of modern techniques means the procedure generally concludes within 30 mins, drastically reducing trauma.</p>
