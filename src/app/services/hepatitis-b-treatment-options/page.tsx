...
// Topic: Hepatitis B Treatment Options
// Cluster: gastroenterology
// Hub: /services/gastroenterology
// Generated: 2026-02-25T04:19:28.072Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Hepatitis B Treatment Options | Indira Hospital Vellore",
  description: "Learn about Hepatitis B Treatment Options at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function HepatitisBTreatmentOptionsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Hepatitis B Treatment Options is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Hepatitis B Treatment Options",
        steps: [
