      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Stroke Recovery Exercises at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Stroke Recovery Exercises"
          description="Read verified experiences from patients who underwent Stroke Recovery Exercises at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
