      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Eeg Test Procedure at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Eeg Test Procedure"
          description="Read verified experiences from patients who underwent Eeg Test Procedure at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
