      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Parkinsons Disease Care at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Parkinsons Disease Care"
          description="Read verified experiences from patients who underwent Parkinsons Disease Care at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
