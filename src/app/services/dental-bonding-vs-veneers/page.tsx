...
// Topic: Dental Bonding Vs Veneers
// Cluster: cosmetic-dentistry
// Hub: /services/cosmetic-dentistry
// Generated: 2026-02-25T03:34:09.118Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Dental Bonding Vs Veneers | Indira Hospital Vellore",
  description: "Learn about Dental Bonding Vs Veneers at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function DentalBondingVsVeneersPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Dental Bonding Vs Veneers is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Dental Bonding Vs Veneers",
        steps: [
