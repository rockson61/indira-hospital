      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Chronic Kidney Disease Stages at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Chronic Kidney Disease Stages"
          description="Read verified experiences from patients who underwent Chronic Kidney Disease Stages at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
