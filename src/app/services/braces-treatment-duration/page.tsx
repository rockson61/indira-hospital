...
// Topic: Braces Treatment Duration
// Cluster: orthodontics
// Hub: /services/orthodontics
// Generated: 2026-02-25T03:34:09.106Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Braces Treatment Duration | Indira Hospital Vellore",
  description: "Learn about Braces Treatment Duration at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function BracesTreatmentDurationPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Braces Treatment Duration is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Braces Treatment Duration",
        steps: [
