...
// Topic: Gingivitis Treatment Guide
// Cluster: gum-treatment
// Hub: /services/gum-treatment
// Generated: 2026-02-25T03:34:09.110Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Gingivitis Treatment Guide | Indira Hospital Vellore",
  description: "Learn about Gingivitis Treatment Guide at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function GingivitisTreatmentGuidePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Gingivitis Treatment Guide is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Gingivitis Treatment Guide",
        steps: [
