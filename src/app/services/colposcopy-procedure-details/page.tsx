...
// Topic: Colposcopy Procedure Details
...
export const metadata: Metadata = {
  title: "Colposcopy Procedure Details | Indira Hospital Vellore",
  description: "Learn about Colposcopy Procedure Details at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function ColposcopyProcedureDetailsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Colposcopy Procedure Details is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Colposcopy Procedure Details",
        steps: [
