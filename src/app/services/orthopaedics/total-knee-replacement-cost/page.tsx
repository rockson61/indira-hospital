      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Total Knee Replacement Cost at Indira Super Speciality Hospital
          </h1>
        ...
        <section className="py-8 bg-teal-50 dark:bg-teal-900/20 rounded-xl p-6">
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/services/orthopaedics" className="text-teal-600 hover:underline">
                ← Back to orthopaedics main page
              </Link>
            </li>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Total Knee Replacement Cost"
          description="Read verified experiences from patients who underwent Total Knee Replacement Cost at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
