      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Spine Surgery Disc Prolapse at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Spine Surgery Disc Prolapse"
          description="Read verified experiences from patients who underwent Spine Surgery Disc Prolapse at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
