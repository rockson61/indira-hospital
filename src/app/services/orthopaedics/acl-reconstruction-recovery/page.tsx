      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Acl Reconstruction Recovery at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Acl Reconstruction Recovery"
          description="Read verified experiences from patients who underwent Acl Reconstruction Recovery at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
