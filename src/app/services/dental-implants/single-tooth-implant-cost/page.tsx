...
// Topic: Single Tooth Implant Cost
// Cluster: dental-implants
// Hub: /services/dental-implants
// Generated: 2026-02-14T15:12:30.826Z
...
export const metadata: Metadata = {
  title: "Single Tooth Implant Cost | Indira Dental Clinic Vellore",
  description: "TODO: Add 150-160 character description with primary keyword in first 60 characters."
};

export default function SingleToothImplantCostPage() {
  return (
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Single Tooth Implant Cost at Indira Dental Clinic
          </h1>
        ...
        <section className="py-8 prose prose-lg max-w-none">
          <h2>What is Single Tooth Implant Cost?</h2>
