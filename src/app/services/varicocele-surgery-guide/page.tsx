...
// Topic: Varicocele Surgery Guide
// Cluster: urology
...
export const metadata: Metadata = {
  title: "Varicocele Surgery Guide | Indira Hospital Vellore",
  description: "Learn about Varicocele Surgery Guide at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function VaricoceleSurgeryGuidePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Varicocele Surgery Guide is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Varicocele Surgery Guide",
        steps: [
