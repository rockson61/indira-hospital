...
// Topic: Phimosis Treatment Options
// Cluster: urology
...
export const metadata: Metadata = {
  title: "Phimosis Treatment Options | Indira Hospital Vellore",
  description: "Learn about Phimosis Treatment Options at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function PhimosisTreatmentOptionsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Phimosis Treatment Options is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Phimosis Treatment Options",
        steps: [
