...
// Topic: Urinary Incontinence Treatment
// Cluster: urology
...
export const metadata: Metadata = {
  title: "Urinary Incontinence Treatment | Indira Hospital Vellore",
  description: "Learn about Urinary Incontinence Treatment at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function UrinaryIncontinenceTreatmentPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Urinary Incontinence Treatment is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Urinary Incontinence Treatment",
        steps: [
