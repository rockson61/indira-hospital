...
// Topic: Breast Cancer Screening Guide
// Cluster: oncology
// Hub: /services/oncology
// Generated: 2026-02-25T03:34:09.137Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Breast Cancer Screening Guide | Indira Hospital Vellore",
  description: "Learn about Breast Cancer Screening Guide at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function BreastCancerScreeningGuidePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Breast Cancer Screening Guide is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Breast Cancer Screening Guide",
        steps: [
