...
// Topic: Bone Grafting For Implants
...
export const metadata: Metadata = {
  title: "Bone Grafting For Implants | Indira Hospital Vellore",
  description: "Learn about Bone Grafting For Implants at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function BoneGraftingForImplantsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Bone Grafting For Implants is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Bone Grafting For Implants",
        steps: [
