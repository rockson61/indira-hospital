...
// Topic: Cervical Cancer Screening PAP
// Cluster: obstetrics-gynaecology
// Hub: /services/obstetrics-gynaecology
// Generated: 2026-02-25T04:19:28.074Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Cervical Cancer Screening PAP | Indira Hospital Vellore",
  description: "Learn about Cervical Cancer Screening PAP at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function CervicalCancerScreeningPapPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Cervical Cancer Screening PAP is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Cervical Cancer Screening PAP",
        steps: [
