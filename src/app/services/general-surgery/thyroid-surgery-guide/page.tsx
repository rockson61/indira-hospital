      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Thyroid Surgery Guide at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Thyroid Surgery Guide"
          description="Read verified experiences from patients who underwent Thyroid Surgery Guide at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
