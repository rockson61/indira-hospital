      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Appendix Surgery Steps at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Appendix Surgery Steps"
          description="Read verified experiences from patients who underwent Appendix Surgery Steps at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
