      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Varicose Veins Laser Treatment at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Varicose Veins Laser Treatment"
          description="Read verified experiences from patients who underwent Varicose Veins Laser Treatment at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
