      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Laparoscopic Hernia Repair at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Laparoscopic Hernia Repair"
          description="Read verified experiences from patients who underwent Laparoscopic Hernia Repair at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
