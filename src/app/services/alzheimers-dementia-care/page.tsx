...
// Topic: Alzheimers Dementia Care
// Cluster: neurology
...
export const metadata: Metadata = {
  title: "Alzheimers Dementia Care | Indira Hospital Vellore",
  description: "Learn about Alzheimers Dementia Care at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};
...
export default function AlzheimersDementiaCarePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Alzheimers Dementia Care is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Alzheimers Dementia Care",
        steps: [
