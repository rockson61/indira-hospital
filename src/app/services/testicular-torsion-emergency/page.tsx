...
// Topic: Testicular Torsion Emergency
// Cluster: urology
...
export const metadata: Metadata = {
  title: "Testicular Torsion Emergency | Indira Hospital Vellore",
  description: "Learn about Testicular Torsion Emergency at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function TesticularTorsionEmergencyPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Testicular Torsion Emergency is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Testicular Torsion Emergency",
        steps: [
