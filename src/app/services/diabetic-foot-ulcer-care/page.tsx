...
// Topic: Diabetic Foot Ulcer Care
...
export const metadata: Metadata = {
  title: "Diabetic Foot Ulcer Care | Indira Hospital Vellore",
  description: "Learn about Diabetic Foot Ulcer Care at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function DiabeticFootUlcerCarePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Diabetic Foot Ulcer Care is a highly specialized treatment provided by our expert medical team.</strong> This advanced procedure offers exceptional success rates with transparent pricing.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Your structured clinical pathway for Diabetic Foot Ulcer Care",
        steps: [
