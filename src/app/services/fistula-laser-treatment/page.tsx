...
// Topic: Fistula Laser Treatment
// Cluster: general-surgery
// Hub: /services/general-surgery
// Generated: 2026-02-25T04:19:28.069Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Fistula Laser Treatment | Indira Hospital Vellore",
  description: "Learn about Fistula Laser Treatment at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function FistulaLaserTreatmentPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Fistula Laser Treatment is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Fistula Laser Treatment",
        steps: [
