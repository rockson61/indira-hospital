    ...
    return (
        <SubServiceTemplate
            ...
            relatedServices={{
                ...
                related: [
                    { title: "Endoscopy Guide", href: "/services/gastroenterology/endoscopy-procedure-guide" },
                    { title: "Pancreatitis Treatment", href: "/services/gastroenterology/pancreatitis-treatment-steps" },
        ...
        >
            <section>
                ...
                <div className="my-10 p-8 md:p-10 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/10 dark:to-indigo-900/10 rounded-[2.5rem] border border-purple-100 dark:border-purple-900 shadow-sm">
                    <h4 className="text-2xl font-black text-slate-900 dark:text-purple-300 mb-4 tracking-tight">Advanced Endoscopy Suite Features</h4>
