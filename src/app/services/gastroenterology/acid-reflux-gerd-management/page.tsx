...
// Topic: Acid Reflux Gerd Management
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Acid Reflux Gerd Management at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Acid Reflux Gerd Management"
          description="Read verified experiences from patients who underwent Acid Reflux Gerd Management at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
