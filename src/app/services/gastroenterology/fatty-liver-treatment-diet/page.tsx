      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Fatty Liver Treatment Diet at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Fatty Liver Treatment Diet"
          description="Read verified experiences from patients who underwent Fatty Liver Treatment Diet at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
