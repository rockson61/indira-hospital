      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Colonoscopy Screening Cost at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Colonoscopy Screening Cost"
          description="Read verified experiences from patients who underwent Colonoscopy Screening Cost at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
