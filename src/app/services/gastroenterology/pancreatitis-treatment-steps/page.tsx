      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Pancreatitis Treatment Steps at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Pancreatitis Treatment Steps"
          description="Read verified experiences from patients who underwent Pancreatitis Treatment Steps at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
