    ...
    return (
        <SubServiceTemplate
            ...
            relatedServices={{
                ...
                related: [
                    { title: "Acid Reflux / GERD", href: "/services/gastroenterology/acid-reflux-gerd-management" },
                    { title: "Colonoscopy Screening", href: "/services/gastroenterology/colonoscopy-screening-cost" },
                    { title: "H. Pylori Cure", href: "/services/gastroenterology/h-pylori-infection-cure" }
                ]
            }}
            reviews={{
