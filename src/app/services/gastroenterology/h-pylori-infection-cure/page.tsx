      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            H-pylori Infection Cure at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with H-pylori Infection Cure"
          description="Read verified experiences from patients who underwent H-pylori Infection Cure at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
