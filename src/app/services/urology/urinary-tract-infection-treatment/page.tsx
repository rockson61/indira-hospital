      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Urinary Tract Infection Treatment at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Urinary Tract Infection Treatment"
          description="Read verified experiences from patients who underwent Urinary Tract Infection Treatment at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
