  ...
  return (
    <SubServiceTemplate
      ...
      relatedServices={{
        serviceSlug: "urology",
        related: [
          { title: "Infertility Evaluation (Female)", href: "/services/obstetrics-gynaecology/infertility-evaluation-steps" },
          { title: "Prostate TURP Surgery", href: "/services/urology/prostate-turp-surgery" },
          { title: "Kidney Stone Prevention", href: "/services/urology/kidney-stone-prevention-guide" }
        ]
      }}
