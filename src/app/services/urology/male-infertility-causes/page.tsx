      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Male Infertility Causes at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Male Infertility Causes"
          description="Read verified experiences from patients who underwent Male Infertility Causes at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
