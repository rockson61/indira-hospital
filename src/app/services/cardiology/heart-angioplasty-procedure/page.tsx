      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Heart Angioplasty Procedure at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Heart Angioplasty Procedure"
          description="Read verified experiences from patients who underwent Heart Angioplasty Procedure at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
