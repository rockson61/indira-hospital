      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Preventive Heart Checkup at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Preventive Heart Checkup"
          description="Read verified experiences from patients who underwent Preventive Heart Checkup at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
