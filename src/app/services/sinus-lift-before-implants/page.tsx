...
// Topic: Sinus Lift Before Implants
// Cluster: dental-implants
// Hub: /services/dental-implants
// Generated: 2026-02-25T03:34:09.090Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Sinus Lift Before Implants | Indira Hospital Vellore",
  description: "Learn about Sinus Lift Before Implants at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function SinusLiftBeforeImplantsPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Sinus Lift Before Implants is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Sinus Lift Before Implants",
        steps: [
