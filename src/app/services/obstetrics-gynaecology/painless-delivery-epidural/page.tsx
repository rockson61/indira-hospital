...
// Generated: 2026-02-16T11:40:07.707Z
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Painless Delivery Epidural at Indira Super Speciality Hospital
          </h1>
        ...
        <section className="py-8 bg-teal-50 dark:bg-teal-900/20 rounded-xl p-6">
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/services/obstetrics-gynaecology" className="text-teal-600 hover:underline">
                ← Back to obstetrics gynaecology main page
              </Link>
            </li>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Painless Delivery Epidural"
          description="Read verified experiences from patients who underwent Painless Delivery Epidural at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
