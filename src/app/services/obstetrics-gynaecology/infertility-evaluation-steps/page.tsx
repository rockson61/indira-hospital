...
// Topic: Infertility Evaluation Steps
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Infertility Evaluation Steps at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Infertility Evaluation Steps"
          description="Read verified experiences from patients who underwent Infertility Evaluation Steps at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
