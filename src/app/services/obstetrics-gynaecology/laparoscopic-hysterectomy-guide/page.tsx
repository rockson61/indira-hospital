      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Laparoscopic Hysterectomy Guide at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Laparoscopic Hysterectomy Guide"
          description="Read verified experiences from patients who underwent Laparoscopic Hysterectomy Guide at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
