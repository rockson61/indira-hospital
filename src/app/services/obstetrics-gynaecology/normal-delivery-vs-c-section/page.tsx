...
// Generated: 2026-02-16T11:40:07.706Z
      ...
      <SectionContainer>
        ...
        <section className="py-12">
          <h1 className="text-4xl font-bold text-foreground mb-6">
            Normal Delivery Vs C-section at Indira Super Speciality Hospital
          </h1>
        ...
        <EntityReviews 
          ...
          title="Patient Experiences with Normal Delivery Vs C-section"
          description="Read verified experiences from patients who underwent Normal Delivery Vs C-section at Indira Super Speciality Hospital."
        />
      </SectionContainer>
    </main>
  );
