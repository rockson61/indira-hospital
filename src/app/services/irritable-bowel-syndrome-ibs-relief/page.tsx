...
// Topic: Irritable Bowel Syndrome IBS Relief
// Cluster: gastroenterology
// Hub: /services/gastroenterology
// Generated: 2026-02-25T04:19:28.071Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Irritable Bowel Syndrome IBS Relief | Indira Hospital Vellore",
  description: "Learn about Irritable Bowel Syndrome IBS Relief at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function IrritableBowelSyndromeIbsReliefPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Irritable Bowel Syndrome IBS Relief is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Irritable Bowel Syndrome IBS Relief",
        steps: [
