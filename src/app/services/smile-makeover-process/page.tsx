...
// Topic: Smile Makeover Process
// Cluster: cosmetic-dentistry
// Hub: /services/cosmetic-dentistry
// Generated: 2026-02-25T03:34:09.114Z

import { Metadata } from "next";
import { SubServiceTemplate } from "@/components/healthcare/SubServiceTemplate";

export const metadata: Metadata = {
  title: "Smile Makeover Process | Indira Hospital Vellore",
  description: "Learn about Smile Makeover Process at Indira Super Speciality Hospital. Expert care by senior doctors with affordable cost, premium facilities, and 0% EMIs available."
};

export default function SmileMakeoverProcessPage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Smile Makeover Process is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Smile Makeover Process",
        steps: [
