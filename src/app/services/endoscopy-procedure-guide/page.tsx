...
// Generated: 2026-02-25T03:34:09.124Z
...
export default function EndoscopyProcedureGuidePage() {
  return (
    <SubServiceTemplate
      ...
      description={
        <span>
          <strong>Endoscopy Procedure Guide is a specialized treatment provided at Indira Super Speciality Hospital in Vellore.</strong> The procedure offers long-lasting results with affordable pricing, bringing you premium care at up to 50% lower cost than Chennai and Bangalore.
        </span>
      }
      ...
      timeline={{
        ...
        description: "Our streamlined approach to Endoscopy Procedure Guide",
        steps: [
