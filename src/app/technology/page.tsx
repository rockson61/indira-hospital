    ...
    return (
        <main className="min-h-screen bg-slate-50 dark:bg-slate-950 selection:bg-teal-200 selection:text-teal-900 pb-24">
            ...
            <section className="bg-slate-900 pt-36 pb-40 lg:pt-48 lg:pb-48 text-white relative overflow-hidden rounded-b-[3rem] sm:rounded-b-[5rem]">
                ...
                <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-teal-500/20 rounded-full blur-[120px] opacity-70 pointer-events-none" />
                ...
                <SectionContainer className="relative z-10 text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <h1 className="text-5xl sm:text-7xl font-black mb-6 tracking-tight leading-[1.1]">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-indigo-400">Saves Lives.</span>
                        </h1>
            ...
            <SectionContainer className="relative z-20 -mt-20 max-w-6xl mx-auto px-4">
                <div className="bg-white/40 backdrop-blur-3xl rounded-[2.5rem] border border-white shadow-[0_20px_40px_rgba(0,0,0,0.08)] p-8">
                    <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
                        <div className="group">
                            <div className="w-14 h-14 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center mb-5 mx-auto md:mx-0 group-hover:bg-teal-50 group-hover:border-teal-200 group-hover:scale-110 transition-all duration-300">
                        ...
                        {technologies.map((tech) => (
                            <Link key={tech.slug} href={`/technology/${tech.slug}`} className="group relative h-full flex flex-col bg-slate-800/50 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/5 hover:bg-slate-800 hover:border-teal-500/30 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)] hover:-translate-y-2 transition-all duration-500 overflow-hidden">
                                ...
                                <div className="relative z-10 flex-grow pr-8">
                                    <div className="mb-6 flex w-16 h-16 items-center justify-center rounded-2xl bg-white/5 border border-white/10 group-hover:bg-teal-500 group-hover:border-teal-400 transition-all duration-500 shadow-lg">
                                        <Monitor className="w-8 h-8 text-teal-300 group-hover:text-white transition-colors" />
                                    </div>

                                    <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-teal-400 group-hover:to-emerald-400 transition-colors">
                                        {tech.title}
                                    </h3>
                                ...
                                <div className="relative z-10 mt-auto flex items-center justify-between pt-6 border-t border-white/10">
                                    <span className="text-sm font-bold text-slate-500 group-hover:text-teal-400 uppercase tracking-widest transition-colors">Discover</span>
                                    <span className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-teal-500 group-hover:text-white transition-all shadow-md">
                ...
                <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-teal-950 rounded-[4rem] border border-white/10 overflow-hidden shadow-2xl relative group/cta flex flex-col items-center text-center p-12 sm:p-20">
                    ...
                    <div className="relative z-10 w-full max-w-4xl">
                        ...
                        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-8 tracking-tight leading-[1.1]">
                            Experience Digital <br /> <span className="text-teal-400">Healthcare.</span>
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center w-full max-w-2xl mx-auto">
                            <Link href="/contact" className="group/btn relative flex items-center justify-center w-full sm:w-auto px-10 py-5 bg-teal-500 text-white font-black rounded-2xl hover:scale-[1.02] transition-all shadow-lg shadow-teal-500/25 overflow-hidden">
                            ...
                            <Link href="/doctors" className="flex items-center justify-center w-full sm:w-auto px-10 py-5 bg-white/5 backdrop-blur-md text-white border border-white/10 font-bold rounded-2xl hover:bg-white/10 transition-colors">
                                ...
                                <ChevronRight className="w-5 h-5 ml-2 text-teal-400" />
                            </Link>
                        </div>
                    </div>
                </div>
