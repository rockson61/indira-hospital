...
export default function TechnologyHubPage() {
 ...
 <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-white shadow-[0_20px_40px_rgba(0,0,0,0.08)] p-8">
 ...
 {/* TRUST SIGNALS */}
 <SectionContainer className="max-w-7xl mx-auto py-24 border-t border-slate-200 dark:border-slate-800">
