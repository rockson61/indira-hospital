...
export default function AppointmentPage() {
 ...
 <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-emerald-400 text-[10px] font-black tracking-[0.4em] uppercase mb-12 shadow-2xl">
