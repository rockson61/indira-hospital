...
export default function AppointmentPage() {
 ...
 <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-emerald-400 text-xs font-black tracking-widest uppercase mb-12 shadow-2xl">
 ...
 <p className="text-xl md:text-2xl text-subtle-on-light max-w-4xl mx-auto font-light leading-relaxed mb-8">
 ...
 <span className="text-sm font-black uppercase tracking-widest text-white">Same-Week Surgery</span>
 </div>
 <div className="w-px h-6 bg-white dark:bg-slate-900"/>
 <div className="flex items-center gap-2">
 <Sparkles className="w-5 h-5 text-indigo-400"/>
 <span className="text-sm font-black uppercase tracking-widest text-white">Fixed Cost Estimates</span>
 </div>
 </div>
 </div>
 ...
 <Suspense fallback={<div className="h-[600px] w-full animate-pulse bg-white dark:bg-slate-900 rounded-[4rem] border border-slate-200 dark:border-slate-800"/>}>
 <BookingFunnel />
 </Suspense>
 </section>
 ...
 <p className="text-xs font-black text-slate-600 uppercase tracking-[0.5em] mb-10">Trusted by 15,000+ Annual Surgical Patients</p>
