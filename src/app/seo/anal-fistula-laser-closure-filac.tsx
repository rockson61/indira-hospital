...
export const metadata: Metadata = {
  title: "Anal Fistula Laser Closure FILAC | Indira Elite Hospital Vellore",
  description: "Learn about Anal Fistula Laser Closure FILAC at Indira Elite Super Speciality Hospital. Experience robotic-assisted clinical mastery with transparent pricing and premium recovery suites."
};

export default function AnalFistulaLaserClosureFilacPage() {
  return (
    <SubServiceTemplate
      title="Anal Fistula Laser Closure FILAC"
      eyebrow="Indira Elite Proctology"
      description={
        <span>
          <strong>Anal Fistula Laser Closure FILAC is a clinical core competency at Indira Elite Hospital.</strong> Our senior consultants utilize advanced robotic-assisted technology to ensure maximum precision and rapid patient recovery.
        </span>
      }
      ...
      timeline={{
        ...
        description: "The structured journey for Anal Fistula Laser Closure FILAC at Indira Elite",
        steps: [
      ...
      reviews={{
        entityType: "service",
        entityName: "Anal Fistula Laser Closure FILAC",
        entitySlug: "seo/anal-fistula-laser-closure-filac"
      }}
    >
