...
export const metadata: Metadata = {
  title: "Robotic Knee Replacement Vellore | Indira Elite Hospital Vellore",
  description: "Learn about Robotic Knee Replacement Vellore at Indira Elite Super Speciality Hospital. Experience robotic-assisted clinical mastery with transparent pricing and premium recovery suites."
};

export default function RoboticKneeReplacementVellorePage() {
  return (
    <SubServiceTemplate
      title="Robotic Knee Replacement Vellore"
      eyebrow="Indira Elite Orthopaedics"
      description={
        <span>
          <strong>Robotic Knee Replacement Vellore is a clinical core competency at Indira Elite Hospital.</strong> Our senior consultants utilize advanced robotic-assisted technology to ensure maximum precision and rapid patient recovery.
        </span>
      }
      ...
      timeline={{
        ...
        description: "The structured journey for Robotic Knee Replacement Vellore at Indira Elite",
        steps: [
      ...
      reviews={{
        entityType: "service",
        entityName: "Robotic Knee Replacement Vellore",
        entitySlug: "seo/robotic-knee-replacement-vellore"
      }}
    >
        {/* Procedural Unique Main Content (Elite Information Gain) */}

        <h2>Understanding Robotic Knee Replacement Vellore</h2>
        <p>Patients suffering from joint stiffness or joint stiffness often find lasting relief through Robotic Knee Replacement Vellore. This minimally invasive intervention is conducted using precision diagnostics, paving the way for improved function. The expert team at Indira Super Speciality Hospital is highly trained in performing this procedure with exceptional precision and care.</p>
