...
export const metadata: Metadata = {
  title: "Painless Fistula Surgery Recovery | Indira Elite Hospital Vellore",
  description: "Learn about Painless Fistula Surgery Recovery at Indira Elite Super Speciality Hospital. Experience robotic-assisted clinical mastery with transparent pricing and premium recovery suites."
};

export default function PainlessFistulaSurgeryRecoveryPage() {
  return (
    <SubServiceTemplate
      title="Painless Fistula Surgery Recovery"
      eyebrow="Indira Elite Proctology"
      description={
        <span>
          <strong>Painless Fistula Surgery Recovery is a clinical core competency at Indira Elite Hospital.</strong> Our senior consultants utilize advanced robotic-assisted technology to ensure maximum precision and rapid patient recovery.
        </span>
      }
      ...
      timeline={{
        ...
        description: "The structured journey for Painless Fistula Surgery Recovery at Indira Elite",
        steps: [
      ...
      reviews={{
        entityType: "service",
        entityName: "Painless Fistula Surgery Recovery",
        entitySlug: "seo/painless-fistula-surgery-recovery"
      }}
    >
