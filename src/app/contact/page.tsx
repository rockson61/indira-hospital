                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-6xl sm:text-8xl lg:text-[7rem] font-black text-white tracking-tight leading-[0.95] mb-8 max-w-6xl mx-auto">
                            Command <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-300">Accessibility.</span>
                        </h1>
                        ...
                        >
                            ...
                            <div className="space-y-10 relative z-10">
                                ...
                                <div className="flex gap-6 group/item">
                                    <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center flex-shrink-0 border border-slate-100 group-hover/item:bg-teal-500 group-hover/item:text-white transition-all duration-500 shadow-sm group-hover/item:scale-110">
                                        <MapPin className="w-7 h-7" />
                                    </div>
                                    <div>
                                        <h3 className="text-xs font-black uppercase tracking-[0.2em] text-slate-400 mb-3">Address</h3>
                                        <p className="text-xl text-slate-600 leading-relaxed font-bold group-hover/item:text-teal-700 transition-colors">
                                ...
                                <div className="flex gap-6 group/item cursor-pointer">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+9104162223333" className="block text-slate-600 font-bold hover:text-teal-600 transition-colors text-lg">+91 0416 222 3333 <span className="text-xs text-slate-400 uppercase tracking-widest ml-2">(Admin)</span></a>
                                    </div>
                                </div>
                                ...
                                {/* Timing Block */}
                                <div className="flex gap-6 group/item">
                                    <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center flex-shrink-0 border border-slate-100 group-hover/item:bg-emerald-500 group-hover/item:text-white transition-all duration-500 shadow-sm group-hover/item:scale-110">
                    ...
                    <div className="lg:col-span-7">
                        ...
                        >
                            ...
                            <div className="relative z-10 mb-12">
                                <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-teal-300 text-xs font-black tracking-[0.2em] uppercase mb-8 shadow-sm">
                            ...
                            <form className="space-y-10 relative z-10">
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <Input placeholder="John" className="bg-white/5 border-slate-700/50 focus:bg-white/10 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 h-16 rounded-[1.5rem] text-lg px-8 font-bold text-white transition-all outline-none" />
                                    </div>
                                    <div className="space-y-3">
                                        ...
                                        <Input placeholder="Doe" className="bg-white/5 border-slate-700/50 focus:bg-white/10 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 h-16 rounded-[1.5rem] text-lg px-8 font-bold text-white transition-all outline-none" />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Input type="email" placeholder="john.doe@expert.com" className="bg-white/5 border-slate-700/50 focus:bg-white/10 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 h-16 rounded-[1.5rem] text-lg px-8 font-bold text-white transition-all outline-none" />
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Input placeholder="+91 98765 00000" className="bg-white/5 border-slate-700/50 focus:bg-white/10 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 h-16 rounded-[1.5rem] text-lg px-8 font-bold text-white transition-all outline-none" />
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Textarea className="min-h-[200px] bg-white/5 border-slate-700/50 focus:bg-white/10 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 rounded-[2rem] text-lg p-8 font-bold text-white transition-all outline-none resize-none" placeholder="Provide specific details about your clinical history or inquiry..." />
                                </div>

                                <button
                                    type="button"
                                    className="group/btn relative flex items-center justify-center w-full px-10 py-7 bg-teal-500 text-slate-900 font-black rounded-3xl transition-all duration-500 hover:scale-[1.02] shadow-2xl shadow-teal-500/30 overflow-hidden"
                                >
                                ...
                                <p className="text-center text-sm text-slate-500 font-medium">By transmitting this form, you precisely agree to our absolute <a href="/privacy-policy" className="text-teal-400 hover:underline">Privacy Protocols</a> regarding data encryption.</p>
                            </form>
                        </motion.div>
                    </div>
                </div>
