            ...
            <section className="bg-gradient-to-br from-fuchsia-900 to-indigo-900 text-white pt-32 pb-16 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        ...
                        <a href={`tel:${siteConfig.contact.phone}`} className="px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-lg text-white font-bold rounded-2xl transition-all border border-white/20 flex items-center gap-2">
