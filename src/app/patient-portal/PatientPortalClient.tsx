...
export default function PatientPortalClient() {
 ...
 >
 <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-fuchsia-300 text-sm font-bold tracking-[0.2em] uppercase mb-10 shadow-[0_0_40px_-5px_rgba(232,121,249,0.3)]">
 ...
 viewport={{ once: true }}
 className="lg:col-span-5 bg-white dark:bg-slate-900 rounded-[3.5rem] p-10 md:p-14 shadow-2xl border border-slate-200 dark:border-slate-800 relative group overflow-hidden"
 >
 ...
 <p className="text-slate-500 dark:text-subtle-on-light text-sm font-medium">Authentication Required</p>
 </div>
 </div>

 <form className="space-y-8">
 <div className="space-y-3">
 <label htmlFor="patient-id"className="text-sm font-black text-subtle-on-light dark:text-slate-500 uppercase tracking-[0.2em]">UHID / Patient Email</label>
 <div className="relative group/input">
 <div className="absolute left-5 top-1/2 -translate-y-1/2 text-subtle-on-light group-focus-within/input:text-fuchsia-500 transition-colors">
 ...
 className="w-full pl-14 pr-6 py-5 bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 rounded-2xl focus:outline-none focus:ring-4 focus:ring-fuchsia-500/10 focus:border-fuchsia-500 transition-all text-slate-900 dark:text-white font-medium placeholder:text-subtle-on-light"
 />
 </div>
 </div>
 ...
 <label htmlFor="password"className="text-sm font-black text-subtle-on-light dark:text-slate-500 uppercase tracking-[0.2em]">Secret Password</label>
 <Link href="#"className="text-sm font-black text-fuchsia-600 dark:text-fuchsia-400 hover:text-fuchsia-700 uppercase tracking-widest">Forgot?</Link>
 </div>
 <div className="relative group/input">
 <div className="absolute left-5 top-1/2 -translate-y-1/2 text-subtle-on-light group-focus-within/input:text-fuchsia-500 transition-colors">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light text-sm font-medium">
 ...
 className="group flex gap-8 p-10 bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-slate-800/50 hover:shadow-2xl hover:shadow-fuchsia-500/5 hover:-translate-y-1 transition-all duration-500"
 >
 ...
 <p className="text-slate-500 dark:text-subtle-on-light leading-relaxed font-medium">{f.desc}</p>
 </div>
 </motion.div>
 ))}
 ...
 viewport={{ once: true }}
 className="mt-8 p-8 bg-gradient-to-br from-slate-900 to-indigo-950 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 relative overflow-hidden group/cta"
 >
 ...
 <p className="text-subtle-on-light text-sm">Call our 24/7 IT Help Desk for UHID verification.</p>
 </div>
