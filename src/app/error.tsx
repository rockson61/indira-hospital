...
export default function GlobalError({
 ...
 <p className="text-slate-600 dark:text-subtle-on-light mb-6 text-sm">
 ...
 <p className="text-subtle-on-light text-sm mb-2 font-mono uppercase tracking-widest font-semibold flex justify-between">
