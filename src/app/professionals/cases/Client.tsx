...
export function CasesClient() {
 ...
 >
 <Card className="bg-slate-900 dark:bg-slate-900 border-slate-200 dark:border-slate-800 overflow-hidden group hover:border-blue-500/30 transition-all duration-500">
 ...
 {/* CLINICAL DATA STRIP */}
 <section className="bg-slate-900 border-y border-slate-200 dark:border-slate-800 py-12 overflow-hidden">
