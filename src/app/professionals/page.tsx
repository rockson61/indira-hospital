...
export default function ProfessionalsHub() {
 ...
 >
 <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm font-black tracking-[0.2em] uppercase mb-10 shadow-[0_0_30px_-5px_var(--tw-shadow-color)] shadow-blue-500/20">
 ...
 <p className="text-xl md:text-2xl text-subtle-on-light max-w-4xl mx-auto font-light leading-relaxed mb-12">
 ...
 size="lg"
 variant="outline"
 className="h-16 px-10 rounded-2xl border-slate-200 dark:border-slate-800 hover:bg-white dark:bg-slate-900 font-bold text-lg"
 ...
 <Card key={i} className="bg-slate-900 border-slate-200 dark:border-slate-800 hover:border-blue-500/30 transition-all duration-500 transform-gpu hover:-translate-y-2 group">
 ...
 <p className="text-sm text-subtle-on-light font-medium leading-relaxed">
 {portal.description}
 </p>
 <Button 
 variant="link"
 className="p-0 text-blue-400 hover:text-blue-300 font-black uppercase text-sm tracking-widest group-hover:translate-x-1 transition-transform"
 ...
 <SectionContainer className="py-24 border-t border-slate-200 dark:border-slate-800 bg-slate-950/50">
 <div className="flex flex-col md:flex-row gap-20 items-center">
 <div className="md:w-1/2 space-y-8 text-left">
 <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm font-bold uppercase tracking-widest rounded-lg">
 ...
 <p className="text-lg text-subtle-on-light font-medium leading-relaxed">
 ...
 <div className="aspect-square rounded-[3rem] bg-gradient-to-br from-blue-600/20 to-indigo-900 border border-slate-200 dark:border-slate-800 p-12 flex items-center justify-center relative overflow-hidden group">
 ...
 <p className="text-subtle-on-light text-sm">Ranked #1 for Laparoscopic Innovation in the Region.</p>
 </div>
 {/* Decorative radar */}
 ...
 <p className="text-subtle-on-light max-w-2xl font-medium">Empowering the next generation of surgeons through accredited residency programs and continuous medical education.</p>
 </div>
