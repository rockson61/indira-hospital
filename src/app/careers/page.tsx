    ...
    return (
        <main className="min-h-screen bg-slate-50 selection:bg-fuchsia-200 selection:text-fuchsia-900 pb-24">
            ...
            <section className="bg-slate-900 pt-48 pb-48 lg:pt-60 lg:pb-64 text-white relative overflow-hidden rounded-b-[3rem] sm:rounded-b-[5rem]">
                ...
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-fuchsia-500/20 rounded-full blur-[120px] opacity-70 pointer-events-none" />
                ...
                <SectionContainer className="relative z-10 text-center">
                    <div className="max-w-4xl mx-auto">
                        <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-fuchsia-300 text-sm font-bold tracking-widest uppercase mb-8 shadow-[0_0_30px_-5px_var(--tw-shadow-color)] shadow-fuchsia-500/30">
                ...
                <SectionContainer>
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 gap-8">
                        <div className="max-w-2xl">
                            <h2 className="text-4xl sm:text-5xl font-black mb-6 text-slate-900 tracking-tight">Active <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-pink-500">Opportunities</span></h2>
                        ...
                        {[
                            ...
                            <div key={i} className="group flex flex-col sm:flex-row justify-between items-start sm:items-center p-6 sm:p-8 bg-white rounded-3xl border border-slate-200 hover:border-fuchsia-300 hover:shadow-[0_8px_30px_rgba(20,184,166,0.15)] hover:ring-2 hover:ring-fuchsia-500/20 transition-all duration-300 cursor-pointer hover:-translate-y-1 relative overflow-hidden">
                                ...
                                <div className="mb-6 sm:mb-0 sm:pl-4">
                                    <h4 className="text-2xl font-black text-slate-900 mb-3 group-hover:text-fuchsia-700 transition-colors tracking-tight">{job.title}</h4>
            ...
            <SectionContainer className="py-24">
                <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-fuchsia-950 rounded-[4rem] p-12 md:p-24 text-center text-white relative overflow-hidden shadow-2xl group/cta">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-fuchsia-500/10 rounded-full blur-[100px] group-hover/cta:bg-fuchsia-500/20 transition-colors duration-700" />
