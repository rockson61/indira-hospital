...
export default function CareersPage() {
 ...
 <p className="text-slate-500 dark:text-subtle-on-light leading-relaxed font-medium relative z-10">
 {item.desc}
 </p>
 </div>
 ))}
 ...
 <p className="text-xl text-slate-500 dark:text-subtle-on-light font-light leading-relaxed">
 ...
 <div className="flex flex-wrap gap-4 text-sm text-slate-500 dark:text-subtle-on-light font-bold uppercase tracking-widest">
