...
export default function QualityPage() {
 ...
 <p 
 className="text-slate-600 dark:text-subtle-on-light font-medium leading-relaxed"
 ...
 <div>
 <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-emerald-300 text-sm font-black tracking-widest uppercase mb-8">
 <Award className="w-3.5 h-3.5"/> Benchmarks
 </span>
 <h2 className="elite-section-title text-white er">
 Our Quality Pillars
 </h2>
 </div>
 <div className="max-w-md">
 <p className="text-subtle-on-light text-lg font-light leading-relaxed">
 ...
 <div key={i} className="group/item p-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[3rem] hover:bg-white dark:bg-slate-900 hover:border-emerald-500/30 transition-all duration-500">
 ...
 <p className="text-subtle-on-light font-medium text-sm leading-relaxed">{pillar.desc}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <InternalLinkGrid type="departments"title="Clinical Specialities"subtitle="NABH Standards"limit={8} className="mt-16 bg-slate-50 dark:bg-slate-900 rounded-[4rem] border"/>
 </div>
 </main>
 );
}
