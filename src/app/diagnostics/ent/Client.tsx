...
export function ENTDiagnosticsClient() {
 ...
 <p className="mt-4 text-sky-600 dark:text-sky-400 font-semibold border-l-4 border-sky-500 pl-4 uppercase tracking-tighter">
 ...
 <Volume2 className="w-16 h-16 text-sky-500 mb-6 font-heading uppercase tracking-widest"/>
 <h4 className="text-xl font-bold mb-2">ENT Diagnostic Benchmarks</h4>
 <ul className="space-y-4 mb-6">
 <li className="flex gap-3">
 <CheckCircle2 className="w-5 h-5 text-sky-500 shrink-0 antialiased leading-relaxed tracking-normal text-slate-800 dark:text-slate-200 uppercase font-black tracking-widest"/>
 <span className="text-sm font-bold uppercase font-black tracking-widest text-slate-800 dark:text-slate-200"><strong>Vocal Cord Stroboscopy</strong>: Slow-motion analysis of vocal fold vibration.</span>
 </li>
 <li className="flex gap-3">
 ...
 <h3 className="text-3xl font-bold mb-8 font-heading text-sky-300 uppercase tracking-widest leading-none">The ENT Diagnostic Spectrum</h3>
 ...
 <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-6 uppercase font-heading">From Diagnosis to Sensory Recovery</h3>
 <p className="mb-10 text-slate-600 dark:text-subtle-on-light">Our diagnostics pave the way for precise, life-changing ENT procedures:</p>
