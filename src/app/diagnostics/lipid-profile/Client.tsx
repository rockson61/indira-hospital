...
export function LipidProfileClient() {
 return (
 <DiagnosticTemplate
 ...
 <p className="mt-4 text-amber-600 dark:text-amber-400 font-semibold border-l-4 border-amber-500 pl-4 uppercase tracking-tighter">
