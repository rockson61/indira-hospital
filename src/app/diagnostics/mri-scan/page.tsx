            ...
            fullDescription={
                <div className="space-y-16">
                    ...
                    <section className="bg-slate-900 rounded-[3rem] p-10 md:p-16 text-white text-center relative overflow-hidden">
                        ...
                        <h3 className="text-3xl font-bold mb-8 italic font-primary text-fuchsia-300 uppercase tracking-widest leading-none">Specialized MRI Modalities</h3>
                    ...
                    <section className="text-left">
                        <div className="mb-12">
                            <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-4 italic font-primary tracking-tighter uppercase uppercase">Preparing for Your 3T MRI</h3>
