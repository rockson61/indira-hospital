...
export function CTScanClient() {
 ...
 <p className="mt-4 text-blue-600 dark:text-blue-400 font-semibold border-l-4 border-blue-500 pl-4 uppercase tracking-tighter">
 ...
 <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-8 border-l-4 border-blue-500 pl-4 font-heading uppercase tracking-tighter">
 ...
 <h3 className="text-3xl font-bold mb-8 font-heading text-blue-300 uppercase tracking-widest leading-none">Specialized CT Protocols</h3>
 ...
 <div className="mb-12">
 <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-4 font-heading tracking-tighter uppercase uppercase uppercase">Preparing for Your Elite CT Scan</h3>
 <p className="text-slate-600 dark:text-subtle-on-light">Ensuring safety and crystal-clear diagnostic quality.</p>
 </div>
