...
export function ProctologyDiagnosticsClient() {
 return (
 <DiagnosticTemplate
 ...
 <Activity className="w-16 h-16 text-fuchsia-500 mb-6 font-heading uppercase tracking-widest"/>
 <h4 className="text-xl font-bold mb-2">Surgical Mapping Benchmarks</h4>
 <ul className="space-y-4 mb-6">
 <li className="flex gap-3">
 <CheckCircle2 className="w-5 h-5 text-fuchsia-500 shrink-0 antialiased leading-relaxed tracking-normal text-slate-800 dark:text-slate-200 uppercase font-black tracking-widest"/>
 <span className="text-sm font-bold uppercase font-black tracking-widest text-slate-800 dark:text-slate-200"><strong>Hemorrhoid Grading</strong>: Categorizing Grade 1 to 4 for laser eligibility.</span>
 </li>
 <li className="flex gap-3">
 ...
 <h3 className="text-3xl font-bold mb-8 font-heading text-fuchsia-300 uppercase tracking-widest leading-none">Diagnostic Modality Spectrum</h3>
 ...
 <div className="mb-12">
 <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-4 font-heading tracking-tighter uppercase uppercase uppercase">The Proctology Consultation Hub</h3>
 <p className="text-slate-600 dark:text-subtle-on-light font-medium antialiased text-sm uppercase uppercase">Your roadmap to a permanent colorectal solution.</p>
 </div>
 ...
 <p className="text-sm text-slate-600 dark:text-subtle-on-light leading-relaxed antialiased">{item.desc}</p>
 </div>
 ))}
 </div>
 </section>
 ...
 <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-6 uppercase font-heading">From Diagnosis to Laser Cure</h3>
 <p className="mb-10 text-slate-600 dark:text-subtle-on-light">Once our elite diagnostics are complete, we build a customized surgical roadmap. Explore our advanced laser treatments for these conditions:</p>
