...
export function ProctologyDiagnosticsClient() {
 ...
 <p className="text-slate-600 dark:text-slate-400 italic font-medium antialiased text-sm uppercase uppercase">Your roadmap to a permanent colorectal solution.</p>
 </div>
 ...
 <p className="mb-10 text-slate-600 dark:text-slate-400">Once our elite diagnostics are complete, we build a customized surgical roadmap. Explore our advanced laser treatments for these conditions:</p>
