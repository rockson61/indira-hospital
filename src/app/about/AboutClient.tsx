...
export default function AboutClient() {
 ...
 viewport={{ once: true }}
 className="group relative bg-white dark:bg-slate-900 p-14 lg:p-20 rounded-[4rem] border border-slate-200 dark:border-slate-800 shadow-2xl transition-all duration-700 hover:-translate-y-2 overflow-hidden"
 >
 ...
 <h2 className="elite-section-title mb-8 text-slate-900 dark:text-white er uppercase">Our Mission</h2>
 <p 
 className="text-2xl text-slate-500 dark:text-subtle-on-light leading-relaxed font-light"
 ...
 whileInView={{ opacity: 1, x: 0 }}
 viewport={{ once: true }}
 className="group relative bg-slate-900 p-14 lg:p-20 rounded-[4rem] border border-slate-200 dark:border-slate-800 shadow-2xl hover:shadow-indigo-500/20 transition-all duration-700 hover:-translate-y-2 overflow-hidden"
 >
 <div className="absolute inset-x-0 top-0 h-1.5 bg-indigo-500"/>
 <div className="w-24 h-24 bg-white dark:bg-slate-900 rounded-[2rem] flex items-center justify-center mb-10 border border-slate-200 dark:border-slate-800 text-indigo-400 group-hover:scale-110 group-hover:-rotate-3 transition-transform">
 <Zap className="w-12 h-12"/>
 </div>
 <h2 className="elite-section-title mb-8 text-white er uppercase">Our Vision</h2>
 <p 
 className="text-2xl text-slate-300 leading-relaxed font-extralight"
 ...
 className="bg-white dark:bg-slate-900 rounded-[3rem] p-12 text-center border border-slate-100 dark:border-slate-800 shadow-xl hover:-translate-y-2 transition-all duration-500 group"
 >
 ...
 <p className="text-5xl font-black text-slate-900 dark:text-white mb-3 tracking-tighter uppercase">{stat.value}</p>
 <p className="text-xs font-black text-subtle-on-light uppercase tracking-[0.3em] leading-none">{stat.label}</p>
 </motion.div>
 ))}
 </div>
 </section>
 ...
 <span className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-slate-900 text-white text-xs font-black tracking-widest uppercase mb-8 shadow-2xl border border-slate-200 dark:border-slate-800">
 <Shield className="w-4 h-4 text-fuchsia-400"/> Guardians of Care
 </span>
 <h2 className="elite-section-title md:mb-8 text-slate-900 dark:text-white er uppercase">
 ...
 <p className="text-slate-500 dark:text-subtle-on-light font-medium text-2xl leading-relaxed max-w-3xl mx-auto font-serif">
 ...
 viewport={{ once: true }}
 transition={{ delay: idx * 0.1 }}
 className="relative bg-white dark:bg-slate-900 p-14 rounded-[4rem] border border-slate-200 dark:border-slate-800 text-center shadow-xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-700 group overflow-hidden flex flex-col items-center"
 >
 ...
 <span className="text-white font-black text-6xl tracking-tighter">{member.icon}</span>
 </div>
 </div>

 <h3 className="elite-section-title text-slate-900 dark:text-white mb-3 er uppercase">{member.name}</h3>
 <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-slate-100 dark:bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-200 dark:border-slate-800 text-xs font-black uppercase tracking-[0.2em] text-slate-500 dark:text-subtle-on-light mb-8 group-hover:bg-slate-900 group-hover:text-white transition-colors duration-500">
 {member.role}
 </div>
 <p className="text-xl text-slate-500 dark:text-subtle-on-light leading-relaxed font-light flex-grow">{member.desc}</p>
 </motion.div>
 ))}
 </div>
 </section>
 ...
 <div className="w-24 h-24 rounded-[2rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center text-fuchsia-400 mx-auto mb-12 shadow-2xl">
 ...
 <p className="text-xl md:text-3xl text-slate-300 font-light mb-16 leading-relaxed max-w-3xl mx-auto">
 ...
 >
 <span className="relative z-10 text-xl uppercase tracking-widest">Find Your Specialist</span>
 ...
 <Link
 href="/contact"
 className="group/call w-full sm:w-auto px-16 py-8 bg-white dark:bg-slate-900 hover:bg-white dark:bg-slate-900 text-white font-black rounded-[2rem] border border-slate-200 dark:border-slate-800 hover:border-slate-200 dark:border-slate-800 transition-all text-xl uppercase tracking-widest"
 >
 Contact Admin
 </Link>
 </div>
