...
export default function AboutPage() {
    return (
        <main className="min-h-screen bg-slate-50 selection:bg-teal-200 selection:text-teal-900 pb-20">
            {/* Bold Asymmetrical Deep Hero */}
            <section className="relative pt-36 pb-32 lg:pt-48 lg:pb-56 overflow-hidden bg-slate-900 rounded-b-[3rem] sm:rounded-b-[5rem]">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-6xl sm:text-8xl lg:text-[7rem] font-black text-white tracking-tight leading-[0.95] mb-8 max-w-6xl mx-auto">
                            The Legacy of <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-300">Certainty.</span>
                        </h1>
            ...
            <section className="max-w-7xl mx-auto px-6 lg:px-8 relative z-20 -mt-24 sm:-mt-32 mb-32">
                <div className="grid md:grid-cols-2 gap-10">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="group relative bg-white/70 backdrop-blur-2xl p-12 lg:p-16 rounded-[4rem] border border-slate-200/50 shadow-2xl transition-all duration-700 hover:-translate-y-2 overflow-hidden"
                    >
                        ...
                        <div className="w-24 h-24 bg-teal-50 rounded-[2rem] flex items-center justify-center mb-10 shadow-sm group-hover:scale-110 group-hover:shadow-xl group-hover:bg-teal-500 group-hover:text-white transition-all duration-700 border border-teal-100">
                            <Target className="w-12 h-12 text-teal-600 group-hover:text-white transition-colors" />
                        </div>
                        <h2 className="text-4xl font-black mb-6 text-slate-900 tracking-tight group-hover:text-teal-700 transition-colors leading-tight">Our Mission</h2>
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="group relative bg-slate-900 p-12 lg:p-16 rounded-[4rem] border border-slate-800 shadow-2xl hover:shadow-emerald-900/40 transition-all duration-700 hover:-translate-y-2 overflow-hidden"
                    >
                        {/* Light Streak Animation */}
                        ...
                        <div className="absolute inset-0 rounded-[4rem] border-2 border-transparent group-hover:border-emerald-400/20 transition-all duration-700 pointer-events-none" />

                        <div className="w-24 h-24 bg-white/10 backdrop-blur-xl rounded-[2rem] flex items-center justify-center mb-10 shadow-lg group-hover:scale-110 group-hover:bg-emerald-500 group-hover:text-slate-900 transition-all duration-700 border border-white/10 text-emerald-400">
                            <Sparkles className="w-12 h-12" />
                        </div>
                        <h2 className="text-4xl font-black mb-6 text-white tracking-tight group-hover:text-emerald-300 transition-colors leading-tight">Our Vision</h2>
            ...
            <section className="max-w-7xl mx-auto px-6 lg:px-8 mb-32">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                        { icon: Clock, value: "35+", label: "Years of Service", color: "text-teal-500", bg: "bg-teal-50" },
                        { icon: HeartPulse, value: "50K+", label: "Patients Treated", color: "text-emerald-500", bg: "bg-emerald-50" },
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-[3rem] p-10 text-center border border-slate-100 shadow-xl hover:-translate-y-2 transition-all duration-500 group"
                        >
            ...
            <section className="max-w-7xl mx-auto px-6 lg:px-8 pb-32">
                <div className="text-center max-w-4xl mx-auto mb-24 relative">
                    <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-teal-50 border border-teal-100 text-teal-700 text-sm font-bold tracking-[0.2em] uppercase mb-8 shadow-sm">
                        <ShieldCheck className="w-4 h-4" /> Stewardship
                    </span>
                    <h2 className="text-5xl md:text-7xl font-black mb-8 text-slate-900 tracking-tight leading-tight">Elite Governance</h2>
                ...
                <div className="grid md:grid-cols-3 gap-10">
                    {[
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ delay: idx * 0.1 }}
                            className="relative bg-white/70 backdrop-blur-2xl p-12 lg:p-14 rounded-[3.5rem] border border-slate-200/50 text-center shadow-[0_20px_50px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] hover:-translate-y-2 transition-all duration-700 group overflow-hidden flex flex-col items-center"
                        >
                            {/* Light Streak Animation */}
                            ...
                            <div className="relative w-40 h-40 mx-auto mb-10">
                                <div className="absolute inset-0 bg-gradient-to-br from-teal-400 to-emerald-300 rounded-full blur-[30px] opacity-0 group-hover:opacity-40 transition-opacity duration-700" />
                                <div className="relative w-full h-full bg-gradient-to-br from-teal-50 to-emerald-50 rounded-[2.5rem] flex items-center justify-center border-4 border-white shadow-xl group-hover:scale-110 transition-transform duration-700 z-10">
                                    <span className="text-teal-700 font-black text-5xl tracking-tighter">{member.icon}</span>
                                </div>
                            </div>

                            <h3 className="text-3xl font-black text-slate-900 mb-3 tracking-tight group-hover:text-teal-700 transition-colors leading-tight">{member.name}</h3>
                            <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-teal-50 border border-teal-100 text-[10px] font-black uppercase tracking-[0.2em] text-teal-600 mb-8 shadow-sm group-hover:bg-teal-500 group-hover:text-white transition-colors">
                                {member.role}
                            </div>
                            <p className="text-lg text-slate-500 leading-relaxed font-medium flex-grow">{member.desc}</p>
                        </motion.div>
                    ))}
                </div>
            </section>
                ...
                <div className="relative bg-gradient-to-br from-slate-900 via-teal-950 to-emerald-950 rounded-[4rem] p-16 sm:p-24 overflow-hidden shadow-2xl shadow-teal-950/40 group/cta flex flex-col items-center text-center">
                    ...
                    <div className="relative z-10 w-full max-w-4xl">
                        ...
                        <h2 className="text-5xl md:text-7xl lg:text-[6rem] font-black text-white mb-10 tracking-tight leading-[1] max-w-4xl mx-auto">
                            The Future <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-300">of Healing.</span>
                        </h2>
                        <p className="text-xl md:text-2xl text-teal-100/70 font-light mb-16 leading-relaxed max-w-3xl mx-auto">
