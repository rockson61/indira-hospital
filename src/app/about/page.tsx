        ...
        <main className="min-h-screen bg-slate-50 selection:bg-fuchsia-200 selection:text-fuchsia-900 pb-20">
            ...
            <section className="max-w-7xl mx-auto px-6 lg:px-8 relative z-20 -mt-24 sm:-mt-32 mb-32">
                <div className="grid md:grid-cols-2 gap-10">
                    ...
                    >
                        ...
                        <h2 className="text-4xl font-black mb-6 text-slate-900 tracking-tight group-hover:text-fuchsia-700 transition-colors leading-tight">Our Mission</h2>
                    ...
                    >
                        ...
                        <div className="w-24 h-24 bg-white/10 backdrop-blur-xl rounded-[2rem] flex items-center justify-center mb-10 shadow-lg group-hover:scale-110 group-hover:bg-pink-500 group-hover:text-slate-900 transition-all duration-700 border border-white/10 text-pink-400">
            ...
            <section className="max-w-7xl mx-auto px-6 lg:px-8 pb-32">
                <div className="text-center max-w-4xl mx-auto mb-24 relative">
                    <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-fuchsia-50 border border-fuchsia-100 text-fuchsia-700 text-sm font-bold tracking-[0.2em] uppercase mb-8 shadow-sm">
                ...
                <div className="grid md:grid-cols-3 gap-10">
                    {[
                        ...
                        >
                            ...
                            <h3 className="text-3xl font-black text-slate-900 mb-3 tracking-tight group-hover:text-fuchsia-700 transition-colors leading-tight">{member.name}</h3>
