...
const PROTOCOLS = [
    {
        ...
        icon: <HandMetal className="w-8 h-8 text-blue-600" />
    },
    {
            ...
            <section className="bg-white dark:bg-slate-900 py-24">
                <SectionContainer>
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-3xl md:text-5xl font-bold mb-8 text-slate-900 dark:text-white">Our Commitment to <span className="text-blue-600">Clinical Excellence</span></h2>
                            <div className="space-y-6">
                                {[
                                    ...
                                    <div key={i} className="flex gap-4">
                                        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/40 flex items-center justify-center text-blue-600 mt-1">
                        ...
                        <div className="relative">
                            <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&q=80&w=800"
                                    alt="Clinical Excellence" className="w-full h-full object-cover" />
                            </div>
                            <div className="absolute -bottom-8 -right-8 bg-blue-600 text-white p-10 rounded-3xl shadow-2xl max-w-xs">
