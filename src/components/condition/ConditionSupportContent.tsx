    ...
    <>
          ...
          <ul className="grid gap-3 sm:grid-cols-2">
            {tocItems.map((item) => (
              <li key={item.href}>
                <a
                  href={item.href}
                  className="flex items-center justify-between rounded-xl glassmorphism-item dark:from-slate-800/80 dark:to-fuchsia-900/30 border border-fuchsia-200 dark:border-fuchsia-700/40 px-4 py-3 text-sm font-medium text-foreground/90 transition-all hover:border-fuchsia-500 hover:text-fuchsia-600 dark:hover:text-fuchsia-400 hover:shadow-lg hover:scale-[1.02]"
                >
      ...
      <SectionContainer className="py-12 bg-gradient-to-br from-fuchsia-50 via-blue-50/50 to-cyan-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950" id={sectionIds.when}>
        <div className="glassmorphism-card-light dark:bg-slate-900/80 rounded-3xl p-8 border border-fuchsia-200/50 dark:border-fuchsia-600/30 shadow-xl">
          ...
          <ul className="grid gap-3 md:grid-cols-2">
            <li className="flex items-start gap-3 glassmorphism-item dark:from-slate-800/80 dark:to-fuchsia-900/30 rounded-xl p-4 border border-fuchsia-200 dark:border-fuchsia-700/40"><span className="text-fuchsia-500">❗</span> Pain lasting more than two days or disrupting sleep</li>
            <li className="flex items-start gap-3 glassmorphism-item dark:from-slate-800/80 dark:to-fuchsia-900/30 rounded-xl p-4 border border-fuchsia-200 dark:border-fuchsia-700/40"><span className="text-fuchsia-500">❗</span> Swelling in the jaw, cheek, or neck</li>
            <li className="flex items-start gap-3 glassmorphism-item dark:from-slate-800/80 dark:to-fuchsia-900/30 rounded-xl p-4 border border-fuchsia-200 dark:border-fuchsia-700/40"><span className="text-fuchsia-500">❗</span> Difficulty opening your mouth or swallowing</li>
            <li className="flex items-start gap-3 glassmorphism-item dark:from-slate-800/80 dark:to-fuchsia-900/30 rounded-xl p-4 border border-fuchsia-200 dark:border-fuchsia-700/40"><span className="text-fuchsia-500">❗</span> Pain radiating to the ear, head, or temples</li>
            <li className="flex items-start gap-3 backdrop-blur-sm bg-gradient-to-r from-white/80 to-blue-50/50 dark:from-slate-800/80 dark:to-blue-900/30 rounded-xl p-4 border border-blue-200 dark:border-blue-800/50 md:col-span-2"><span className="text-fuchsia-500">❗</span> Visible pus, bleeding, or foul taste in the mouth</li>
          </ul>
      ...
      <SectionContainer className="py-12 bg-gradient-to-br from-cyan-50/50 via-white to-blue-50/50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950" id={sectionIds.treatments}>
        ...
        <div className="overflow-x-auto rounded-2xl border border-fuchsia-200/50 dark:border-fuchsia-700/40 shadow-lg">
          <table className="min-w-full divide-y divide-fuchsia-200/50 dark:divide-fuchsia-800/50">
            ...
            <tbody className="divide-y divide-fuchsia-100/50 dark:divide-fuchsia-800/30 bg-white/80 dark:bg-slate-800/60">
