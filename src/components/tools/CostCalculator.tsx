...
export function CostCalculator() {
 ...
 <div className="flex items-center gap-3 p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 cursor-pointer group" onClick={() => setInsurance(!insurance)}>
 <div className={`w-5 h-5 rounded border transition-all flex items-center justify-center ${insurance ? 'bg-indigo-600 border-indigo-500' : 'border-slate-200 dark:border-slate-800'}`}>
