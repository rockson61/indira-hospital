...
import { CreditCard, FileText, CheckCircle2, ArrowRight, Lock, Shield } from "lucide-react";
...
export function PayBillClient() {
 ...
 <div className="absolute top-0 right-1/4 w-[600px] h-[600px] bg-fuchsia-500/10 rounded-full hidden md:block blur-[120px] will-change-transform transform-gpu opacity-70 pointer-events-none" />
