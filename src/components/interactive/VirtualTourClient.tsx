    ...
    <div className="relative min-h-screen bg-slate-950 overflow-hidden font-sans">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <header className="p-8 flex items-center justify-between">
          <Link href="/gallery" className="group flex items-center gap-3 px-6 py-3 rounded-2xl bg-white/5 backdrop-blur-3xl border border-white/10 hover:bg-white/10 transition-all shadow-2xl">
          ...
          <div className="max-w-4xl w-full">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-12">
              {activeScene.facts.map((fact, i) => (
                <div key={i} className="flex items-center gap-4 p-5 rounded-[2rem] bg-white/5 backdrop-blur-2xl border border-white/5 group hover:border-indigo-500/30 transition-all">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <Link href="/contact" className="flex items-center justify-center gap-4 px-10 py-6 bg-white/5 backdrop-blur-3xl border border-white/10 text-white font-bold rounded-3xl hover:bg-white/10 transition-colors uppercase tracking-widest text-[11px]">
                Arrange Site Visit
              </Link>
            </div>
          </div>
