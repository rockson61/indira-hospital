...
export default function BookingFunnel() {
  ...
  return (
    <div className="w-full bg-slate-900/60 backdrop-blur-3xl rounded-[3rem] border border-white/10 shadow-2xl relative overflow-hidden min-h-[500px] flex flex-col">
      {/* Background Accents */}
          ...
          {["selection", "valuation", "handoff"].map((s, i) => (
            <div 
              ...
              className={`h-1 rounded-full transition-all duration-500 ${
                step === s ? "w-8 bg-emerald-400" : i < ["selection", "valuation", "handoff"].indexOf(step) ? "w-4 bg-emerald-400/40" : "w-4 bg-white/10"
              }`} 
            />
          ))}
        </div>
        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-6 pl-16 pr-6 text-white placeholder:text-slate-600 focus:outline-none focus:border-emerald-500/50 focus:bg-white/10 transition-all font-medium italic"
                />
              </div>
                ...
                {options.length > 0 ? (
                  options.slice(0, 10).map((opt) => (
                    <button
                      ...
                      className="flex items-center justify-between p-5 rounded-2xl bg-white/5 border border-white/5 hover:border-emerald-500/30 hover:bg-white/10 transition-all group group-hover:shadow-[0_0_20px_rgba(16,185,129,0.1)]"
                    >
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-10 items-start">
                ...
                <div className="w-full md:w-[340px] space-y-6">
                  {selectedPricing ? (
                    <div className="p-8 rounded-[2rem] bg-gradient-to-br from-indigo-500/10 to-fuchsia-500/10 border border-white/10 shadow-2xl relative group overflow-hidden">
                    ...
                    <div className="p-8 rounded-[2rem] bg-white/5 border border-white/5 text-center flex flex-col items-center justify-center min-h-[200px]">
          ...
          {step === "handoff" && (
            ...
            >
              ...
              <div className="w-full max-w-md p-6 rounded-3xl bg-white/5 border border-white/5 space-y-4 text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                ...
                <button
                  ...
                  className="px-8 py-7 bg-white/5 text-white font-bold rounded-3xl hover:bg-white/10 transition-colors uppercase tracking-widest text-[9px]"
                >
                  Review Details
                </button>
              </div>
