...
export const MobileQuickActions = () => {
 return (
 <div className="lg:hidden fixed bottom-0 left-0 right-0 z-[100] bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700 dark:border-slate-800 pb-safe shadow-[0_-8px_30px_rgb(0,0,0,0.12)]">
