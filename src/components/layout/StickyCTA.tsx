...
export function StickyCTA() {
 ...
 <div className="bg-white dark:bg-slate-900 border-t border-slate-200/50 dark:border-slate-700/50 p-3 sm:px-6 flex gap-3 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
 <a
