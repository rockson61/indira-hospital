    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <div className="bg-fuchsia-50 dark:bg-fuchsia-950 dark:bg-slate-800/60 p-6 rounded-2xl border border-blue-100 dark:border-fuchsia-700/40 relative overflow-hidden">
                    ...
                    <ul className="space-y-3">
                        {[
                            ...
                            <li key={i} className="flex items-center gap-3">
                                <div className="w-1.5 h-1.5 bg-fuchsia-50 dark:bg-fuchsia-950 dark:bg-slate-800/600 rounded-full" />
