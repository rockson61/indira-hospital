  ...
  return (
    <section className="py-24 bg-[#030712] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              return (
                ...
                >
                  ...
                  <div className={`p-3 rounded-xl transition-colors shrink-0 relative z-10 ${
                    isActive ? "bg-fuchsia-500 text-white" : "bg-white/5 text-gray-500 group-hover:text-white"
                  }`}>
          ...
          <div className="lg:col-span-8 h-full">
            <motion.div
              ...
              className="h-full"
            >
              <GlassCard className="p-8 lg:p-12 h-full border-white/10 hover:border-white/20 transition-colors group">
                <div className="flex flex-col h-full">
                  <div className="flex items-start justify-between mb-8">
                    ...
                    <div className="flex gap-2">
                      <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs text-gray-400">95% Success Rate</span>
                      <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs text-gray-400">NABH Accredited</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                    {(services[activeService].features || []).map((feature, idx) => (
                      <div key={idx} className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 group-hover:border-white/10 transition-colors">
                  ...
                  <div className="mt-auto flex flex-wrap items-center gap-6 pt-8 border-t border-white/10">
                    ...
                    <div className="ml-auto flex gap-4">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center h-12 px-8 rounded-xl bg-white/5 border border-white/10 text-white font-bold hover:bg-white/10 transition-all duration-300"
                      >
                        Book Appointment
                      </Link>
                    </div>
        ...
        >
          <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-[600px] h-[600px] bg-white/10 blur-[100px] rounded-full group-hover:scale-110 transition-transform duration-1000" />
