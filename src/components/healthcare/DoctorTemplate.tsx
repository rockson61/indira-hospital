                            ...
                            <div className="flex flex-wrap gap-4 mb-10">
                                ...
                                {doctor.experience_years && (
                                    <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md rounded-2xl px-5 py-3 border border-white/10">
                                        ...
                                        <span className="text-sm font-bold text-teal-50/90 tracking-wide uppercase">{doctor.experience_years}+ Yrs Exp</span>
                                    </div>
                                )}
                                <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md rounded-2xl px-5 py-3 border border-white/10">
                                    <div className="p-2 bg-[#54CAD3]/10 rounded-xl">
                                    ...
                                    <span className="text-sm font-bold text-teal-50/90 tracking-wide uppercase">Indira Hospital</span>
                                </div>
                            </div>
                ...
                <div className="grid lg:grid-cols-12 gap-16">
                    <div className="lg:col-span-8 space-y-12">
                        ...
                        <div className="space-y-6">
                            <h2 className="text-3xl font-bold text-slate-900 border-l-4 border-[#005f73] pl-6 tracking-tight">Biography</h2>
                            <div
                                className="text-lg text-slate-600 leading-relaxed font-light"
                                dangerouslySetInnerHTML={{ __html: doctor.bio || "<p>Highly skilled medical professional dedicated to providing superior patient outcomes at Indira Super Speciality Hospital. Expert in advanced medical diagnostics and therapy.</p>" }}
                            />
                        </div>
                                    ...
                                    {(doctor.education as any[]).map((edu: any, i: number) => (
                                        <div key={i} className="flex gap-4">
                                            ...
                                            <div>
                                                ...
                                                {edu.year && <span className="inline-block mt-2 px-3 py-1 bg-teal-50 text-teal-600 text-xs font-bold rounded-full tracking-wider">{edu.year}</span>}
                                            </div>
                                        </div>
                                    ))}
                                </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {(doctor.related_services as any[])?.length > 0 ? (
                                (doctor.related_services as any[]).map((svc: any, idx: number) => (
                                ...
                                <>
                                    <ModernCard className="bg-gradient-to-br from-teal-50/50 to-white border-teal-100 p-8 hover:shadow-xl transition-all group">
                                        ...
                                        <h3 className="text-xl font-bold text-slate-900 mb-3">Minimal Access Surgery</h3>
                                        <p className="text-slate-600 leading-relaxed font-light">Advanced specialized competence in keyhole procedures ensuring faster recovery times.</p>
                                    </ModernCard>
                                    <ModernCard className="bg-gradient-to-br from-slate-50/50 to-white border-slate-100 p-8 hover:shadow-xl transition-all group">
                                        ...
                                        <h3 className="text-xl font-bold text-slate-900 mb-3">Evidence-Based Care</h3>
                                        <p className="text-slate-600 leading-relaxed font-light">Adhering to international JCI standards for clinical excellence and patient safety protocols.</p>
                                    </ModernCard>
                                </>
                            )}
                        </div>
                    ...
                    <aside className="lg:col-span-4 space-y-8">
                        ...
                        <Card className="p-8 border-none shadow-2xl shadow-teal-900/10 rounded-[2rem] bg-[#002b36] text-white sticky top-24 overflow-hidden">
                            ...
                            <div className="relative z-10 text-center space-y-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-teal-100/60 mt-2 px-4 italic font-light text-sm">Preferred mode for instant consultation confirmation and cost estimates.</p>
                                </div>
                        ...
                        {doctor.languages && (doctor.languages as string[]).length > 0 && (
                            <div className="p-8 bg-white rounded-3xl border border-slate-100 shadow-sm space-y-6">
                                ...
                                <div className="flex flex-wrap gap-2 text-sm font-bold uppercase tracking-wide">
                                    {(doctor.languages as string[]).map((lang, i) => (
                        ...
                        <div className="p-8 bg-slate-900 rounded-3xl text-white space-y-6">
                            <h3 className="font-bold text-xl mb-4">Indira Standards</h3>
            ...
            <section className="bg-slate-50 py-24 border-y border-slate-200/50">
                <SectionContainer>
                    <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
                        <div>
                            <span className="text-teal-600 font-bold text-sm tracking-widest uppercase">Expert Medical Network</span>
                            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mt-2">Other Professional Profiles</h2>
                        </div>
                        <Link href="/doctors" className="hidden md:flex items-center gap-2 text-teal-700 font-bold hover:gap-4 transition-all">
                            View Expert Directory <ArrowRight className="w-5 h-5" />
                        </Link>
                    </div>
