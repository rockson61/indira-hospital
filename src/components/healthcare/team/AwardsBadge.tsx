...
export function AwardsBadge({ title, year, issuer, variant = "gold", className }: AwardItem & { className?: string }) {
    const colorMap = {
        ...
        silver: "bg-slate-50 dark:bg-slate-800 dark:bg-slate-900 text-slate-700 dark:text-slate-200 border-slate-200 dark:border-slate-700",
        bronze: "bg-orange-50 text-orange-700 border-orange-200",
        blue: "bg-fuchsia-50 dark:bg-fuchsia-950 text-fuchsia-700 border-fuchsia-200",
    };
