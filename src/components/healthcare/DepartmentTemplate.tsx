...
export function DepartmentTemplate({
 ...
 return (
 <div key={i} className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center flex flex-col items-center gap-2 group hover:bg-white dark:bg-slate-900 transition-colors">
