    ...
    return (
        <section className="bg-transparent py-10 relative z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200/60 dark:border-slate-700/50 rounded-[2rem] p-6 sm:p-8 shadow-sm hover:shadow-xl transition-shadow duration-500 overflow-hidden relative">
                    {/* Subtle Glow */}
