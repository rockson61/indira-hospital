                ...
                <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
                    {providerGroups.map((group, idx) => {
                        ...
                        return (
                            <div
                                key={idx}
                                className="group relative bg-slate-50 dark:bg-slate-900/50 rounded-3xl p-8 border border-slate-200/60 dark:border-slate-800/80 hover:border-blue-300 dark:hover:border-blue-800 transition-all duration-500 shadow-sm hover:shadow-[0_20px_60px_-15px_rgba(59,130,246,0.1)] overflow-hidden flex flex-col"
                            >
