...
export function HealthLibraryCard() {
 ...
 <div className="absolute -top-32 -left-32 w-64 h-64 bg-white dark:bg-slate-900 rounded-full blur-[60px]" />

 <div className="relative z-10">
 <div className="w-16 h-16 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center mb-8 shadow-inner shadow-white/10">
 ...
 <div className="relative p-8 lg:p-16 flex flex-col justify-center lg:w-7/12 bg-white dark:bg-slate-900 z-10">
