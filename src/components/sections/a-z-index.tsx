            ...
            <SectionContainer>
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-3xl md:text-5xl font-black mb-6 text-slate-900 dark:text-white tracking-tight">
                        Health <span className="text-blue-600">A to Z Index</span>
                    </h2>
                ...
                <div className="max-w-2xl mx-auto mb-12 relative group">
                    ...
                    <input
                        ...
                        className="w-full pl-14 pr-6 py-5 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none outline-none focus:ring-2 focus:ring-blue-600 text-lg transition-all"
                        value={searchTerm}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {filteredData.map((item, i) => (
                        ...
                        >
                            <span className="font-bold text-slate-800 dark:text-slate-200 group-hover:text-blue-600 transition-colors">{item.name}</span>
