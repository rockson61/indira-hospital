...
export async function SignatureTreatments() {
    ...
    return (
        <section className="py-28 bg-slate-900 relative overflow-hidden">
            {/* Background Glows */}
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-teal-600/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-teal-400/5 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/2 pointer-events-none" />
            ...
            <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
                <div className="flex justify-between items-end mb-12">
                    ...
                    <Link
                        ...
                        className="hidden sm:inline-flex items-center font-bold text-teal-400 hover:text-teal-300 transition-colors"
                    >
