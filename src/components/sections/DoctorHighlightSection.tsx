        ...
        <section className="py-24 bg-slate-50 border-y border-slate-100">
            <SectionContainer>
                ...
                <div className="mt-16 text-center">
                    <Link
                        href="/doctors"
                        className="inline-flex items-center justify-center px-10 py-5 bg-slate-900 text-white font-black rounded-2xl hover:bg-teal-700 hover:scale-[1.02] transition-all shadow-lg"
                    >
                        Browse All Doctors
