            ...
            <section className="relative pt-48 pb-32 lg:pt-60 lg:pb-56 overflow-hidden bg-slate-900 rounded-b-[4rem] sm:rounded-b-[6rem]">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center flex flex-col items-center">
                    ...
                    >
                        ...
                        <div className="w-full max-w-4xl mx-auto bg-white/10 backdrop-blur-3xl p-3 sm:p-5 rounded-[3rem] border border-white/20 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.6)] flex flex-col gap-4 relative overflow-hidden group/search">
                            {/* Interactive Shine */}
