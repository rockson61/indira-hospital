...
export function CTAWidget({
 ...
 {showRating && (
 <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-bold text-gray-300">
 <Star className="w-3 h-3 text-yellow-400 fill-yellow-400" />
 4.9/5 Rating
 </div>
 )}
 {showAvailability && (
 <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-bold text-green-400">
 <Clock className="w-3 h-3" />
 Available 24/7
 </div>
 )}
 <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-bold text-fuchsia-400">
 ...
 variant="bordered"
 className={`h-16 px-10 rounded-2xl font-bold text-lg border-2 transition-all duration-300 hover:bg-white dark:bg-slate-900 ${
 urgency 
 ? 'border-slate-200 dark:border-slate-800 text-white' 
 : 'border-slate-200 dark:border-slate-800 text-white hover:border-slate-200 dark:border-slate-800'
 }`}
 >
