            ...
            <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-5 justify-center">
                    ...
                    <Link
                        ...
                        className="group inline-flex items-center justify-center gap-3 px-10 py-5 bg-white/10 backdrop-blur text-white font-black rounded-2xl border border-white/20 hover:bg-white/20 transition-all text-lg"
                    >
                        Book Appointment
