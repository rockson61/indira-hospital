...
export function WhyChooseUs() {
 ...
 >
 <GlassCard className="p-6 text-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
 ...
 transition={{ duration: 0.6 }}
 >
 <GlassCard className="p-8 bg-gradient-to-r from-white/15 to-[#54CAD3]/20 border border-slate-200 dark:border-slate-800">
 ...
 >
 <GlassCard className="p-8 max-w-4xl mx-auto bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
