...
export function Reviews() {
 ...
 <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-light text-lg mb-8">&ldquo;{review.review}&rdquo;</p>
 </div>
 <div className="flex items-center gap-4">
 <div className="w-10 h-10 rounded-full bg-fuchsia-100 dark:bg-slate-900 flex items-center justify-center text-fuchsia-600 font-black text-xs uppercase">{review.name.charAt(0)}</div>
 <h4 className="font-black text-slate-900 dark:text-white uppercase tracking-widest text-xs">{review.name}</h4>
 </div>
 </div>
 ))}
 </div>
