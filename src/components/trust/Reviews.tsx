          ...
          {reviews.map((review, index) => (
            <div key={index} className="elite-card p-8 group hover:scale-[1.02] flex flex-col justify-between h-full">
              ...
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-fuchsia-100 dark:bg-white/10 flex items-center justify-center text-fuchsia-600 font-black text-xs uppercase">{review.name.charAt(0)}</div>
