...
export function ServiceCard({ service, variant = "detail", className, cardClassName, theme = "teal" }: ServiceCardProps) {
 ...
 href={href}
 className={cn(
 "group flex items-center justify-between p-5 rounded-[2.5rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/50 hover:bg-white dark:bg-slate-900 hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.1)] hover:-translate-y-0.5 transition-all duration-500",
 className
 )}
 >
 ...
 <div className={cn(
 "h-full rounded-[3rem] border border-slate-200 dark:border-slate-700/50 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] dark:hover:shadow-fuchsia-500/5 hover:-translate-y-2 transition-all duration-700 bg-white dark:bg-slate-900 overflow-hidden relative p-10 flex flex-col items-center text-center",
 cardClassName
 )}>
 ...
 "group relative h-full rounded-[2.5rem] border border-slate-200/60 dark:border-slate-700/50 hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.05)] dark:hover:shadow-fuchsia-500/10 hover:-translate-y-1.5 transition-all duration-500 p-7 sm:p-8 flex flex-col bg-white dark:bg-slate-900 overflow-hidden",
 className
 )}>
 {/* Light Streak Animation */}
