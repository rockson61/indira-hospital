    ...
    return (
        ...
        >
            <Link href={href} className={cn("block group h-full", className)}>
                <div className="relative h-full bg-white/40 backdrop-blur-2xl border border-slate-200 dark:border-slate-700/50 rounded-[2.5rem] p-8 hover:bg-white dark:bg-slate-900 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] hover:-translate-y-2 transition-all duration-500 group overflow-hidden flex flex-col">
