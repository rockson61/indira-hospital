...
export function LocationCard({ location, className, cardClassName, variant = "card" }: LocationCardProps) {
    ...
    return (
        <article className={cn("overflow-hidden rounded-[2rem] border border-slate-200/60 dark:border-slate-700/50 backdrop-blur-xl shadow-sm hover:shadow-2xl dark:hover:shadow-fuchsia-500/10 hover:-translate-y-1.5 transition-all duration-500 group bg-white/80 dark:bg-slate-900/80 flex flex-col h-full", cardClassName || className)}>
            {/* Map Thumbnail */}
