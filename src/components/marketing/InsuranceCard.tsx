    ...
    return (
        <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-3xl p-8 relative overflow-hidden shadow-2xl group border border-emerald-400/50">
            ...
            <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/20 backdrop-blur-md border border-white/20 text-white text-[10px] font-black tracking-widest uppercase mb-6 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-3 mb-8">
                    {popularInsurances.map((ins, idx) => (
                        <div key={idx} className="bg-white/10 backdrop-blur border border-white/10 rounded-xl px-3 py-2 text-xs font-bold text-white text-center flex items-center justify-center shadow-inner">
                            {ins}
                        </div>
                    ))}
                </div>
