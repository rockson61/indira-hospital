...
export function AvailabilityTicker() {
    ...
    return (
        <div className="w-full overflow-hidden bg-slate-950 border-b border-white/5 py-2">
            <div className="flex animate-marquee whitespace-nowrap items-center gap-12">
                ...
                {availability.map((doc, i) => (
                    <div key={`doc-${i}`} className="flex items-center gap-6 px-6 border-r border-white/10 last:border-none">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <span className="px-2 py-0.5 bg-white/5 rounded text-[9px] font-black text-fuchsia-400 border border-fuchsia-500/30 uppercase">
                                {doc.status}
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
...
export function AvailabilityCTA() {
    return (
        <div className="p-6 bg-gradient-to-r from-slate-900 to-slate-950 rounded-3xl border border-white/5 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6 group hover:border-fuchsia-500/30 transition-all">
