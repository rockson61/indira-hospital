...
export function VirtualTour() {
 ...
 <button className="p-3 bg-white dark:bg-slate-900 rounded-full text-slate-900 dark:text-white hover:bg-white dark:bg-slate-900 transition-all">
 ...
 <button className="mt-4 w-full flex items-center justify-center gap-2 py-2 bg-white dark:bg-slate-900 hover:bg-white dark:bg-slate-900 text-slate-900 dark:text-white text-xs font-bold rounded-xl transition-all">
 VIEW IN DEPTH
