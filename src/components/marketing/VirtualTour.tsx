...
export function VirtualTour() {
    ...
    return (
        <section className="relative w-full aspect-video rounded-[3rem] overflow-hidden bg-slate-900 border border-white/10 shadow-2xl group">
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-8 pointer-events-none">
                <div className="flex justify-between items-start pointer-events-auto">
                    <div className="p-4 bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-2xl">
                ...
                {TOUR_POINTS.map(point => (
                    ...
                    >
                        <div className="relative">
                            ...
                            <div className="relative w-8 h-8 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center border-2 border-fuchsia-500 shadow-lg group/point hover:scale-110 transition-all">
            ...
            {activePoint && (
                <div className="absolute bottom-12 left-12 right-12 md:left-auto md:w-80 p-6 bg-slate-900/80 backdrop-blur-2xl border border-fuchsia-500/30 rounded-3xl animate-in fade-in slide-in-from-bottom-4">
                    <button 
                    ...
                    <button className="mt-4 w-full flex items-center justify-center gap-2 py-2 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl transition-all">
                        VIEW IN DEPTH
