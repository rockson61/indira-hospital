...
const glassCardVariants = cva("rounded-2xl border transition-all duration-300", {
 variants: {
 variant: {
 default: "bg-card/70 dark:bg-gray-800/70 border-border/50 dark:border-gray-700/50 hover:shadow-clay",
 accent:
 "bg-fuchsia-50/70 dark:bg-fuchsia-900/20 border-fuchsia-200/50 dark:border-fuchsia-700/50 hover:shadow-fuchsia-500/20 hover:shadow-clay",
 secondary:
 "bg-fuchsia-50/70 dark:bg-blue-900/20 border-blue-200/50 dark:border-fuchsia-700/50 hover:shadow-fuchsia-500/20 hover:shadow-clay",
