...
const modernButtonVariants = cva(
 ...
 variants: {
 variant: {
 default: 'bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm hover:shadow-clay-sm',
 destructive: 'bg-error-500 text-white hover:bg-error-600 shadow-sm hover:shadow-clay-sm',
 outline: 'border border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground',
 secondary: 'bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-sm hover:shadow-clay-sm',
 ghost: 'text-primary hover:bg-primary/10',
 link: 'text-primary underline-offset-4 hover:underline',
 gradient: 'bg-gradient-to-r from-fuchsia-500 to-fuchsia-500 text-white hover:from-fuchsia-600 hover:to-fuchsia-600 shadow-clay hover:shadow-fuchsia-500/40 hover:-translate-y-0.5',
 },
 size: {
