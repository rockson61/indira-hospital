...
export function PageHeader({
    ...
    return (
        <section className={cn("relative pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden bg-slate-900 rounded-b-[3rem] sm:rounded-b-[4rem]", className)} {...props}>
            ...
            <div className="absolute -top-[20%] -right-[10%] w-[600px] h-[600px] rounded-full bg-cyan-500/20 hidden md:block blur-[120px] will-change-transform transform-gpu opacity-70 pointer-events-none" />
