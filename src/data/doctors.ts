...
export const doctors: readonly Doctor[] = [
    ...
    },
    {
        ...
        name: "Dr. P. Shankar",
        slug: "dr-p-shankar",
        specialty: "Chairman & HOD - General Surgery | Proctology & Laparoscopic Surgery",
        departmentId: "general-surgery",
        experience: 30,
        education: ["MBBS", "MS - General Surgery"],
        imageUrl: "/images/doctors/dr-shankar.jpg",
        availability: ["Mon-Sat"],
        bio: "Dr. P. Shankar is the esteemed Chairman of Indira Hospital and is widely recognized as the best proctologist in India and Tamil Nadu. A veteran General Surgeon with over 30 years of clinical and administrative excellence, he specializes in advanced Proctology (Laser Piles, Fistula, Fissure), Laparoscopic Surgery, and Surgical Gastroenterology. His expertise also extends to Diabetic Foot Care and complex General Surgical procedures, ensuring world-class healthcare delivery.",
    },
    {
        id: "dr-raman-kumar",
